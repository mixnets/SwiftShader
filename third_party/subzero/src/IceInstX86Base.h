...
template <typename TraitsType> struct InstImpl {
  ...
  private:
    ...
    static constexpr GPREmitterOneOp Emitter = {};
  };
  ...
  protected:
    ...
    static constexpr const char *Opcode = nullptr;
    static constexpr GPREmitterRegOp Emitter = {};
  };
  ...
  protected:
    ...
    static constexpr const char *Opcode = nullptr;
    static constexpr GPREmitterAddrOp Emitter;
  };
  ...
  protected:
    ...
    static constexpr const char *Opcode = nullptr;
    static constexpr XmmEmitterRegOp Emitter;
  };
  ...
  protected:
    ...
    static constexpr const char *Opcode = nullptr;
    static constexpr XmmEmitterShiftOp Emitter;
  };
