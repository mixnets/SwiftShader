...
template <> const char *const InstMIPS32Abs_d::Opcode = "abs.d";
template <> const char *const InstMIPS32Abs_s::Opcode = "abs.s";
template <> const char *const InstMIPS32Addi::Opcode = "addi";
template <> const char *const InstMIPS32Add::Opcode = "add";
template <> const char *const InstMIPS32Add_d::Opcode = "add.d";
template <> const char *const InstMIPS32Add_s::Opcode = "add.s";
template <> const char *const InstMIPS32Addiu::Opcode = "addiu";
template <> const char *const InstMIPS32Addu::Opcode = "addu";
template <> const char *const InstMIPS32And::Opcode = "and";
template <> const char *const InstMIPS32Andi::Opcode = "andi";
template <> const char *const InstMIPS32C_eq_d::Opcode = "c.eq.d";
template <> const char *const InstMIPS32C_eq_s::Opcode = "c.eq.s";
template <> const char *const InstMIPS32C_ole_d::Opcode = "c.ole.d";
template <> const char *const InstMIPS32C_ole_s::Opcode = "c.ole.s";
template <> const char *const InstMIPS32C_olt_d::Opcode = "c.olt.d";
template <> const char *const InstMIPS32C_olt_s::Opcode = "c.olt.s";
template <> const char *const InstMIPS32C_ueq_d::Opcode = "c.ueq.d";
template <> const char *const InstMIPS32C_ueq_s::Opcode = "c.ueq.s";
template <> const char *const InstMIPS32C_ule_d::Opcode = "c.ule.d";
template <> const char *const InstMIPS32C_ule_s::Opcode = "c.ule.s";
template <> const char *const InstMIPS32C_ult_d::Opcode = "c.ult.d";
template <> const char *const InstMIPS32C_ult_s::Opcode = "c.ult.s";
template <> const char *const InstMIPS32C_un_d::Opcode = "c.un.d";
template <> const char *const InstMIPS32C_un_s::Opcode = "c.un.s";
template <> const char *const InstMIPS32Clz::Opcode = "clz";
template <> const char *const InstMIPS32Cvt_d_l::Opcode = "cvt.d.l";
template <> const char *const InstMIPS32Cvt_d_s::Opcode = "cvt.d.s";
template <> const char *const InstMIPS32Cvt_d_w::Opcode = "cvt.d.w";
template <> const char *const InstMIPS32Cvt_s_d::Opcode = "cvt.s.d";
template <> const char *const InstMIPS32Cvt_s_l::Opcode = "cvt.s.l";
template <> const char *const InstMIPS32Cvt_s_w::Opcode = "cvt.s.w";
template <> const char *const InstMIPS32Div::Opcode = "div";
template <> const char *const InstMIPS32Div_d::Opcode = "div.d";
template <> const char *const InstMIPS32Div_s::Opcode = "div.s";
template <> const char *const InstMIPS32Divu::Opcode = "divu";
template <> const char *const InstMIPS32La::Opcode = "la";
template <> const char *const InstMIPS32Ldc1::Opcode = "ldc1";
template <> const char *const InstMIPS32Ll::Opcode = "ll";
template <> const char *const InstMIPS32Lui::Opcode = "lui";
template <> const char *const InstMIPS32Lw::Opcode = "lw";
template <> const char *const InstMIPS32Lwc1::Opcode = "lwc1";
template <> const char *const InstMIPS32Mfc1::Opcode = "mfc1";
template <> const char *const InstMIPS32Mfhi::Opcode = "mfhi";
template <> const char *const InstMIPS32Mflo::Opcode = "mflo";
template <> const char *const InstMIPS32Mov_d::Opcode = "mov.d";
template <> const char *const InstMIPS32Mov_s::Opcode = "mov.s";
template <> const char *const InstMIPS32Movf::Opcode = "movf";
template <> const char *const InstMIPS32Movn::Opcode = "movn";
template <> const char *const InstMIPS32Movn_d::Opcode = "movn.d";
template <> const char *const InstMIPS32Movn_s::Opcode = "movn.s";
template <> const char *const InstMIPS32Movt::Opcode = "movt";
template <> const char *const InstMIPS32Movz::Opcode = "movz";
template <> const char *const InstMIPS32Movz_d::Opcode = "movz.d";
template <> const char *const InstMIPS32Movz_s::Opcode = "movz.s";
template <> const char *const InstMIPS32Mtc1::Opcode = "mtc1";
template <> const char *const InstMIPS32Mthi::Opcode = "mthi";
template <> const char *const InstMIPS32Mtlo::Opcode = "mtlo";
template <> const char *const InstMIPS32Mul::Opcode = "mul";
template <> const char *const InstMIPS32Mul_d::Opcode = "mul.d";
template <> const char *const InstMIPS32Mul_s::Opcode = "mul.s";
template <> const char *const InstMIPS32Mult::Opcode = "mult";
template <> const char *const InstMIPS32Multu::Opcode = "multu";
template <> const char *const InstMIPS32Nor::Opcode = "nor";
template <> const char *const InstMIPS32Or::Opcode = "or";
template <> const char *const InstMIPS32Ori::Opcode = "ori";
template <> const char *const InstMIPS32Sc::Opcode = "sc";
template <> const char *const InstMIPS32Sdc1::Opcode = "sdc1";
template <> const char *const InstMIPS32Sll::Opcode = "sll";
template <> const char *const InstMIPS32Sllv::Opcode = "sllv";
template <> const char *const InstMIPS32Slt::Opcode = "slt";
template <> const char *const InstMIPS32Slti::Opcode = "slti";
template <> const char *const InstMIPS32Sltiu::Opcode = "sltiu";
template <> const char *const InstMIPS32Sltu::Opcode = "sltu";
template <> const char *const InstMIPS32Sqrt_d::Opcode = "sqrt.d";
template <> const char *const InstMIPS32Sqrt_s::Opcode = "sqrt.s";
template <> const char *const InstMIPS32Sra::Opcode = "sra";
template <> const char *const InstMIPS32Srav::Opcode = "srav";
template <> const char *const InstMIPS32Srl::Opcode = "srl";
template <> const char *const InstMIPS32Srlv::Opcode = "srlv";
template <> const char *const InstMIPS32Sub::Opcode = "sub";
template <> const char *const InstMIPS32Sub_d::Opcode = "sub.d";
template <> const char *const InstMIPS32Sub_s::Opcode = "sub.s";
template <> const char *const InstMIPS32Subu::Opcode = "subu";
template <> const char *const InstMIPS32Sw::Opcode = "sw";
template <> const char *const InstMIPS32Swc1::Opcode = "swc1";
const char *const InstMIPS32Sync::Opcode = "sync";
template <> const char *const InstMIPS32Teq::Opcode = "teq";
template <> const char *const InstMIPS32Trunc_l_d::Opcode = "trunc.l.d";
template <> const char *const InstMIPS32Trunc_l_s::Opcode = "trunc.l.s";
template <> const char *const InstMIPS32Trunc_w_d::Opcode = "trunc.w.d";
template <> const char *const InstMIPS32Trunc_w_s::Opcode = "trunc.w.s";
template <> const char *const InstMIPS32Xor::Opcode = "xor";
template <> const char *const InstMIPS32Xori::Opcode = "xori";
