...
/// automatically.
/* In-place ops */
template <> const char *InstImpl::InstX86Bswap::Base::Opcode = "bswap";
template <> const char *InstImpl::InstX86Neg::Base::Opcode = "neg";
/* Unary ops */
template <> const char *InstImpl::InstX86Bsf::Base::Opcode = "bsf";
template <> const char *InstImpl::InstX86Bsr::Base::Opcode = "bsr";
template <> const char *InstImpl::InstX86Lea::Base::Opcode = "lea";
template <> const char *InstImpl::InstX86Movd::Base::Opcode = "movd";
template <> const char *InstImpl::InstX86Movsx::Base::Opcode = "movs";
template <> const char *InstImpl::InstX86Movzx::Base::Opcode = "movz";
template <> const char *InstImpl::InstX86Sqrt::Base::Opcode = "sqrt";
template <> const char *InstImpl::InstX86Cbwdq::Base::Opcode = "cbw/cwd/cdq";
/* Mov-like ops */
template <> const char *InstImpl::InstX86Mov::Base::Opcode = "mov";
template <> const char *InstImpl::InstX86Movp::Base::Opcode = "movups";
template <> const char *InstImpl::InstX86Movq::Base::Opcode = "movq";
/* Binary ops */
template <> const char *InstImpl::InstX86Add::Base::Opcode = "add";
template <> const char *InstImpl::InstX86AddRMW::Base::Opcode = "add";
template <> const char *InstImpl::InstX86Addps::Base::Opcode = "add";
template <> const char *InstImpl::InstX86Adc::Base::Opcode = "adc";
template <> const char *InstImpl::InstX86AdcRMW::Base::Opcode = "adc";
template <> const char *InstImpl::InstX86Addss::Base::Opcode = "add";
template <> const char *InstImpl::InstX86Andnps::Base::Opcode = "andn";
template <> const char *InstImpl::InstX86Andps::Base::Opcode = "and";
template <> const char *InstImpl::InstX86Maxss::Base::Opcode = "max";
template <> const char *InstImpl::InstX86Minss::Base::Opcode = "min";
template <> const char *InstImpl::InstX86Maxps::Base::Opcode = "max";
template <> const char *InstImpl::InstX86Minps::Base::Opcode = "min";
template <> const char *InstImpl::InstX86Padd::Base::Opcode = "padd";
template <> const char *InstImpl::InstX86Padds::Base::Opcode = "padds";
template <> const char *InstImpl::InstX86Paddus::Base::Opcode = "paddus";
template <> const char *InstImpl::InstX86Sub::Base::Opcode = "sub";
template <> const char *InstImpl::InstX86SubRMW::Base::Opcode = "sub";
template <> const char *InstImpl::InstX86Subps::Base::Opcode = "sub";
template <> const char *InstImpl::InstX86Subss::Base::Opcode = "sub";
template <> const char *InstImpl::InstX86Sbb::Base::Opcode = "sbb";
template <> const char *InstImpl::InstX86SbbRMW::Base::Opcode = "sbb";
template <> const char *InstImpl::InstX86Psub::Base::Opcode = "psub";
template <> const char *InstImpl::InstX86Psubs::Base::Opcode = "psubs";
template <> const char *InstImpl::InstX86Psubus::Base::Opcode = "psubus";
template <> const char *InstImpl::InstX86And::Base::Opcode = "and";
template <> const char *InstImpl::InstX86AndRMW::Base::Opcode = "and";
template <> const char *InstImpl::InstX86Pand::Base::Opcode = "pand";
template <> const char *InstImpl::InstX86Pandn::Base::Opcode = "pandn";
template <> const char *InstImpl::InstX86Or::Base::Opcode = "or";
template <> const char *InstImpl::InstX86Orps::Base::Opcode = "or";
template <> const char *InstImpl::InstX86OrRMW::Base::Opcode = "or";
template <> const char *InstImpl::InstX86Por::Base::Opcode = "por";
template <> const char *InstImpl::InstX86Xor::Base::Opcode = "xor";
template <> const char *InstImpl::InstX86Xorps::Base::Opcode = "xor";
template <> const char *InstImpl::InstX86XorRMW::Base::Opcode = "xor";
template <> const char *InstImpl::InstX86Pxor::Base::Opcode = "pxor";
template <> const char *InstImpl::InstX86Imul::Base::Opcode = "imul";
template <> const char *InstImpl::InstX86ImulImm::Base::Opcode = "imul";
template <> const char *InstImpl::InstX86Mulps::Base::Opcode = "mul";
template <> const char *InstImpl::InstX86Mulss::Base::Opcode = "mul";
template <> const char *InstImpl::InstX86Pmull::Base::Opcode = "pmull";
template <> const char *InstImpl::InstX86Pmulhw::Base::Opcode = "pmulhw";
template <> const char *InstImpl::InstX86Pmulhuw::Base::Opcode = "pmulhuw";
template <> const char *InstImpl::InstX86Pmaddwd::Base::Opcode = "pmaddwd";
template <> const char *InstImpl::InstX86Pmuludq::Base::Opcode = "pmuludq";
template <> const char *InstImpl::InstX86Div::Base::Opcode = "div";
template <> const char *InstImpl::InstX86Divps::Base::Opcode = "div";
template <> const char *InstImpl::InstX86Divss::Base::Opcode = "div";
template <> const char *InstImpl::InstX86Idiv::Base::Opcode = "idiv";
template <> const char *InstImpl::InstX86Rol::Base::Opcode = "rol";
template <> const char *InstImpl::InstX86Shl::Base::Opcode = "shl";
template <> const char *InstImpl::InstX86Psll::Base::Opcode = "psll";
template <> const char *InstImpl::InstX86Shr::Base::Opcode = "shr";
template <> const char *InstImpl::InstX86Sar::Base::Opcode = "sar";
template <> const char *InstImpl::InstX86Psra::Base::Opcode = "psra";
template <> const char *InstImpl::InstX86Psrl::Base::Opcode = "psrl";
template <> const char *InstImpl::InstX86Pcmpeq::Base::Opcode = "pcmpeq";
template <> const char *InstImpl::InstX86Pcmpgt::Base::Opcode = "pcmpgt";
template <> const char *InstImpl::InstX86MovssRegs::Base::Opcode = "movss";
/* Ternary ops */
template <> const char *InstImpl::InstX86Insertps::Base::Opcode = "insertps";
template <> const char *InstImpl::InstX86Round::Base::Opcode = "round";
template <> const char *InstImpl::InstX86Shufps::Base::Opcode = "shufps";
template <> const char *InstImpl::InstX86Pinsr::Base::Opcode = "pinsr";
template <> const char *InstImpl::InstX86Blendvps::Base::Opcode = "blendvps";
template <> const char *InstImpl::InstX86Pblendvb::Base::Opcode = "pblendvb";
/* Three address ops */
template <> const char *InstImpl::InstX86Pextr::Base::Opcode = "pextr";
template <> const char *InstImpl::InstX86Pshufd::Base::Opcode = "pshufd";
template <> const char *InstImpl::InstX86Pshufb::Base::Opcode = "pshufb";
template <> const char *InstImpl::InstX86Punpckl::Base::Opcode = "punpckl";
template <> const char *InstImpl::InstX86Punpckh::Base::Opcode = "punpckh";
template <> const char *InstImpl::InstX86Packss::Base::Opcode = "packss";
template <> const char *InstImpl::InstX86Packus::Base::Opcode = "packus";
/* Inplace GPR ops */
template <>
const InstImpl::Assembler::GPREmitterOneOp
    InstImpl::InstX86Bswap::Base::Emitter = {
        &InstImpl::Assembler::bswap, nullptr /* only a reg form exists */
};
template <>
const InstImpl::Assembler::GPREmitterOneOp InstImpl::InstX86Neg::Base::Emitter =
    {&InstImpl::Assembler::neg, &InstImpl::Assembler::neg};
/* Unary GPR ops */
/* uses specialized emitter. */
template <>
const InstImpl::Assembler::GPREmitterRegOp
    InstImpl::InstX86Cbwdq::Base::Emitter = {nullptr, nullptr, nullptr};
template <>
const InstImpl::Assembler::GPREmitterRegOp InstImpl::InstX86Bsf::Base::Emitter =
    {&InstImpl::Assembler::bsf, &InstImpl::Assembler::bsf, nullptr};
template <>
const InstImpl::Assembler::GPREmitterRegOp InstImpl::InstX86Bsr::Base::Emitter =
    {&InstImpl::Assembler::bsr, &InstImpl::Assembler::bsr, nullptr};
template <>
const InstImpl::Assembler::GPREmitterRegOp InstImpl::InstX86Lea::Base::Emitter =
    {
        /* reg/reg and reg/imm are illegal */ nullptr,
        &InstImpl::Assembler::lea, nullptr};
template <>
const InstImpl::Assembler::GPREmitterRegOp
    InstImpl::InstX86Movsx::Base::Emitter = {
        &InstImpl::Assembler::movsx, &InstImpl::Assembler::movsx, nullptr};
template <>
const InstImpl::Assembler::GPREmitterRegOp
    InstImpl::InstX86Movzx::Base::Emitter = {
        &InstImpl::Assembler::movzx, &InstImpl::Assembler::movzx, nullptr};
/* Unary XMM ops */
/* uses specialized emitter. */
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Movd::Base::Emitter = {nullptr, nullptr};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Sqrt::Base::Emitter = {&InstImpl::Assembler::sqrt,
                                            &InstImpl::Assembler::sqrt};
/* Binary GPR ops */
/* uses specialized emitter. */
template <>
const InstImpl::Assembler::GPREmitterRegOp
    InstImpl::InstX86Imul::Base::Emitter = {nullptr, nullptr, nullptr};
template <>
const InstImpl::Assembler::GPREmitterRegOp InstImpl::InstX86Add::Base::Emitter =
    {&InstImpl::Assembler::add, &InstImpl::Assembler::add,
     &InstImpl::Assembler::add};
template <>
const InstImpl::Assembler::GPREmitterAddrOp
    InstImpl::InstX86AddRMW::Base::Emitter = {&InstImpl::Assembler::add,
                                              &InstImpl::Assembler::add};
template <>
const InstImpl::Assembler::GPREmitterRegOp InstImpl::InstX86Adc::Base::Emitter =
    {&InstImpl::Assembler::adc, &InstImpl::Assembler::adc,
     &InstImpl::Assembler::adc};
template <>
const InstImpl::Assembler::GPREmitterAddrOp
    InstImpl::InstX86AdcRMW::Base::Emitter = {&InstImpl::Assembler::adc,
                                              &InstImpl::Assembler::adc};
template <>
const InstImpl::Assembler::GPREmitterRegOp InstImpl::InstX86And::Base::Emitter =
    {&InstImpl::Assembler::And, &InstImpl::Assembler::And,
     &InstImpl::Assembler::And};
template <>
const InstImpl::Assembler::GPREmitterAddrOp
    InstImpl::InstX86AndRMW::Base::Emitter = {&InstImpl::Assembler::And,
                                              &InstImpl::Assembler::And};
template <>
const InstImpl::Assembler::GPREmitterRegOp InstImpl::InstX86Or::Base::Emitter =
    {&InstImpl::Assembler::Or, &InstImpl::Assembler::Or,
     &InstImpl::Assembler::Or};
template <>
const InstImpl::Assembler::GPREmitterAddrOp
    InstImpl::InstX86OrRMW::Base::Emitter = {&InstImpl::Assembler::Or,
                                             &InstImpl::Assembler::Or};
template <>
const InstImpl::Assembler::GPREmitterRegOp InstImpl::InstX86Sbb::Base::Emitter =
    {&InstImpl::Assembler::sbb, &InstImpl::Assembler::sbb,
     &InstImpl::Assembler::sbb};
template <>
const InstImpl::Assembler::GPREmitterAddrOp
    InstImpl::InstX86SbbRMW::Base::Emitter = {&InstImpl::Assembler::sbb,
                                              &InstImpl::Assembler::sbb};
template <>
const InstImpl::Assembler::GPREmitterRegOp InstImpl::InstX86Sub::Base::Emitter =
    {&InstImpl::Assembler::sub, &InstImpl::Assembler::sub,
     &InstImpl::Assembler::sub};
template <>
const InstImpl::Assembler::GPREmitterAddrOp
    InstImpl::InstX86SubRMW::Base::Emitter = {&InstImpl::Assembler::sub,
                                              &InstImpl::Assembler::sub};
template <>
const InstImpl::Assembler::GPREmitterRegOp InstImpl::InstX86Xor::Base::Emitter =
    {&InstImpl::Assembler::Xor, &InstImpl::Assembler::Xor,
     &InstImpl::Assembler::Xor};
template <>
const InstImpl::Assembler::GPREmitterAddrOp
    InstImpl::InstX86XorRMW::Base::Emitter = {&InstImpl::Assembler::Xor,
                                              &InstImpl::Assembler::Xor};
/* Binary Shift GPR ops */
template <>
const InstImpl::Assembler::GPREmitterShiftOp
    InstImpl::InstX86Rol::Base::Emitter = {&InstImpl::Assembler::rol,
                                           &InstImpl::Assembler::rol};
template <>
const InstImpl::Assembler::GPREmitterShiftOp
    InstImpl::InstX86Sar::Base::Emitter = {&InstImpl::Assembler::sar,
                                           &InstImpl::Assembler::sar};
template <>
const InstImpl::Assembler::GPREmitterShiftOp
    InstImpl::InstX86Shl::Base::Emitter = {&InstImpl::Assembler::shl,
                                           &InstImpl::Assembler::shl};
template <>
const InstImpl::Assembler::GPREmitterShiftOp
    InstImpl::InstX86Shr::Base::Emitter = {&InstImpl::Assembler::shr,
                                           &InstImpl::Assembler::shr};
/* Binary XMM ops */
/* uses specialized emitter. */
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86MovssRegs::Base::Emitter = {nullptr, nullptr};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Addss::Base::Emitter = {&InstImpl::Assembler::addss,
                                             &InstImpl::Assembler::addss};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Addps::Base::Emitter = {&InstImpl::Assembler::addps,
                                             &InstImpl::Assembler::addps};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Divss::Base::Emitter = {&InstImpl::Assembler::divss,
                                             &InstImpl::Assembler::divss};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Divps::Base::Emitter = {&InstImpl::Assembler::divps,
                                             &InstImpl::Assembler::divps};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Mulss::Base::Emitter = {&InstImpl::Assembler::mulss,
                                             &InstImpl::Assembler::mulss};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Mulps::Base::Emitter = {&InstImpl::Assembler::mulps,
                                             &InstImpl::Assembler::mulps};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Padd::Base::Emitter = {&InstImpl::Assembler::padd,
                                            &InstImpl::Assembler::padd};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Padds::Base::Emitter = {&InstImpl::Assembler::padds,
                                             &InstImpl::Assembler::padds};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Paddus::Base::Emitter = {&InstImpl::Assembler::paddus,
                                              &InstImpl::Assembler::paddus};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Pand::Base::Emitter = {&InstImpl::Assembler::pand,
                                            &InstImpl::Assembler::pand};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Pandn::Base::Emitter = {&InstImpl::Assembler::pandn,
                                             &InstImpl::Assembler::pandn};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Pcmpeq::Base::Emitter = {&InstImpl::Assembler::pcmpeq,
                                              &InstImpl::Assembler::pcmpeq};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Pcmpgt::Base::Emitter = {&InstImpl::Assembler::pcmpgt,
                                              &InstImpl::Assembler::pcmpgt};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Pmull::Base::Emitter = {&InstImpl::Assembler::pmull,
                                             &InstImpl::Assembler::pmull};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Pmulhw::Base::Emitter = {&InstImpl::Assembler::pmulhw,
                                              &InstImpl::Assembler::pmulhw};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Pmulhuw::Base::Emitter = {&InstImpl::Assembler::pmulhuw,
                                               &InstImpl::Assembler::pmulhuw};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Pmaddwd::Base::Emitter = {&InstImpl::Assembler::pmaddwd,
                                               &InstImpl::Assembler::pmaddwd};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Pmuludq::Base::Emitter = {&InstImpl::Assembler::pmuludq,
                                               &InstImpl::Assembler::pmuludq};
template <>
const InstImpl::Assembler::XmmEmitterRegOp InstImpl::InstX86Por::Base::Emitter =
    {&InstImpl::Assembler::por, &InstImpl::Assembler::por};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Psub::Base::Emitter = {&InstImpl::Assembler::psub,
                                            &InstImpl::Assembler::psub};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Psubs::Base::Emitter = {&InstImpl::Assembler::psubs,
                                             &InstImpl::Assembler::psubs};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Psubus::Base::Emitter = {&InstImpl::Assembler::psubus,
                                              &InstImpl::Assembler::psubus};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Pxor::Base::Emitter = {&InstImpl::Assembler::pxor,
                                            &InstImpl::Assembler::pxor};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Subss::Base::Emitter = {&InstImpl::Assembler::subss,
                                             &InstImpl::Assembler::subss};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Subps::Base::Emitter = {&InstImpl::Assembler::subps,
                                             &InstImpl::Assembler::subps};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Andnps::Base::Emitter = {&InstImpl::Assembler::andnps,
                                              &InstImpl::Assembler::andnps};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Andps::Base::Emitter = {&InstImpl::Assembler::andps,
                                             &InstImpl::Assembler::andps};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Maxss::Base::Emitter = {&InstImpl::Assembler::maxss,
                                             &InstImpl::Assembler::maxss};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Minss::Base::Emitter = {&InstImpl::Assembler::minss,
                                             &InstImpl::Assembler::minss};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Maxps::Base::Emitter = {&InstImpl::Assembler::maxps,
                                             &InstImpl::Assembler::maxps};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Minps::Base::Emitter = {&InstImpl::Assembler::minps,
                                             &InstImpl::Assembler::minps};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Orps::Base::Emitter = {&InstImpl::Assembler::orps,
                                            &InstImpl::Assembler::orps};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Xorps::Base::Emitter = {
        &InstImpl::Assembler::xorps,
        &InstImpl::Assembler::xorps}; /* Binary XMM Shift ops */
template <>
const InstImpl::Assembler::XmmEmitterShiftOp
    InstImpl::InstX86Psll::Base::Emitter = {&InstImpl::Assembler::psll,
                                            &InstImpl::Assembler::psll,
                                            &InstImpl::Assembler::psll};
template <>
const InstImpl::Assembler::XmmEmitterShiftOp
    InstImpl::InstX86Psra::Base::Emitter = {&InstImpl::Assembler::psra,
                                            &InstImpl::Assembler::psra,
                                            &InstImpl::Assembler::psra};
template <>
const InstImpl::Assembler::XmmEmitterShiftOp
    InstImpl::InstX86Psrl::Base::Emitter = {&InstImpl::Assembler::psrl,
                                            &InstImpl::Assembler::psrl,
                                            &InstImpl::Assembler::psrl};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Pshufb::Base::Emitter = {&InstImpl::Assembler::pshufb,
                                              &InstImpl::Assembler::pshufb};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Punpckl::Base::Emitter = {&InstImpl::Assembler::punpckl,
                                               &InstImpl::Assembler::punpckl};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Punpckh::Base::Emitter = {&InstImpl::Assembler::punpckh,
                                               &InstImpl::Assembler::punpckh};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Packss::Base::Emitter = {&InstImpl::Assembler::packss,
                                              &InstImpl::Assembler::packss};
template <>
const InstImpl::Assembler::XmmEmitterRegOp
    InstImpl::InstX86Packus::Base::Emitter = {&InstImpl::Assembler::packus,
                                              &InstImpl::Assembler::packus};

const char *InstImpl::InstX86Base::getWidthString(Type Ty) {
  return Traits::TypeAttributes[Ty].WidthString;
}

const char *InstImpl::InstX86Base::getFldString(Type Ty) {
  return Traits::TypeAttributes[Ty].FldString;
}

typename InstImpl::Cond::BrCond
InstImpl::InstX86Base::getOppositeCondition(BrCond Cond) {
  return Traits::InstBrAttributes[Cond].Opposite;
}

InstImpl::InstX86FakeRMW::InstX86FakeRMW(Cfg *Func, Operand *Data,
                                         Operand *Addr,
...
InstImpl::InstX86GetIP::InstX86GetIP(Cfg *Func, Variable *Dest)
    : InstX86Base(Func, InstX86Base::GetIP, 0, Dest) {}

InstImpl::InstX86Mul::InstX86Mul(Cfg *Func, Variable *Dest, Variable *Source1,
                                 Operand *Source2)
...
InstImpl::InstX86Shld::InstX86Shld(Cfg *Func, Variable *Dest, Variable *Source1,
                                   Operand *Source2)
...
InstImpl::InstX86Shrd::InstX86Shrd(Cfg *Func, Variable *Dest, Variable *Source1,
                                   Operand *Source2)
...
InstImpl::InstX86Label::InstX86Label(Cfg *Func, TargetLowering *Target)
...
InstImpl::InstX86Br::InstX86Br(Cfg *Func, const CfgNode *TargetTrue,
...
bool InstImpl::InstX86Br::optimizeBranch(const CfgNode *NextNode) {
...
bool InstImpl::InstX86Br::repointEdges(CfgNode *OldNode, CfgNode *NewNode) {
  bool Found = false;
...
InstImpl::InstX86Jmp::InstX86Jmp(Cfg *Func, Operand *Target)
    : InstX86Base(Func, InstX86Base::Jmp, 1, nullptr) {
  this->addSource(Target);
}

InstImpl::InstX86Call::InstX86Call(Cfg *Func, Variable *Dest,
                                   Operand *CallTarget)
...
InstImpl::InstX86Movmsk::InstX86Movmsk(Cfg *Func, Variable *Dest,
                                       Operand *Source)
    : InstX86Base(Func, InstX86Base::Movmsk, 1, Dest) {
  this->addSource(Source);
}

InstImpl::InstX86Cmov::InstX86Cmov(Cfg *Func, Variable *Dest, Operand *Source,
                                   BrCond Condition)
...
InstImpl::InstX86Cmpps::InstX86Cmpps(Cfg *Func, Variable *Dest, Operand *Source,
                                     CmppsCond Condition)
...
InstImpl::InstX86Cmpxchg::InstX86Cmpxchg(Cfg *Func, Operand *DestOrAddr,
                                         Variable *Eax, Variable *Desired,
                                         bool Locked)
    : InstImpl::InstX86BaseLockable(Func, InstX86Base::Cmpxchg, 3,
...
InstImpl::InstX86Cmpxchg8b::InstX86Cmpxchg8b(Cfg *Func, X86OperandMem *Addr,
                                             Variable *Edx, Variable *Eax,
                                             Variable *Ecx, Variable *Ebx,
                                             bool Locked)
    : InstImpl::InstX86BaseLockable(Func, InstX86Base::Cmpxchg, 5, nullptr,
                                    Locked) {
...
InstImpl::InstX86Cvt::InstX86Cvt(Cfg *Func, Variable *Dest, Operand *Source,
                                 CvtVariant Variant)
    : InstX86Base(Func, InstX86Base::Cvt, 1, Dest), Variant(Variant) {
  this->addSource(Source);
}

InstImpl::InstX86Icmp::InstX86Icmp(Cfg *Func, Operand *Src0, Operand *Src1)
    : InstX86Base(Func, InstX86Base::Icmp, 2, nullptr) {
  this->addSource(Src0);
  this->addSource(Src1);
}

InstImpl::InstX86Ucomiss::InstX86Ucomiss(Cfg *Func, Operand *Src0,
                                         Operand *Src1)
...
InstImpl::InstX86UD2::InstX86UD2(Cfg *Func)
    : InstX86Base(Func, InstX86Base::UD2, 0, nullptr) {}

InstImpl::InstX86Int3::InstX86Int3(Cfg *Func)
    : InstX86Base(Func, InstX86Base::Int3, 0, nullptr) {}

InstImpl::InstX86Test::InstX86Test(Cfg *Func, Operand *Src1, Operand *Src2)
    : InstX86Base(Func, InstX86Base::Test, 2, nullptr) {
  this->addSource(Src1);
  this->addSource(Src2);
}

InstImpl::InstX86Mfence::InstX86Mfence(Cfg *Func)
    : InstX86Base(Func, InstX86Base::Mfence, 0, nullptr) {
  this->HasSideEffects = true;
}

InstImpl::InstX86Store::InstX86Store(Cfg *Func, Operand *Value, X86Operand *Mem)
    : InstX86Base(Func, InstX86Base::Store, 2, nullptr) {
  this->addSource(Value);
  this->addSource(Mem);
}

InstImpl::InstX86StoreP::InstX86StoreP(Cfg *Func, Variable *Value,
                                       X86OperandMem *Mem)
...
InstImpl::InstX86StoreQ::InstX86StoreQ(Cfg *Func, Operand *Value,
                                       X86OperandMem *Mem)
...
InstImpl::InstX86StoreD::InstX86StoreD(Cfg *Func, Operand *Value,
                                       X86OperandMem *Mem)
...
InstImpl::InstX86Nop::InstX86Nop(Cfg *Func, NopVariant Variant)
    : InstX86Base(Func, InstX86Base::Nop, 0, nullptr), Variant(Variant) {}

InstImpl::InstX86Pop::InstX86Pop(Cfg *Func, Variable *Dest)
...
InstImpl::InstX86Push::InstX86Push(Cfg *Func, Operand *Source)
    : InstX86Base(Func, InstX86Base::Push, 1, nullptr) {
  this->addSource(Source);
}

InstImpl::InstX86Push::InstX86Push(Cfg *Func, InstX86Label *L)
    : InstX86Base(Func, InstX86Base::Push, 0, nullptr), Label(L) {}

InstImpl::InstX86Ret::InstX86Ret(Cfg *Func, Variable *Source)
    : InstX86Base(Func, InstX86Base::Ret, Source ? 1 : 0, nullptr) {
  if (Source)
    this->addSource(Source);
}

InstImpl::InstX86Setcc::InstX86Setcc(Cfg *Func, Variable *Dest, BrCond Cond)
    : InstX86Base(Func, InstX86Base::Setcc, 0, Dest), Condition(Cond) {}

InstImpl::InstX86Xadd::InstX86Xadd(Cfg *Func, Operand *Dest, Variable *Source,
                                   bool Locked)
    : InstImpl::InstX86BaseLockable(Func, InstX86Base::Xadd, 2,
                                    llvm::dyn_cast<Variable>(Dest), Locked) {
  this->addSource(Dest);
  this->addSource(Source);
}

InstImpl::InstX86Xchg::InstX86Xchg(Cfg *Func, Operand *Dest, Variable *Source)
    : InstX86Base(Func, InstX86Base::Xchg, 2, llvm::dyn_cast<Variable>(Dest)) {
  this->addSource(Dest);
  this->addSource(Source);
}

InstImpl::InstX86IacaStart::InstX86IacaStart(Cfg *Func)
    : InstX86Base(Func, InstX86Base::IacaStart, 0, nullptr) {
  assert(getFlags().getAllowIacaMarks());
}

InstImpl::InstX86IacaEnd::InstX86IacaEnd(Cfg *Func)
...
void InstImpl::InstX86Base::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
...
void InstImpl::InstX86FakeRMW::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
...
void InstImpl::InstX86GetIP::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
...
void InstImpl::InstX86GetIP::emitIAS(const Cfg *Func) const {
  const auto *Dest = this->getDest();
...
void InstImpl::InstX86GetIP::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
...
void InstImpl::InstX86Label::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  Str << getLabelName() << ":";
...
void InstImpl::InstX86Label::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
...
void InstImpl::InstX86Label::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  Str << getLabelName() << ":";
...
void InstImpl::InstX86Br::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  Str << "\t";
...
void InstImpl::InstX86Br::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  if (Label) {
...
void InstImpl::InstX86Br::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  Str << "br ";
...
void InstImpl::InstX86Jmp::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
...
void InstImpl::InstX86Jmp::emitIAS(const Cfg *Func) const {
  // Note: Adapted (mostly copied) from
  // InstImpl::InstX86Call::emitIAS().
  Assembler *Asm = Func->getAssembler<Assembler>();
...
void InstImpl::InstX86Jmp::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  Str << "jmp ";
...
void InstImpl::InstX86Call::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 1);
...
void InstImpl::InstX86Call::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  Operand *CallTarget = getCallTarget();
  auto *Target = InstX86Base::getTarget(Func);
...
void InstImpl::InstX86Call::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  if (this->getDest()) {
...
void InstImpl::InstX86Base::emitTwoAddress(const Cfg *Func, const char *Opcode,
...
void InstImpl::emitIASOpTyGPR(const Cfg *Func, Type Ty, const Operand *Op,
...
void InstImpl::emitIASRegOpTyGPR(const Cfg *Func, bool IsLea, Type Ty,
...
void InstImpl::emitIASAddrOpTyGPR(const Cfg *Func, Type Ty, const Address &Addr,
                                  const Operand *Src,
...
void InstImpl::emitIASAsAddrOpTyGPR(const Cfg *Func, Type Ty,
...
void InstImpl::emitIASGPRShift(const Cfg *Func, Type Ty, const Variable *Var,
                               const Operand *Src,
...
void InstImpl::emitIASGPRShiftDouble(const Cfg *Func, const Variable *Dest,
...
void InstImpl::emitIASXmmShift(const Cfg *Func, Type Ty, const Variable *Var,
                               const Operand *Src,
...
void InstImpl::emitIASRegOpTyXMM(const Cfg *Func, Type Ty, const Variable *Var,
                                 const Operand *Src,
...
void InstImpl::emitIASCastRegOp(
...
template <typename DReg_t, typename SReg_t, DReg_t (*destEnc)(RegNumT),
          SReg_t (*srcEnc)(RegNumT)>
void InstImpl::emitIASThreeOpImmOps(
...
void InstImpl::emitIASMovlikeXMM(const Cfg *Func, const Variable *Dest,
                                 const Operand *Src,
...
void InstImpl::InstX86Movmsk::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  this->dumpDest(Func);
...
void InstImpl::InstX86Movmsk::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 1);
...
void InstImpl::InstX86Movmsk::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 1);
  Assembler *Asm = Func->getAssembler<Assembler>();
...
void InstImpl::InstX86Sqrt::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 1);
...
void InstImpl::InstX86Div::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
...
void InstImpl::InstX86Div::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 3);
...
void InstImpl::InstX86Idiv::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 3);
...
void InstImpl::InstX86Idiv::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 3);
  const Operand *Src = this->getSrc(1);
  Type Ty = Src->getType();
...
void InstImpl::emitVariableBlendInst(const char *Opcode, const Inst *Instr,
                                     const Cfg *Func) {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
...
void InstImpl::emitIASVariableBlendInst(const Inst *Instr, const Cfg *Func,
                                        const XmmEmitterRegOp &Emitter) {
  assert(Instr->getSrcSize() == 3);
  assert(llvm::cast<Variable>(Instr->getSrc(2))->getRegNum() ==
         RegisterSet::Reg_xmm0);
...
void InstImpl::InstX86Blendvps::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  emitVariableBlendInst(this->Opcode, this, Func);
}

void InstImpl::InstX86Blendvps::emitIAS(const Cfg *Func) const {
  static const XmmEmitterRegOp Emitter = {&Assembler::blendvps,
                                          &Assembler::blendvps};
  emitIASVariableBlendInst(this, Func, Emitter);
}

void InstImpl::InstX86Pblendvb::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  emitVariableBlendInst(this->Opcode, this, Func);
}

void InstImpl::InstX86Pblendvb::emitIAS(const Cfg *Func) const {
  static const XmmEmitterRegOp Emitter = {&Assembler::pblendvb,
                                          &Assembler::pblendvb};
  emitIASVariableBlendInst(this, Func, Emitter);
}

void InstImpl::InstX86Imul::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
...
void InstImpl::InstX86Imul::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86ImulImm::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86ImulImm::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 2);
  const Variable *Dest = this->getDest();
...
void InstImpl::InstX86Insertps::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 3);
...
void InstImpl::InstX86Cbwdq::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 1);
...
void InstImpl::InstX86Cbwdq::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  assert(this->getSrcSize() == 1);
  Operand *Src0 = this->getSrc(0);
  const auto DestReg = this->getDest()->getRegNum();
...
void InstImpl::InstX86Mul::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86Mul::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 2);
  assert(llvm::isa<Variable>(this->getSrc(0)));
  assert(llvm::cast<Variable>(this->getSrc(0))->getRegNum() ==
         RegisterSet::Reg_eax);
...
void InstImpl::InstX86Mul::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  this->dumpDest(Func);
...
void InstImpl::InstX86Shld::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  Variable *Dest = this->getDest();
...
void InstImpl::InstX86Shld::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 3);
...
void InstImpl::InstX86Shld::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  this->dumpDest(Func);
...
void InstImpl::InstX86Shrd::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  Variable *Dest = this->getDest();
...
void InstImpl::InstX86Shrd::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 3);
  assert(this->getDest() == this->getSrc(0));
  const Variable *Dest = this->getDest();
  const Operand *Src1 = this->getSrc(1);
...
void InstImpl::InstX86Shrd::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  this->dumpDest(Func);
...
void InstImpl::InstX86Cmov::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  Variable *Dest = this->getDest();
...
void InstImpl::InstX86Cmov::emitIAS(const Cfg *Func) const {
  assert(Condition != Cond::Br_None);
  assert(this->getDest()->hasReg());
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86Cmov::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  Str << "cmov" << Traits::InstBrAttributes[Condition].DisplayString << ".";
...
void InstImpl::InstX86Cmpps::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86Cmpps::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  assert(this->getSrcSize() == 2);
  assert(Condition < Cond::Cmpps_Invalid);
...
void InstImpl::InstX86Cmpps::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  assert(Condition < Cond::Cmpps_Invalid);
...
void InstImpl::InstX86Cmpxchg::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 3);
...
void InstImpl::InstX86Cmpxchg::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 3);
  Assembler *Asm = Func->getAssembler<Assembler>();
  Type Ty = this->getSrc(0)->getType();
  auto *Target = InstX86Base::getTarget(Func);
...
void InstImpl::InstX86Cmpxchg::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  if (this->Locked) {
...
void InstImpl::InstX86Cmpxchg8b::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
...
void InstImpl::InstX86Cmpxchg8b::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 5);
  Assembler *Asm = Func->getAssembler<Assembler>();
  const auto Mem = llvm::cast<X86OperandMem>(this->getSrc(0));
  assert(Mem->getSegmentRegister() == X86OperandMem::DefaultSegment);
...
void InstImpl::InstX86Cmpxchg8b::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  if (this->Locked) {
...
void InstImpl::InstX86Cvt::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 1);
...
void InstImpl::InstX86Cvt::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 1);
  const Variable *Dest = this->getDest();
  const Operand *Src = this->getSrc(0);
...
void InstImpl::InstX86Cvt::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  this->dumpDest(Func);
...
void InstImpl::InstX86Round::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 3);
...
void InstImpl::InstX86Round::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 2);
  assert(InstX86Base::getTarget(Func)->getInstructionSet() >= Traits::SSE4_1);
  const Variable *Dest = this->getDest();
  Type Ty = Dest->getType();
...
void InstImpl::InstX86Icmp::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86Icmp::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86Icmp::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
...
void InstImpl::InstX86Ucomiss::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86Ucomiss::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86Ucomiss::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
...
void InstImpl::InstX86UD2::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
...
void InstImpl::InstX86UD2::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  Asm->ud2();
}

void InstImpl::InstX86UD2::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  Str << "ud2";
...
void InstImpl::InstX86Int3::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 0);
...
void InstImpl::InstX86Int3::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  Asm->int3();
}

void InstImpl::InstX86Int3::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  Str << "int 3";
...
void InstImpl::InstX86Test::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86Test::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 2);
  const Operand *Src0 = this->getSrc(0);
  const Operand *Src1 = this->getSrc(1);
  Type Ty = Src0->getType();
...
void InstImpl::InstX86Test::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
...
void InstImpl::InstX86Mfence::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 0);
...
void InstImpl::InstX86Mfence::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  Asm->mfence();
}

void InstImpl::InstX86Mfence::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  Str << "mfence";
...
void InstImpl::InstX86Store::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86Store::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86Store::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
...
void InstImpl::InstX86StoreP::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86StoreP::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86StoreP::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
...
void InstImpl::InstX86StoreQ::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86StoreQ::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  assert(this->getSrcSize() == 2);
  const auto *SrcVar = llvm::cast<Variable>(this->getSrc(0));
  const auto DestMem = llvm::cast<X86OperandMem>(this->getSrc(1));
...
void InstImpl::InstX86StoreQ::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
...
void InstImpl::InstX86StoreD::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86StoreD::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  assert(this->getSrcSize() == 2);
  const auto *SrcVar = llvm::cast<Variable>(this->getSrc(0));
  const auto DestMem = llvm::cast<X86OperandMem>(this->getSrc(1));
...
void InstImpl::InstX86StoreD::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
...
void InstImpl::InstX86Lea::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
...
void InstImpl::InstX86Mov::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 1);
...
void InstImpl::InstX86Mov::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 1);
  const Variable *Dest = this->getDest();
  const Operand *Src = this->getSrc(0);
  Type DestTy = Dest->getType();
...
void InstImpl::InstX86Movd::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  assert(this->getSrcSize() == 1);
  Variable *Dest = this->getDest();
...
void InstImpl::InstX86Movd::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  assert(this->getSrcSize() == 1);
  const Variable *Dest = this->getDest();
  auto *Target = InstX86Base::getTarget(Func);
...
void InstImpl::InstX86Movp::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
...
void InstImpl::InstX86Movp::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 1);
...
void InstImpl::InstX86Movq::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 1);
...
void InstImpl::InstX86Movq::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 1);
  assert(this->getDest()->getType() == IceType_i64 ||
         this->getDest()->getType() == IceType_f64 ||
...
void InstImpl::InstX86MovssRegs::emitIAS(const Cfg *Func) const {
...
void InstImpl::InstX86Movsx::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 1);
  const Variable *Dest = this->getDest();
  const Operand *Src = this->getSrc(0);
...
void InstImpl::InstX86Nop::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
...
void InstImpl::InstX86Nop::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  // TODO: Emit the right code for the variant.
  Asm->nop();
}

void InstImpl::InstX86Nop::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
...
void InstImpl::InstX86Pextr::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 2);
...
void InstImpl::InstX86Pextr::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 2);
  // pextrb and pextrd are SSE4.1 instructions.
  const Variable *Dest = this->getDest();
...
void InstImpl::InstX86Pinsr::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 3);
...
void InstImpl::InstX86Pinsr::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 3);
  assert(this->getDest() == this->getSrc(0));
...
void InstImpl::InstX86Pshufd::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 2);
  const Variable *Dest = this->getDest();
  Type Ty = Dest->getType();
  static const ThreeOpImmEmitter<XmmRegister, XmmRegister> Emitter = {
...
void InstImpl::InstX86Shufps::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 3);
  const Variable *Dest = this->getDest();
  assert(Dest == this->getSrc(0));
  Type Ty = Dest->getType();
...
void InstImpl::InstX86Pop::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  assert(this->getSrcSize() == 0);
...
void InstImpl::InstX86Pop::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 0);
  Assembler *Asm = Func->getAssembler<Assembler>();
...
void InstImpl::InstX86Pop::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  this->dumpDest(Func);
...
void InstImpl::InstX86Push::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  Str << "\t"
...
void InstImpl::InstX86Push::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
...
void InstImpl::InstX86Push::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
...
void InstImpl::InstX86Ret::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  Str << "\t"
...
void InstImpl::InstX86Ret::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  Asm->ret();
}

void InstImpl::InstX86Ret::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  Type Ty =
...
void InstImpl::InstX86Setcc::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  Str << "\t"
...
void InstImpl::InstX86Setcc::emitIAS(const Cfg *Func) const {
  assert(Condition != Cond::Br_None);
...
void InstImpl::InstX86Setcc::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
...
void InstImpl::InstX86Xadd::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  if (this->Locked) {
...
void InstImpl::InstX86Xadd::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 2);
  Assembler *Asm = Func->getAssembler<Assembler>();
  Type Ty = this->getSrc(0)->getType();
  const auto Mem = llvm::cast<X86OperandMem>(this->getSrc(0));
...
void InstImpl::InstX86Xadd::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  if (this->Locked) {
...
void InstImpl::InstX86Xchg::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  Str << "\t"
...
void InstImpl::InstX86Xchg::emitIAS(const Cfg *Func) const {
  assert(this->getSrcSize() == 2);
  Assembler *Asm = Func->getAssembler<Assembler>();
  Type Ty = this->getSrc(0)->getType();
...
void InstImpl::InstX86Xchg::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  Type Ty = this->getSrc(0)->getType();
...
void InstImpl::InstX86IacaStart::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  Str << "\t# IACA_START\n"
...
void InstImpl::InstX86IacaStart::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  Asm->iaca_start();
}

void InstImpl::InstX86IacaStart::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  Str << "IACA_START";
...
void InstImpl::InstX86IacaEnd::emit(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrEmit();
  Str << "\t# IACA_END\n"
...
void InstImpl::InstX86IacaEnd::emitIAS(const Cfg *Func) const {
  Assembler *Asm = Func->getAssembler<Assembler>();
  Asm->iaca_end();
}

void InstImpl::InstX86IacaEnd::dump(const Cfg *Func) const {
  if (!BuildDefs::dump())
    return;
  Ostream &Str = Func->getContext()->getStrDump();
  Str << "IACA_END";
