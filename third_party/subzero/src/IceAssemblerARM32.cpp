...
void AssemblerARM32::vldrq(const Operand *OpQd, const Operand *OpAddress,
                           CondARM32::Cond Cond, const TargetInfo &TInfo) {
  // This is a pseudo-instruction which loads 32-bit data into a quadword
...
void AssemblerARM32::vld1(size_t ElmtSize, const Operand *OpQd, const Operand *OpAddress, const TargetInfo &TInfo) {
  ...
  // VLD1 (single elements to one lane) - ARMv7-A/R section A8.6.308, encoding A1:
...
void AssemblerARM32::vst1(size_t ElmtSize, const Operand *OpQd,
  ...
  // VST1 (single element from one lane) - ARMv7-A/R section A8.6.392, encoding A1:
