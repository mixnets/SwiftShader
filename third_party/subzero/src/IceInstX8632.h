...
/// automatically.
#define X86INSTS_DEFINE_STATIC_DATA(X8632, TraitsType)                         \
  namespace Ice {                                                              \
  namespace X8632 {                                                            \
  /* In-place ops */                                                           \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Bswap::Base::Opcode = "bswap";                  \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Neg::Base::Opcode = "neg";                      \
  /* Unary ops */                                                              \
  template <>                                                                  \
  template <>                                                                  \
  ...
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Bsr::Base::Opcode = "bsr";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Lea::Base::Opcode = "lea";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Movd::Base::Opcode = "movd";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Movsx::Base::Opcode = "movs";                   \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Movzx::Base::Opcode = "movz";                   \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Sqrt::Base::Opcode = "sqrt";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Cbwdq::Base::Opcode = "cbw/cwd/cdq";            \
  /* Mov-like ops */                                                           \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Mov::Base::Opcode = "mov";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Movp::Base::Opcode = "movups";                  \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Movq::Base::Opcode = "movq";                    \
  /* Binary ops */                                                             \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Add::Base::Opcode = "add";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86AddRMW::Base::Opcode = "add";                   \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Addps::Base::Opcode = "add";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Adc::Base::Opcode = "adc";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86AdcRMW::Base::Opcode = "adc";                   \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Addss::Base::Opcode = "add";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Andnps::Base::Opcode = "andn";                  \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Andps::Base::Opcode = "and";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Maxss::Base::Opcode = "max";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Minss::Base::Opcode = "min";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Maxps::Base::Opcode = "max";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Minps::Base::Opcode = "min";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Padd::Base::Opcode = "padd";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Padds::Base::Opcode = "padds";                  \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Paddus::Base::Opcode = "paddus";                \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Sub::Base::Opcode = "sub";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86SubRMW::Base::Opcode = "sub";                   \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Subps::Base::Opcode = "sub";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Subss::Base::Opcode = "sub";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Sbb::Base::Opcode = "sbb";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86SbbRMW::Base::Opcode = "sbb";                   \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Psub::Base::Opcode = "psub";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Psubs::Base::Opcode = "psubs";                  \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Psubus::Base::Opcode = "psubus";                \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86And::Base::Opcode = "and";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86AndRMW::Base::Opcode = "and";                   \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pand::Base::Opcode = "pand";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pandn::Base::Opcode = "pandn";                  \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Or::Base::Opcode = "or";                        \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Orps::Base::Opcode = "or";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86OrRMW::Base::Opcode = "or";                     \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Por::Base::Opcode = "por";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Xor::Base::Opcode = "xor";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Xorps::Base::Opcode = "xor";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86XorRMW::Base::Opcode = "xor";                   \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pxor::Base::Opcode = "pxor";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Imul::Base::Opcode = "imul";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86ImulImm::Base::Opcode = "imul";                 \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Mulps::Base::Opcode = "mul";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Mulss::Base::Opcode = "mul";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pmull::Base::Opcode = "pmull";                  \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pmulhw::Base::Opcode = "pmulhw";                \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pmulhuw::Base::Opcode = "pmulhuw";              \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pmaddwd::Base::Opcode = "pmaddwd";              \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pmuludq::Base::Opcode = "pmuludq";              \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Div::Base::Opcode = "div";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Divps::Base::Opcode = "div";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Divss::Base::Opcode = "div";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Idiv::Base::Opcode = "idiv";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Rol::Base::Opcode = "rol";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Shl::Base::Opcode = "shl";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Psll::Base::Opcode = "psll";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Shr::Base::Opcode = "shr";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Sar::Base::Opcode = "sar";                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Psra::Base::Opcode = "psra";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Psrl::Base::Opcode = "psrl";                    \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pcmpeq::Base::Opcode = "pcmpeq";                \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pcmpgt::Base::Opcode = "pcmpgt";                \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86MovssRegs::Base::Opcode = "movss";              \
  /* Ternary ops */                                                            \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Insertps::Base::Opcode = "insertps";            \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Round::Base::Opcode = "round";                  \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Shufps::Base::Opcode = "shufps";                \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pinsr::Base::Opcode = "pinsr";                  \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Blendvps::Base::Opcode = "blendvps";            \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pblendvb::Base::Opcode = "pblendvb";            \
  /* Three address ops */                                                      \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pextr::Base::Opcode = "pextr";                  \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pshufd::Base::Opcode = "pshufd";                \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Pshufb::Base::Opcode = "pshufb";                \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Punpckl::Base::Opcode = "punpckl";              \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Punpckh::Base::Opcode = "punpckh";              \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Packss::Base::Opcode = "packss";                \
  template <>                                                                  \
  template <>                                                                  \
  const char *InstImpl::InstX86Packus::Base::Opcode = "packus";                \
  /* Inplace GPR ops */                                                        \
  template <>                                                                  \
  template <>                                                                  \
  ...
  template <>                                                                  \
  const InstImpl::Assembler::GPREmitterRegOp                                   \
      InstImpl::InstX86Bsf::Base::Emitter = {                                  \
          &InstImpl::Assembler::bsf, &InstImpl::Assembler::bsf, nullptr};      \
  template <>                                                                  \
  template <>                                                                  \
  const InstImpl::Assembler::GPREmitterRegOp                                   \
      InstImpl::InstX86Bsr::Base::Emitter = {                                  \
  ...
  template <>                                                                  \
  const InstImpl::Assembler::XmmEmitterRegOp                                   \
      InstImpl::InstX86Pmulhuw::Base::Emitter = {                              \
          &InstImpl::Assembler::pmulhuw, &InstImpl::Assembler::pmulhuw};       \
  template <>                                                                  \
  template <>                                                                  \
  const InstImpl::Assembler::XmmEmitterRegOp                                   \
      InstImpl::InstX86Pmaddwd::Base::Emitter = {                              \
          &InstImpl::Assembler::pmaddwd, &InstImpl::Assembler::pmaddwd};       \
  template <>                                                                  \
  template <>                                                                  \
  const InstImpl::Assembler::XmmEmitterRegOp                                   \
      InstImpl::InstX86Pmuludq::Base::Emitter = {                              \
          &InstImpl::Assembler::pmuludq, &InstImpl::Assembler::pmuludq};       \
  template <>                                                                  \
  template <>                                                                  \
  const InstImpl::Assembler::XmmEmitterRegOp                                   \
  ...
  template <>                                                                  \
  const InstImpl::Assembler::XmmEmitterRegOp                                   \
      InstImpl::InstX86Xorps::Base::Emitter = {&InstImpl::Assembler::xorps,    \
  ...
  template <>                                                                  \
  const InstImpl::Assembler::XmmEmitterRegOp                                   \
      InstImpl::InstX86Punpckl::Base::Emitter = {                              \
          &InstImpl::Assembler::punpckl, &InstImpl::Assembler::punpckl};       \
  template <>                                                                  \
  template <>                                                                  \
  const InstImpl::Assembler::XmmEmitterRegOp                                   \
      InstImpl::InstX86Punpckh::Base::Emitter = {                              \
          &InstImpl::Assembler::punpckh, &InstImpl::Assembler::punpckh};       \
  template <>                                                                  \
  template <>                                                                  \
  const InstImpl::Assembler::XmmEmitterRegOp                                   \
