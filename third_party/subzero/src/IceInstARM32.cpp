...
// Two-addr ops
template <> const char *const InstARM32Movt::Opcode = "movt";
// Unary ops
template <> const char *const InstARM32Movw::Opcode = "movw";
template <> const char *const InstARM32Clz::Opcode = "clz";
template <> const char *const InstARM32Mvn::Opcode = "mvn";
template <> const char *const InstARM32Rbit::Opcode = "rbit";
template <> const char *const InstARM32Rev::Opcode = "rev";
template <>
const char *const InstARM32Sxt::Opcode = "sxt"; // still requires b/h
template <>
const char *const InstARM32Uxt::Opcode = "uxt"; // still requires b/h
// FP
template <> const char *const InstARM32Vsqrt::Opcode = "vsqrt";
// Mov-like ops
template <> const char *const InstARM32Ldr::Opcode = "ldr";
template <> const char *const InstARM32Ldrex::Opcode = "ldrex";
template <> const char *const InstARM32Vldr1d::Opcode = "vldr1d";
template <> const char *const InstARM32Vldr1q::Opcode = "vldr1q";
// Three-addr ops
template <> const char *const InstARM32Adc::Opcode = "adc";
template <> const char *const InstARM32Add::Opcode = "add";
template <> const char *const InstARM32And::Opcode = "and";
template <> const char *const InstARM32Asr::Opcode = "asr";
template <> const char *const InstARM32Bic::Opcode = "bic";
template <> const char *const InstARM32Eor::Opcode = "eor";
template <> const char *const InstARM32Lsl::Opcode = "lsl";
template <> const char *const InstARM32Lsr::Opcode = "lsr";
template <> const char *const InstARM32Mul::Opcode = "mul";
template <> const char *const InstARM32Orr::Opcode = "orr";
template <> const char *const InstARM32Rsb::Opcode = "rsb";
template <> const char *const InstARM32Rsc::Opcode = "rsc";
template <> const char *const InstARM32Sbc::Opcode = "sbc";
template <> const char *const InstARM32Sdiv::Opcode = "sdiv";
template <> const char *const InstARM32Sub::Opcode = "sub";
template <> const char *const InstARM32Udiv::Opcode = "udiv";
// FP
template <> const char *const InstARM32Vadd::Opcode = "vadd";
template <> const char *const InstARM32Vand::Opcode = "vand";
template <> const char *const InstARM32Vbsl::Opcode = "vbsl";
template <> const char *const InstARM32Vceq::Opcode = "vceq";
template <>
const char *const InstARM32ThreeAddrFP<InstARM32::Vcge>::Opcode = "vcge";
template <>
const char *const InstARM32ThreeAddrFP<InstARM32::Vcgt>::Opcode = "vcgt";
template <> const char *const InstARM32Vdiv::Opcode = "vdiv";
template <> const char *const InstARM32Veor::Opcode = "veor";
template <> const char *const InstARM32Vmla::Opcode = "vmla";
template <> const char *const InstARM32Vmls::Opcode = "vmls";
template <> const char *const InstARM32Vmul::Opcode = "vmul";
template <> const char *const InstARM32Vmvn::Opcode = "vmvn";
template <> const char *const InstARM32Vmovl::Opcode = "vmovl";
template <> const char *const InstARM32Vmovh::Opcode = "vmovh";
template <> const char *const InstARM32Vmovhl::Opcode = "vmovhl";
template <> const char *const InstARM32Vmovlh::Opcode = "vmovlh";
template <> const char *const InstARM32Vorr::Opcode = "vorr";
template <>
const char *const InstARM32UnaryopFP<InstARM32::Vneg>::Opcode = "vneg";
template <>
const char *const InstARM32ThreeAddrFP<InstARM32::Vshl>::Opcode = "vshl";
template <>
const char *const InstARM32ThreeAddrFP<InstARM32::Vshr>::Opcode = "vshr";
template <> const char *const InstARM32Vsub::Opcode = "vsub";
template <>
const char *const InstARM32ThreeAddrFP<InstARM32::Vqadd>::Opcode = "vqadd";
template <>
const char *const InstARM32ThreeAddrFP<InstARM32::Vqsub>::Opcode = "vqsub";
template <>
const char *const InstARM32ThreeAddrFP<InstARM32::Vqmovn2>::Opcode = "vqmovn2";
template <>
const char *const InstARM32ThreeAddrFP<InstARM32::Vmulh>::Opcode = "vmulh";
template <>
const char *const InstARM32ThreeAddrFP<InstARM32::Vmlap>::Opcode = "vmlap";
template <>
const char *const InstARM32ThreeAddrFP<InstARM32::Vzip>::Opcode = "vzip";
// Four-addr ops
template <> const char *const InstARM32Mla::Opcode = "mla";
template <> const char *const InstARM32Mls::Opcode = "mls";
// Cmp-like ops
template <> const char *const InstARM32Cmn::Opcode = "cmn";
template <> const char *const InstARM32Cmp::Opcode = "cmp";
template <> const char *const InstARM32Tst::Opcode = "tst";
