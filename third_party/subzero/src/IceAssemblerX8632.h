...
protected:
  AssemblerX8632(bool EmitAddrSizeOverridePrefix = Traits::Is64Bit)
      : Assembler(Assembler::Asm_X8632),
...
public:
  ...
  static bool classof(const Assembler *Asm) {
    return Asm->getKind() == Assembler::Asm_X8632;
  }
...
private:
  ...
  void emitAddrSizeOverridePrefix() {
    // No address size override prefix on x86-32
  }
...
using AssemblerX8632 = AssemblerX8632;
