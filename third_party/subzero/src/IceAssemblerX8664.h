...
protected:
  AssemblerX8664(bool EmitAddrSizeOverridePrefix = Traits::Is64Bit)
      : Assembler(Assembler::Asm_X8664),
...
public:
  ...
  static bool classof(const Assembler *Asm) {
    return Asm->getKind() == Assembler::Asm_X8664;
  }
...
using AssemblerX8664 = AssemblerX8664;
