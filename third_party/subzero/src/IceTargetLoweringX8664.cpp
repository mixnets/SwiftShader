...
// register args to it.
SizeT getShadowStoreSize() { return 0; }
...
Type TargetX8664::getPointerType() { return IceType_i64; }
...
void TargetX8664::lowerCaseCluster(const CaseCluster &Case, Operand *Comparison,
  ...
  case CaseCluster::JumpTable: {
    ...
    Variable *Index;
    const Type PointerType = IceType_i64;
...
void TargetDataX8664::lowerJumpTables() {
  ...
  case FT_Elf: {
    ...
    const FixupKind RelocationKind = FK_Abs64;
