...
template <> struct PoolTypeConverter<float> {
  ...
  using IceType = Ice::ConstantFloat;
...
template <> struct PoolTypeConverter<double> {
  ...
  using IceType = Ice::ConstantDouble;
...
template <> struct PoolTypeConverter<uint32_t> {
  using PrimitiveIntType = uint32_t;
  using IceType = Ice::ConstantInteger32;
...
TargetX8664::TargetX8664(Cfg *Func) : Ice::TargetLowering(Func) {
  static_assert(
...
FixupKind TargetX8664::PcRelFixup = TargetX8664::Traits::FK_PcRel;

FixupKind TargetX8664::AbsFixup = TargetX8664::Traits::FK_Abs;
...
void TargetX8664::_push_reg(RegNumT RegNum) {
  if (Traits::isXmm(RegNum)) {
    ...
    _storep(reg, address);
  } else if (RegNum != Traits::RegisterSet::Reg_rbp || !false) {
