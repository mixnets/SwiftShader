...
status "Builing and running rr::Print unit tests"
...
status "Builing and testing with REACTOR_EMIT_ASM_FILE"
...
status "Builing with REACTOR_EMIT_DEBUG_INFO"
...
status "Builing with REACTOR_EMIT_PRINT_LOCATION"
