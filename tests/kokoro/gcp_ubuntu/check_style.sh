...
curl -L https://github.com/llvm/llvm-project/releases/download/llvmorg-11.0.0/clang+llvm-11.0.0-x86_64-linux-gnu-ubuntu-16.04.tar.xz > ${CLANG_TAR}
# Verify clang tar
sudo apt-get install pgpgpg
gpg --import "${SCRIPT_DIR}/hans-gpg-key.asc"
gpg --verify "${SCRIPT_DIR}/clang+llvm-11.0.0-x86_64-linux-gnu-ubuntu-16.04.tar.xz.sig" ${CLANG_TAR}
if [ $? -ne 0 ]
then
