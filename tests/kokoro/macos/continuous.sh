...
# Lower the amount of debug info, to work around Kokoro timeouts.
# See b/147355576 for more information.
LESS_DEBUG_INFO=1

# Disable ASAN checks for debug builds, to work around Kokoro timeouts.
# See b/147355576 for more information.
ASAN="ON"
