...
std::unique_ptr<vk::DynamicLoader> VulkanTester::loadDriver()
{
	...
	// TODO: consider exposing this if going via the loader becomes problematic.
	// Leaving it here for testing.
	const bool LOAD_SWIFTSHADER_DIRECTLY = false;
	...
	scopedSetEnvVar = std::make_unique<ScopedSetEnvVar>("VK_ICD_FILENAMES", icdFileName);
