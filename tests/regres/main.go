...
func (c *changeInfo) update(client *gerrit.Client) error {
	...
	kokoroPresubmit := change.Labels["codeReviewScore"].Value
	presubmitReady := change.Labels["Presubmit-Ready"].Value

	c.priority = presubmitReady*10 + codeReviewScore + kokoroPresubmit
