...
TEST_P(SwiftShaderVulkanBufferToBufferComputeTest, SwitchConditionalEmptyCases)
{
    std::stringstream src;
    src <<
              "OpCapability Shader\n"
...
TEST_P(SwiftShaderVulkanBufferToBufferComputeTest, SwitchConditionalStore)
{
    std::stringstream src;
    src <<
              "OpCapability Shader\n"
...
TEST_P(SwiftShaderVulkanBufferToBufferComputeTest, SwitchConditionalCaseReturn)
{
    std::stringstream src;
    src <<
              "OpCapability Shader\n"
...
TEST_P(SwiftShaderVulkanBufferToBufferComputeTest, SwitchConditionalDefaultReturn)
{
    std::stringstream src;
    src <<
              "OpCapability Shader\n"
...
TEST_P(SwiftShaderVulkanBufferToBufferComputeTest, SwitchConditionalPhi)
{
    std::stringstream src;
    src <<
              "OpCapability Shader\n"
