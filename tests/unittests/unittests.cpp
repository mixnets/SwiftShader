...
protected:
	...
	void compareColor(unsigned char* referenceColor)
	{
	...
	void Initialize(EGLDisplay &display, EGLSurface &surface, EGLContext &context, int version, bool withChecks)
	{
	...
	void Uninitialize(EGLDisplay display, EGLSurface surface, EGLContext context)
	{
...
TEST_F(SwiftShaderTest, Initalization)
{
	...
	EGLSurface surface;
	EGLContext context;
	Initialize(display, surface, context, 2, true);
	...
	Uninitialize(display, surface, context);
}
...
TEST_F(SwiftShaderTest, TextureRectangle_TexImage2D)
{
	...
	EGLSurface surface;
	EGLContext context;
	Initialize(display, surface, context, 2, false);
...
TEST_F(SwiftShaderTest, TextureRectangle_TexStorage2D)
{
	...
	EGLSurface surface;
	EGLContext context;
	Initialize(display, surface, context, 3, false);
