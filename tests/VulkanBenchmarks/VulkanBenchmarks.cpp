...
class DrawVerticesBenchmark : public VulkanBenchmark
{
public:
	DrawVerticesBenchmark(Multisample multisample)
...
class TriangleSolidColorBenchmark : public DrawVerticesBenchmark
{
public:
	TriangleSolidColorBenchmark(Multisample multisample)
	    : DrawVerticesBenchmark(multisample)
	{}
...
class TriangleInterpolateColorBenchmark : public DrawVerticesBenchmark
{
public:
...
class TriangleSampleTextureBenchmark : public DrawVerticesBenchmark
{
public:
