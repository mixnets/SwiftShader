...
BENCHMARK_CAPTURE(CppCompute, sqrt, one, std::sqrtf)->Arg(4 * 1024 * 1024)->Unit(benchmark::kMillisecond);
BENCHMARK_CAPTURE(CppCompute, sin, zero, std::sinf)->Arg(4 * 1024 * 1024)->Unit(benchmark::kMillisecond);
BENCHMARK_CAPTURE(CppCompute, cos, zero, std::cosf)->Arg(4 * 1024 * 1024)->Unit(benchmark::kMillisecond);
BENCHMARK_CAPTURE(CppCompute, exp, zero, std::expf)->Arg(4 * 1024 * 1024)->Unit(benchmark::kMillisecond);
BENCHMARK_CAPTURE(CppCompute, log, one, std::logf)->Arg(4 * 1024 * 1024)->Unit(benchmark::kMillisecond);
