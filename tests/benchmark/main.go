...
// The benchmark tool profiles and reports average FPS statistics of Vulkan
// applications using the SwiftShader driver.
//
// The tool repeatedly runs a the test Vulkan applications listed in the
// test list passed as the first argument, varying the number of hardware
// threads spawned and used by SwiftShader.
//
// The stdout of the the test applications is parsed for FPS counter messages,
// which are averaged for the lifetime of the process, and are reported once all
