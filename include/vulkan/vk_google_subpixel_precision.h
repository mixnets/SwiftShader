...
#define VK_GOOGLE_PIPELINE_SUBPIXEL_PRECISION_SPEC_VERSION 1
#define VK_GOOGLE_PIPELINE_SUBPIXEL_PRECISION_EXTENSION_NAME "VK_GOOGLE_pipeline_subpixel_precision"
