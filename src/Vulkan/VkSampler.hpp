...
{
public:
	Sampler(const VkSamplerCreateInfo *pCreateInfo, void *mem, const vk::SamplerYcbcrConversion *ycbcrConversion, const VkSamplerFilteringPrecisionModeGOOGLE filteringPrecision)
