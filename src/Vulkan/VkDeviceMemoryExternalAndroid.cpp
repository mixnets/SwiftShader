...
VkFormatFeatureFlags GetVkFormatFeaturesFromAHBFormatAndUsage(uint32_t ahbFormat, uint64_t ahbUsage)
{
...
VkResult AHardwareBufferExternalMemory::GetAndroidHardwareBufferFormatProperties(const AHardwareBuffer_Desc &ahbDesc, VkAndroidHardwareBufferFormatPropertiesANDROID *pFormat)
{
	...
	pFormat->formatFeatures = GetVkFormatFeaturesFromAHBFormatAndUsage(ahbDesc.format, ahbDesc.usage);
