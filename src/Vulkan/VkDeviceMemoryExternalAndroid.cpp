...
int GetBytesFromAHBFormat(uint32_t ahbFormat)
{
	switch(ahbFormat)
	{
		...
		case AHARDWAREBUFFER_FORMAT_D24_UNORM_S8_UINT:
			UNSUPPORTED("Requested bytes() for unsupported format AHARDWAREBUFFER_FORMAT_D24_UNORM_S8_UINT");
			return -1;
		case AHARDWAREBUFFER_FORMAT_D32_FLOAT:
			return 4;
		case AHARDWAREBUFFER_FORMAT_D32_FLOAT_S8_UINT:
			UNSUPPORTED("Requested bytes() for unsupported format AHARDWAREBUFFER_FORMAT_D32_FLOAT_S8_UINT");
			return -1;
