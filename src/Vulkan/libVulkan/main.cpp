...
{
	this->vkGetInstanceProcAddr = vulkan::GetInstanceProcAddr;
	this->vkGetDeviceProcAddr = vulkan::GetDeviceProcAddr;
	this->vkEnumerateInstanceExtensionProperties = vulkan::EnumerateInstanceExtensionProperties;
	this->vkCreateInstance = vulkan::CreateInstance;
	this->vkDestroyInstance = vulkan::DestroyInstance;
	this->vkEnumeratePhysicalDevices = vulkan::EnumeratePhysicalDevices;
	this->vkGetPhysicalDeviceQueueFamilyProperties = vulkan::GetPhysicalDeviceQueueFamilyProperties;
	this->vkGetPhysicalDeviceFeatures = vulkan::GetPhysicalDeviceFeatures;
	this->vkGetPhysicalDeviceProperties = vulkan::GetPhysicalDeviceProperties;
	this->vkEnumerateDeviceExtensionProperties = vulkan::EnumerateDeviceExtensionProperties;
	this->vkCreateDevice = vulkan::CreateDevice;
	this->vkGetPhysicalDeviceMemoryProperties = vulkan::GetPhysicalDeviceMemoryProperties;
}
