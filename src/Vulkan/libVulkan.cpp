		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES_EXT:
			{
				...
				bool hasFeatures = vk::Cast(physicalDevice)->hasFeatures2<VkPhysicalDeviceLineRasterizationFeaturesEXT>(lineRasterizationFeatures);
				if(!hasFeatures)
				{
					return VK_ERROR_FEATURE_NOT_PRESENT;
				}
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_FEATURES_EXT:
			{
				...
				bool hasFeatures = vk::Cast(physicalDevice)->hasFeatures2<VkPhysicalDeviceProvokingVertexFeaturesEXT>(provokingVertexFeatures);
				if(!hasFeatures)
				{
					return VK_ERROR_FEATURE_NOT_PRESENT;
				}
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_FEATURES:
			{
				...
				bool hasFeatures = vk::Cast(physicalDevice)->hasFeatures2<VkPhysicalDeviceVulkan11Features>(vk11Features);
				if(!hasFeatures)
				{
					return VK_ERROR_FEATURE_NOT_PRESENT;
				}
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_FEATURES:
			{
				...
				bool hasFeatures = vk::Cast(physicalDevice)->hasFeatures2<VkPhysicalDeviceVulkan12Features>(vk12Features);
				if(!hasFeatures)
				{
					return VK_ERROR_FEATURE_NOT_PRESENT;
				}
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLIP_ENABLE_FEATURES_EXT:
			{
				...
				bool hasFeatures = vk::Cast(physicalDevice)->hasFeatures2<VkPhysicalDeviceDepthClipEnableFeaturesEXT>(depthClipFeatures);
				if(!hasFeatures)
				{
					return VK_ERROR_FEATURE_NOT_PRESENT;
				}
