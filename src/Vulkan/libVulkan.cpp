...
VKAPI_ATTR VkResult VKAPI_CALL vkAllocateMemory(VkDevice device, const VkMemoryAllocateInfo *pAllocateInfo, const VkAllocationCallbacks *pAllocator, VkDeviceMemory *pMemory)
{
	...
	vk::DeviceMemory::ParsedAllocationInfo parsedAllocationInfo;
	VkResult result = vk::DeviceMemory::ParseAllocationInfo(pAllocateInfo, &parsedAllocationInfo);
	if(result != VK_SUCCESS)
	{
		return result;
	}

	result = vk::DeviceMemory::Create(pAllocator, pAllocateInfo, pMemory, parsedAllocationInfo, vk::Cast(device));
	if(result != VK_SUCCESS)
	{
		return result;
	}
