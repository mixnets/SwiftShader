...
VKAPI_ATTR VkResult VKAPI_CALL vkGetSemaphoreFdKHR(VkDevice device, const VkSemaphoreGetFdInfoKHR *pGetFdInfo, int *pFd)
{
	...
	return vk::Cast(pGetFdInfo->semaphore)->as<vk::BinarySemaphore>()->exportFd(pFd);
}
...
VKAPI_ATTR VkResult VKAPI_CALL vkImportSemaphoreFdKHR(VkDevice device, const VkImportSemaphoreFdInfoKHR *pImportSemaphoreInfo)
{
	...
	return vk::Cast(pImportSemaphoreInfo->semaphore)->as<vk::BinarySemaphore>()->importFd(pImportSemaphoreInfo->fd, temporaryImport);
}
    ...
    const VkImportSemaphoreZirconHandleInfoFUCHSIA *pImportSemaphoreZirconHandleInfo)
{
	...
	return vk::Cast(pImportSemaphoreZirconHandleInfo->semaphore)->as<vk::BinarySemaphore>()->importHandle(pImportSemaphoreZirconHandleInfo->handle, temporaryImport);
}
    ...
    zx_handle_t *pZirconHandle)
{
	...
	return vk::Cast(pGetZirconHandleInfo->semaphore)->as<vk::BinarySemaphore>()->exportHandle(pZirconHandle);
}
#endif  // VK_USE_PLATFORM_FUCHSIA
...
VKAPI_ATTR VkResult VKAPI_CALL vkGetSemaphoreCounterValue(VkDevice device, VkSemaphore semaphore, uint64_t *pValue)
{
	...
	*pValue = vk::Cast(semaphore)->as<vk::TimelineSemaphore>()->getCounterValue();
	return VK_SUCCESS;
}
...
VKAPI_ATTR VkResult VKAPI_CALL vkSignalSemaphore(VkDevice device, const VkSemaphoreSignalInfo *pSignalInfo)
{
	TRACE("(VkDevice device = %p, const VkSemaphoreSignalInfo *pSignalInfo = %p)",
	      device, pSignalInfo);
	vk::Cast(pSignalInfo->semaphore)->as<vk::TimelineSemaphore>()->signal(pSignalInfo->value);
	return VK_SUCCESS;
}
...
VKAPI_ATTR VkResult VKAPI_CALL vkAcquireNextImageKHR(VkDevice device, VkSwapchainKHR swapchain, uint64_t timeout, VkSemaphore semaphore, VkFence fence, uint32_t *pImageIndex)
{
	...
	return vk::Cast(swapchain)->getNextImage(timeout, vk::Cast(semaphore)->as<vk::BinarySemaphore>(), vk::Cast(fence), pImageIndex);
}
...
VKAPI_ATTR VkResult VKAPI_CALL vkAcquireNextImage2KHR(VkDevice device, const VkAcquireNextImageInfoKHR *pAcquireInfo, uint32_t *pImageIndex)
{
	...
	return vk::Cast(pAcquireInfo->swapchain)->getNextImage(pAcquireInfo->timeout, vk::Cast(pAcquireInfo->semaphore)->as<vk::BinarySemaphore>(), vk::Cast(pAcquireInfo->fence), pImageIndex);
}
