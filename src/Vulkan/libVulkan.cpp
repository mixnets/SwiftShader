...
VKAPI_ATTR VkResult VKAPI_CALL vkCreateSemaphore(VkDevice device, const VkSemaphoreCreateInfo *pCreateInfo, const VkAllocationCallbacks *pAllocator, VkSemaphore *pSemaphore)
{
	...
	ASSERT(type == VK_SEMAPHORE_TYPE_BINARY || type == VK_SEMAPHORE_TYPE_TIMELINE);
...
VKAPI_ATTR VkResult VKAPI_CALL vkGetSemaphoreFdKHR(VkDevice device, const VkSemaphoreGetFdInfoKHR *pGetFdInfo, int *pFd)
{
	...
	{
		result = sem->exportFd(pFd);
	}
	else
	{
		UNSUPPORTED("pGetFdInfo->semaphore type: TimelineSemaphore");
	}
...
VKAPI_ATTR VkResult VKAPI_CALL vkImportSemaphoreFdKHR(VkDevice device, const VkImportSemaphoreFdInfoKHR *pImportSemaphoreInfo)
{
	...
	return vk::DynamicCast<vk::BinarySemaphore>(pImportSemaphoreInfo->semaphore)->importFd(pImportSemaphoreInfo->fd, temporaryImport);
}
    ...
    const VkImportSemaphoreZirconHandleInfoFUCHSIA *pImportSemaphoreZirconHandleInfo)
{
	...
	return vk::DynamicCast<vk::BinarySemaphore>(pImportSemaphoreZirconHandleInfo->semaphore)->importHandle(pImportSemaphoreZirconHandleInfo->handle, temporaryImport);
}
    ...
    zx_handle_t *pZirconHandle)
{
	...
	return vk::DynamicCast<vk::BinarySemaphore>(pGetZirconHandleInfo->semaphore)->exportHandle(pZirconHandle);
}
#endif  // VK_USE_PLATFORM_FUCHSIA
