	...
	const VkImportSemaphoreZirconHandleInfoFUCHSIA* pImportSemaphoreZirconHandleInfo)
{
	...
	return vk::Cast(pImportSemaphoreZirconHandleInfo->semaphore)->importHandle(pImportSemaphoreZirconHandleInfo->handle);
}
	...
	zx_handle_t*                                 pZirconHandle)
{
	...
	*pZirconHandle = vk::Cast(pGetZirconHandleInfo->semaphore)->exportHandle();
