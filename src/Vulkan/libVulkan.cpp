...
namespace vk
{
	...
	VkResult CreateDevice(VkPhysicalDevice physicalDevice, const VkDeviceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDevice* pDevice)
	{
		...
		*pDevice = Cast(new (pAllocator) Device(pAllocator, physicalDevice,
			pCreateInfo->queueCreateInfoCount, pCreateInfo->pQueueCreateInfos));
	...
	VkResult AllocateMemory(VkDevice device, const VkMemoryAllocateInfo* pAllocateInfo, const VkAllocationCallbacks* pAllocator, VkDeviceMemory* pMemory)
	{
		...
		*pMemory = Cast(new (pAllocator) DeviceMemory(pAllocator, pAllocateInfo->allocationSize));
	...
	{
		TRACE("(VkDevice device, VkImage image, VkMemoryRequirements* pMemoryRequirements)",
	...
	VkResult CreateBuffer(VkDevice device, const VkBufferCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkBuffer* pBuffer)
	{
		...
		*pBuffer = Cast(new (pAllocator) Buffer(pAllocator, pCreateInfo->flags,
			pCreateInfo->size, pCreateInfo->usage, pCreateInfo->sharingMode,
	...
	VkResult CreateImage(VkDevice device, const VkImageCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkImage* pImage)
	{
		...
		*pImage = Cast(new (pAllocator) Image(pAllocator, pCreateInfo->flags, pCreateInfo->imageType, pCreateInfo->format,
			pCreateInfo->extent, pCreateInfo->mipLevels, pCreateInfo->arrayLayers, pCreateInfo->samples,
			pCreateInfo->tiling, pCreateInfo->usage, pCreateInfo->sharingMode, pCreateInfo->queueFamilyIndexCount,
			pCreateInfo->pQueueFamilyIndices, pCreateInfo->initialLayout));
	...
	VkResult CreateImageView(VkDevice device, const VkImageViewCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkImageView* pView)
	{
		...
		*pView = Cast(new (pAllocator) ImageView(pCreateInfo->image, pCreateInfo->viewType,
			pCreateInfo->format, pCreateInfo->components, pCreateInfo->subresourceRange));
	...
	VkResult CreateShaderModule(VkDevice device, const VkShaderModuleCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkShaderModule* pShaderModule)
	{
		...
		*pShaderModule = Cast(new (pAllocator) ShaderModule(pAllocator, pCreateInfo->codeSize, pCreateInfo->pCode));
	...
	VkResult CreateGraphicsPipelines(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkGraphicsPipelineCreateInfo* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines)
	{
		...
		{
			pPipelines[i] = Cast(new (pAllocator) Pipeline(pAllocator, pCreateInfos[i]));
		}
	...
	VkResult CreatePipelineLayout(VkDevice device, const VkPipelineLayoutCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPipelineLayout* pPipelineLayout)
	{
		...
		*pPipelineLayout = Cast(new (pAllocator) PipelineLayout(pAllocator, pCreateInfo->setLayoutCount,
			pCreateInfo->pSetLayouts, pCreateInfo->pushConstantRangeCount, pCreateInfo->pPushConstantRanges));
	...
	VkResult CreateFramebuffer(VkDevice device, const VkFramebufferCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkFramebuffer* pFramebuffer)
	{
		...
		*pFramebuffer = Cast(new (pAllocator) Framebuffer(pAllocator, pCreateInfo->renderPass, pCreateInfo->attachmentCount,
			pCreateInfo->pAttachments, pCreateInfo->width, pCreateInfo->height, pCreateInfo->layers));
	...
	VkResult CreateRenderPass(VkDevice device, const VkRenderPassCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass)
	{
		...
		*pRenderPass = Cast(new (pAllocator) RenderPass(pAllocator, pCreateInfo->attachmentCount, pCreateInfo->pAttachments,
			pCreateInfo->subpassCount, pCreateInfo->pSubpasses, pCreateInfo->dependencyCount, pCreateInfo->pDependencies));
	...
	VkResult CreateCommandPool(VkDevice device, const VkCommandPoolCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkCommandPool* pCommandPool)
	{
		...
		*pCommandPool = Cast(new (pAllocator) CommandPool(pCreateInfo->flags, pCreateInfo->queueFamilyIndex));
