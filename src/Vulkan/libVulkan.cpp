...
{
public:
	ExtensionProperties(const VkExtensionProperties &vkExtensionProperties)
	    : vkExtensionProperties(vkExtensionProperties)
	    , supported(true)
	{}
	ExtensionProperties(const VkExtensionProperties &vkExtensionProperties, bool supported)
	    : vkExtensionProperties(vkExtensionProperties)
	    , supported(supported)
	{}

	operator VkExtensionProperties() const { return vkExtensionProperties; }
	const char *getName() const { return vkExtensionProperties.extensionName; }
...
#endif
#ifdef VK_USE_PLATFORM_XLIB_KHR
	{ { VK_KHR_XLIB_SURFACE_EXTENSION_NAME, VK_KHR_XLIB_SURFACE_SPEC_VERSION }, libX11 },
#endif
#ifdef VK_USE_PLATFORM_WAYLAND_KHR
...
static bool hasExtension(const char *extensionName, const ExtensionProperties *extensionProperties, uint32_t extensionPropertiesCount)
{
	for(uint32_t i = 0; i < extensionPropertiesCount; i++)
	{
		if(strcmp(extensionName, extensionProperties[i].getName()) == 0)
		{
