...
VKAPI_ATTR VkResult VKAPI_CALL vkCreateGraphicsPipelines(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkGraphicsPipelineCreateInfo* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines)
{
	...
	for(uint32_t i = 0; i < createInfoCount; i++)
	{
		...
		if(result != VK_SUCCESS)
		{
			...
			{
				vk::destroy(pPipelines[j], pAllocator);
			}
...
VKAPI_ATTR VkResult VKAPI_CALL vkResetCommandPool(VkDevice device, VkCommandPool commandPool, VkCommandPoolResetFlags flags)
{
	...
	vk::Cast(commandPool)->reset(flags);
...
{
	TRACE("(VkCommandBuffer commandBuffer = 0x%X, uint32_t deviceMask = %d)", commandBuffer, deviceMask);
...
{
	TRACE("(VkCommandBuffer commandBuffer = 0x%X, uint32_t baseGroupX = %d, uint32_t baseGroupY = %d, uint32_t baseGroupZ = %d, uint32_t groupCountX = %d, uint32_t groupCountY = %d, uint32_t groupCountZ = %d)",
...
VKAPI_ATTR void VKAPI_CALL vkGetBufferMemoryRequirements2(VkDevice device, const VkBufferMemoryRequirementsInfo2* pInfo, VkMemoryRequirements2* pMemoryRequirements)
{
	...
	void* pNext = pMemoryRequirements->pNext;
	while(pNext)
	{
		switch(*reinterpret_cast<const VkStructureType*>(pNext))
		{
		...
		{
			auto& features = *reinterpret_cast<VkMemoryDedicatedRequirements*>(pNext);
			features.prefersDedicatedAllocation = VK_FALSE;
			features.requiresDedicatedAllocation = VK_FALSE;
...
VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceProperties2(VkPhysicalDevice physicalDevice, VkPhysicalDeviceProperties2* pProperties)
{
	...
	while(pNext)
	{
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_PROPERTIES_EXT:
			{
				auto& properties = *reinterpret_cast<VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT*>(pNext);
				UNIMPLEMENTED();
				pNext = properties.pNext;
			}
			break;
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CONSERVATIVE_RASTERIZATION_PROPERTIES_EXT:
			{
				auto& properties = *reinterpret_cast<VkPhysicalDeviceConservativeRasterizationPropertiesEXT*>(pNext);
				UNIMPLEMENTED();
				pNext = properties.pNext;
			}
			break;
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES_EXT:
			{
				auto& properties = *reinterpret_cast<VkPhysicalDeviceDescriptorIndexingPropertiesEXT*>(pNext);
				UNIMPLEMENTED();
				pNext = properties.pNext;
			}
			break;
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DISCARD_RECTANGLE_PROPERTIES_EXT:
			{
				auto& properties = *reinterpret_cast<VkPhysicalDeviceDiscardRectanglePropertiesEXT*>(pNext);
				UNIMPLEMENTED();
				pNext = properties.pNext;
			}
			break;
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_HOST_PROPERTIES_EXT:
			{
				auto& properties = *reinterpret_cast<VkPhysicalDeviceExternalMemoryHostPropertiesEXT*>(pNext);
				UNIMPLEMENTED();
				pNext = properties.pNext;
			}
			break;
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PER_VIEW_ATTRIBUTES_PROPERTIES_NVX:
			{
				auto& properties = *reinterpret_cast<VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX*>(pNext);
				UNIMPLEMENTED();
				pNext = properties.pNext;
			}
			break;
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES_KHR:
			{
				auto& properties = *reinterpret_cast<VkPhysicalDevicePushDescriptorPropertiesKHR*>(pNext);
				UNIMPLEMENTED();
				pNext = properties.pNext;
			}
			break;
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLE_LOCATIONS_PROPERTIES_EXT:
			{
				auto& properties = *reinterpret_cast<VkPhysicalDeviceSampleLocationsPropertiesEXT*>(pNext);
				UNIMPLEMENTED();
				pNext = properties.pNext;
			}
			break;
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES_EXT:
			{
				auto& properties = *reinterpret_cast<VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT*>(pNext);
				UNIMPLEMENTED();
				pNext = properties.pNext;
			}
			break;
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_AMD:
			{
				auto& properties = *reinterpret_cast<VkPhysicalDeviceShaderCorePropertiesAMD*>(pNext);
				UNIMPLEMENTED();
				pNext = properties.pNext;
			}
			break;
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES_EXT:
			{
				auto& properties = *reinterpret_cast<VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT*>(pNext);
				UNIMPLEMENTED();
				pNext = properties.pNext;
			}
			break;
...
{
	TRACE("(VkDevice device = 0x%X, const VkSamplerYcbcrConversionCreateInfo* pCreateInfo = 0x%X, const VkAllocationCallbacks* pAllocator = 0x%X, VkSamplerYcbcrConversion* pYcbcrConversion = 0x%X)",
...
{
	TRACE("(VkDevice device = 0x%X, VkSamplerYcbcrConversion ycbcrConversion = 0x%X, const VkAllocationCallbacks* pAllocator = 0x%X)",
...
VKAPI_ATTR void VKAPI_CALL vkUpdateDescriptorSetWithTemplate(VkDevice device, VkDescriptorSet descriptorSet, VkDescriptorUpdateTemplate descriptorUpdateTemplate, const void* pData)
{
	...
	vk::Cast(device)->updateDescriptorSetWithTemplate(descriptorSet, descriptorUpdateTemplate, pData);
}
