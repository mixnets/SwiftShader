...
void* allocate(size_t count, const VkAllocationCallbacks* pAllocator,
               VkSystemAllocationScope allocationScope, const void* src = nullptr);
...
// placement new operator in the VkObject base class for simplicity.
// Unfortunately, since we use a placement new to allocate VkObject derived
...
// we use this function, which calls the virtual VkObject::destroy() function
