...
class VmoExternalMemory : public vk::DeviceMemory::Impl
{
public:
	...
	// by this DeviceMemory;:Impl subclass.
	struct AllocateInfo {
	...
	VkResult allocate(size_t size, void** pBuffer) override
	{
		...
		{
			zx_status_t status = zx_handle_duplicate(allocateInfo.handle, ZX_RIGHT_SAME_RIGHTS, &vmoHandle);
			if (status != ZX_OK)
			{
