...
Instance::Instance(const VkInstanceCreateInfo *pCreateInfo, void *mem, VkPhysicalDevice physicalDevice, VkDebugUtilsMessengerEXT messenger)
...
void Instance::submitDebugUtilsMessage(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageTypes, const VkDebugUtilsMessengerCallbackDataEXT *pCallbackData)
{
	...
	{
		vk::Cast(messenger)->submitDebugUtilsMessage(messageSeverity, messageTypes, pCallbackData);
	}
}
