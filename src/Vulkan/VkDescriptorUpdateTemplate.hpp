...
namespace vk
{
	class DescriptorUpdateTemplate : public VkObject<DescriptorUpdateTemplate, VkDescriptorUpdateTemplate>
	{
	public:
		DescriptorUpdateTemplate(const VkDescriptorUpdateTemplateCreateInfo* pCreateInfo, const Memory& mem) :
			flags(pCreateInfo->flags),
			descriptorUpdateEntryCount(pCreateInfo->descriptorUpdateEntryCount),
			descriptorUpdateEntries(reinterpret_cast<VkDescriptorUpdateTemplateEntry*>(mem.host)),
		...
		static MemorySize ComputeRequiredAllocationSize(const VkDescriptorUpdateTemplateCreateInfo* info)
		{
			return { info->descriptorUpdateEntryCount * sizeof(VkDescriptorUpdateTemplateEntry), 0 };
		}
