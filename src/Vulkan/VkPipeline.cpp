	...
	: Pipeline(Cast(pCreateInfo->layout))
{
	...
	if(pCreateInfo->pDynamicState)
	{
		...
		{
			const VkDynamicState& dynamicState = pCreateInfo->pDynamicState->pDynamicStates[i];
			switch(dynamicState)
			{
...
bool GraphicsPipeline::hasDynamicState(const VkDynamicState& dynamicState) const
{
