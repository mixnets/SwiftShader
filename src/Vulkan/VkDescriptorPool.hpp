...
public:
	...
	DescriptorPool(const VkDescriptorPoolCreateInfo* pCreateInfo, const Memory& mem);
	~DescriptorPool() = delete;
	void destroy(const VkAllocationCallbacks* pAllocator) override;

	static MemorySize ComputeRequiredAllocationSize(const VkDescriptorPoolCreateInfo* pCreateInfo);
