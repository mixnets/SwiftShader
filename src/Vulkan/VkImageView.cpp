...
int ImageView::getLayerOffset(VkImageAspectFlagBits aspect, uint32_t mipLevel, Usage usage) const
{
	return getImage(usage)->getLayerOffset(aspect, subresourceRange.baseMipLevel + mipLevel);
}
