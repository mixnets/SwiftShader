...
Identifier::Identifier(const VkImageViewCreateInfo *pCreateInfo)
{
	...
	pack({ pCreateInfo->viewType, samplingFormat, ResolveComponentMapping(pCreateInfo->components, viewFormat), subresource.baseMipLevel + subresource.levelCount, subresource.levelCount <= 1u });
}
