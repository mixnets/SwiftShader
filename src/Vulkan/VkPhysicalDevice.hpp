...
public:
	...
	bool hasExtendedFeatures(const VkPhysicalDeviceSubgroupSizeControlFeaturesEXT *requested) const;
	...
	void getProperties(VkPhysicalDeviceSubgroupSizeControlPropertiesEXT *properties) const;
