...
struct DependencyInfo : public VkDependencyInfoKHR
{
	    ...
	    }
	{
		...
		this->pMemoryBarriers = &memoryBarriers.front();
		this->pBufferMemoryBarriers = &bufferMemoryBarriers.front();
		this->pImageMemoryBarriers = &imageMemoryBarriers.front();
	}

private:
	std::vector<VkMemoryBarrier2KHR> memoryBarriers;
	std::vector<VkBufferMemoryBarrier2KHR> bufferMemoryBarriers;
	std::vector<VkImageMemoryBarrier2KHR> imageMemoryBarriers;
};
