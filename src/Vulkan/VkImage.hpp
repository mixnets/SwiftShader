...
public:
	...
	uint32_t rowPitchBytes32(VkImageAspectFlagBits aspect, uint32_t mipLevel) const;
	uint32_t slicePitchBytes32(VkImageAspectFlagBits aspect, uint32_t mipLevel) const;
