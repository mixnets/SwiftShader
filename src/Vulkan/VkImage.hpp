...
public:
	...
	void *getTexelPointer(const VkOffset3D &offset, const VkImageSubresourceLayers &subresourceLayers) const;
	void *getTexelPointer(const VkOffset3D &offset, const VkImageSubresourceRange &subresourceRange) const;
	bool isCube() const;
