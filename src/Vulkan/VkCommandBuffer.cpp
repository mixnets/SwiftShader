...
{
public:
	ExecuteCommands(const CommandBuffer* commandBuffer) :
...
{
	SignalEvent(Event* ev, VkPipelineStageFlags stageMask) :
	    ev(ev),
	    stageMask(stageMask)
	{
	}
...
{
	ResetEvent(Event* ev, VkPipelineStageFlags stageMask) :
	    ev(ev),
	    stageMask(stageMask)
	{
	}
