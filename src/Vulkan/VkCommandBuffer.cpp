...
{
public:
	CmdResetEvent(vk::Event *ev, VkPipelineStageFlags2KHR stageMask)
	    : ev(ev)
	    , stageMask(stageMask)
	{
	}
...
private:
	vk::Event *const ev;
	const VkPipelineStageFlags2KHR stageMask;  // TODO(b/117835459): We currently ignore the flags and reset the event at the last stage
};
