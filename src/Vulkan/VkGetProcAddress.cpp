...
static const std::unordered_map<std::string, PFN_vkVoidFunction> &GetGlobalFunctionPointers()
{
...
static const std::unordered_map<std::string, PFN_vkVoidFunction> &GetInstanceFunctionPointers()
{
...
#undef MAKE_VULKAN_INSTANCE_ENTRY
	return instanceFunctionPointers;
}
...
static const std::unordered_map<std::string, PFN_vkVoidFunction> &GetDeviceFunctionPointers()
{
	...
	return deviceFunctionPointers;
}

static const std::vector<std::pair<const char *, std::unordered_map<std::string, PFN_vkVoidFunction>>> &GetDeviceExtensionFunctionPointers()
{
	...
	return deviceExtensionFunctionPointers;
}
...
{
	auto &globalFunctionPointers = GetGlobalFunctionPointers();
	...
	if(instance)
	{
		auto &instanceFunctionPointers = GetInstanceFunctionPointers();
		...
		auto &deviceFunctionPointers = GetDeviceFunctionPointers();
		...
		auto &deviceExtensionFunctionPointers = GetDeviceExtensionFunctionPointers();
