...
static const std::unordered_map<std::string, PFN_vkVoidFunction> instanceFunctionPointers =
{
	...
	// VK_KHR_maintenance1
	MAKE_VULKAN_INSTANCE_ENTRY(vkTrimCommandPoolKHR),
	// VK_KHR_sampler_ycbcr_conversion
	MAKE_VULKAN_INSTANCE_ENTRY(vkCreateSamplerYcbcrConversionKHR),
	MAKE_VULKAN_INSTANCE_ENTRY(vkDestroySamplerYcbcrConversionKHR),
	// VK_KHR_bind_memory2
	MAKE_VULKAN_INSTANCE_ENTRY(vkBindBufferMemory2KHR),
	MAKE_VULKAN_INSTANCE_ENTRY(vkBindImageMemory2KHR),
	// VK_KHR_get_memory_requirements2
	MAKE_VULKAN_INSTANCE_ENTRY(vkGetImageMemoryRequirements2KHR),
	MAKE_VULKAN_INSTANCE_ENTRY(vkGetBufferMemoryRequirements2KHR),
	MAKE_VULKAN_INSTANCE_ENTRY(vkGetImageSparseMemoryRequirements2KHR),
};
#undef MAKE_VULKAN_GLOBAL_ENTRY
