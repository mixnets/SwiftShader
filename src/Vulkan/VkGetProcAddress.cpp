...
{
	MAKE_VULKAN_INSTANCE_ENTRY(vkCreateInstance),
	MAKE_VULKAN_INSTANCE_ENTRY(vkEnumerateInstanceExtensionProperties),
	MAKE_VULKAN_INSTANCE_ENTRY(vkEnumerateInstanceLayerProperties),
	MAKE_VULKAN_INSTANCE_ENTRY(vkEnumerateInstanceVersion),
};
#undef MAKE_VULKAN_INSTANCE_ENTRY

#define MAKE_VULKAN_CORE_ENTRY(aFunction) { #aFunction, reinterpret_cast<PFN_vkVoidFunction>(aFunction) }
static const std::unordered_map<std::string, PFN_vkVoidFunction> coreFunctionPointers =
{
	MAKE_VULKAN_CORE_ENTRY(vkDestroyInstance),
	MAKE_VULKAN_CORE_ENTRY(vkEnumeratePhysicalDevices),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceFeatures),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceFormatProperties),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceImageFormatProperties),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceProperties),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceQueueFamilyProperties),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceMemoryProperties),
	MAKE_VULKAN_CORE_ENTRY(vkCreateDevice),
	MAKE_VULKAN_CORE_ENTRY(vkEnumerateDeviceExtensionProperties),
	MAKE_VULKAN_CORE_ENTRY(vkEnumerateDeviceLayerProperties),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceSparseImageFormatProperties),
	MAKE_VULKAN_CORE_ENTRY(vkEnumeratePhysicalDeviceGroups),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceFeatures2),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceProperties2),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceFormatProperties2),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceImageFormatProperties2),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceQueueFamilyProperties2),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceMemoryProperties2),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceSparseImageFormatProperties2),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceExternalBufferProperties),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceExternalFenceProperties),
	MAKE_VULKAN_CORE_ENTRY(vkGetPhysicalDeviceExternalSemaphoreProperties),
	// VK_KHR_maintenance1
	MAKE_VULKAN_CORE_ENTRY(vkTrimCommandPoolKHR),
	// VK_KHR_sampler_ycbcr_conversion
	MAKE_VULKAN_CORE_ENTRY(vkCreateSamplerYcbcrConversionKHR),
	MAKE_VULKAN_CORE_ENTRY(vkDestroySamplerYcbcrConversionKHR),
	// VK_KHR_bind_memory2
	MAKE_VULKAN_CORE_ENTRY(vkBindBufferMemory2KHR),
	MAKE_VULKAN_CORE_ENTRY(vkBindImageMemory2KHR),
	// VK_KHR_get_memory_requirements2
	MAKE_VULKAN_CORE_ENTRY(vkGetImageMemoryRequirements2KHR),
	MAKE_VULKAN_CORE_ENTRY(vkGetBufferMemoryRequirements2KHR),
	MAKE_VULKAN_CORE_ENTRY(vkGetImageSparseMemoryRequirements2KHR),
};
#undef MAKE_VULKAN_INSTANCE_ENTRY
...
static const std::unordered_map<std::string, PFN_vkVoidFunction> deviceFunctionPointers =
{
	...
	MAKE_VULKAN_DEVICE_ENTRY(vkEnumeratePhysicalDeviceGroupsKHR),
	// VK_KHR_external_fence_capabilities
	MAKE_VULKAN_DEVICE_ENTRY(vkGetPhysicalDeviceExternalFencePropertiesKHR),
	// VK_KHR_external_memory_capabilities
	MAKE_VULKAN_DEVICE_ENTRY(vkGetPhysicalDeviceExternalBufferPropertiesKHR),
	// VK_KHR_external_semaphore_capabilities
	MAKE_VULKAN_DEVICE_ENTRY(vkGetPhysicalDeviceExternalSemaphorePropertiesKHR),
	// VK_KHR_get_physical_device_properties2
	MAKE_VULKAN_DEVICE_ENTRY(vkGetPhysicalDeviceFeatures2KHR),
	MAKE_VULKAN_DEVICE_ENTRY(vkGetPhysicalDeviceProperties2KHR),
	MAKE_VULKAN_DEVICE_ENTRY(vkGetPhysicalDeviceFormatProperties2KHR),
	MAKE_VULKAN_DEVICE_ENTRY(vkGetPhysicalDeviceImageFormatProperties2KHR),
	MAKE_VULKAN_DEVICE_ENTRY(vkGetPhysicalDeviceQueueFamilyProperties2KHR),
	MAKE_VULKAN_DEVICE_ENTRY(vkGetPhysicalDeviceMemoryProperties2KHR),
	MAKE_VULKAN_DEVICE_ENTRY(vkGetPhysicalDeviceSparseImageFormatProperties2KHR),
	// VK_KHR_maintenance3
...
PFN_vkVoidFunction GetInstanceProcAddr(VkInstance instance, const char* pName)
{
	...
	{
		auto coreFunction = coreFunctionPointers.find(std::string(pName));
		if(coreFunction != coreFunctionPointers.end())
		{
			return coreFunction->second;
		}
