...
PipelineLayout::PipelineLayout(const VkPipelineLayoutCreateInfo* pCreateInfo, const Memory& mem) :
...
MemorySize PipelineLayout::ComputeRequiredAllocationSize(const VkPipelineLayoutCreateInfo* pCreateInfo)
{
	...
	return MemorySize(setLayoutsSize + pushConstantRangesSize, 0);
}
