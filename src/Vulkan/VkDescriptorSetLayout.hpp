...
public:
	...
	static void Notify(void* descriptorSet, DescriptorView::AccessType accessType);
	static void Unregister(void* descriptorSet);
...
private:
	...
	std::unordered_map<void*, DescriptorSetMetaData> descriptorMetaData;
