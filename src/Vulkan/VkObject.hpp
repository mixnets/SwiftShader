...
namespace vk
{
	inline void* allocate(size_t count, const VkAllocationCallbacks* pAllocator, VkSystemAllocationScope allocationScope)
	{
	...
	inline void deallocate(void* ptr, const VkAllocationCallbacks* pAllocator)
	{
