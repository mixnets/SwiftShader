...
// Whenever any object deriving from VkObject is declared, also declare a
...
public:
	...
	static inline VkSystemAllocationScope GetAllocationScope() { return VK_SYSTEM_ALLOCATION_SCOPE_OBJECT; }
