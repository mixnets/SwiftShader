...
Buffer::Buffer(const VkBufferCreateInfo* pCreateInfo, uint32_t* pQueueFamilyIndices)
...
{
	DestroyQueueFamilyIndices(pAllocator, queueFamilyIndices);
}

VkResult Buffer::AllocateQueueFamilyIndices(const VkAllocationCallbacks* pAllocator,
                                            ...
                                            uint32_t** queueFamilyIndices)
{
	...
	*queueFamilyIndices = reinterpret_cast<uint32_t*>(vk::allocate(
		queueFamilyIndicesSize, pAllocator, Buffer::GetAllocationScope()));
...
void Buffer::DestroyQueueFamilyIndices(const VkAllocationCallbacks* pAllocator, uint32_t* queueFamilyIndices)
{
