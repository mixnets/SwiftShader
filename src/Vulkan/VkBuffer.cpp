...
const VkMemoryRequirements Buffer::getMemoryRequirements() const
{
	...
	// TODO(b/195684837): Adds 15 bytes of padding so that any attribute with a starting address within the buffer bounds
	// can be read robustly. This may not produce spec-compliant results.
