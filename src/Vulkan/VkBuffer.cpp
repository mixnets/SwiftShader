...
Buffer::Buffer(const VkBufferCreateInfo* pCreateInfo, const Memory& mem)
...
MemorySize Buffer::ComputeRequiredAllocationSize(const VkBufferCreateInfo* pCreateInfo)
{
