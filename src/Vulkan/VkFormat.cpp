...
int Format::pitchB(int width, int border, const VkSubresourceLayout &drmPlaneLayout) const
{
	...
	{
		return drmPlaneLayout.rowPitch;
	}
...
{
	if(drmPlaneLayout.depthPitch > 0)
	{
		return drmPlaneLayout.depthPitch;
	}
	if(drmPlaneLayout.arrayPitch > 0)
	{
		return drmPlaneLayout.arrayPitch;
	}
