	...
	: physicalDevice(pPhysicalDevice)
{
	...
	queues = reinterpret_cast<VkQueue*>(
		vk::allocate(sizeof(Queue*) * queueCount, pAllocator, VK_SYSTEM_ALLOCATION_SCOPE_OBJECT));
...
{
	return reinterpret_cast<VkDevice>(this);
}

void* Device::operator new(size_t count, const VkAllocationCallbacks* pAllocator)
{
	return vk::allocate(count, pAllocator, VK_SYSTEM_ALLOCATION_SCOPE_DEVICE);
}

void Device::operator delete(void* ptr, const VkAllocationCallbacks* pAllocator)
{
