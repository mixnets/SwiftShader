...
void logv_android(Level level, const char *msg)
{
	...
	{
		case Level::DEBUG:
			__android_log_print(ANDROID_LOG_DEBUG, "SwiftShader", msg);
			break;
		case Level::INFO:
			__android_log_print(ANDROID_LOG_INFO, "SwiftShader", msg);
			break;
		case Level::WARN:
			__android_log_print(ANDROID_LOG_WARN, "SwiftShader", msg);
			break;
		case Level::ERROR:
			__android_log_print(ANDROID_LOG_ERROR, "SwiftShader", msg);
			break;
		case Level::FATAL:
			__android_log_print(ANDROID_LOG_FATAL, "SwiftShader", msg);
			break;
	}
}
#endif  // __ANDROID__
