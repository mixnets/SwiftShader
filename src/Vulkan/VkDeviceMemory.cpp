...
class HostMemory : public vk::DeviceMemory::ExternalBase
{
public:
	struct AllocateInfo
	{
			...
			while(createInfo)
			{
				switch(createInfo->sType)
				{
					case VK_STRUCTURE_TYPE_IMPORT_MEMORY_HOST_POINTER_INFO_EXT:
					{
						...
						if(importInfo->handleType != VK_EXTERNAL_MEMORY_HANDLE_TYPE_HOST_ALLOCATION_BIT_EXT
	...
	explicit HostMemory(const VkMemoryAllocateInfo *pAllocateInfo)
...
#endif
	if(parseCreateInfo<HostMemory>(pAllocateInfo, pTraits))
	{
		return;
	}
