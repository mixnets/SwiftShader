...
VkResult DeviceMemory::CreateFromFactory(const VkAllocationCallbacks *pAllocator, const VkMemoryAllocateInfo *pAllocateInfo, VkDeviceMemory *pMemory, Device *device)
{
...
VkResult DeviceMemory::exportAndroidHardwareBuffer(struct AHardwareBuffer **pAhb) const
{
	...
	return exportAndroidHardwareBuffer(pAhb);
}
