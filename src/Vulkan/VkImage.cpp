...
Image::Image(const VkImageCreateInfo* pCreateInfo, uint32_t* pQueueFamilyIndices) :
...
VkResult Image::AllocateQueueFamilyIndices(const VkAllocationCallbacks* pAllocator,
...
void Image::DestroyQueueFamilyIndices(const VkAllocationCallbacks* pAllocator, uint32_t* queueFamilyIndices)
{
