...
{
public:
	FileBase(ID id, const std::string& dir, const std::string& name, const std::string& source);
...
FileBase::FileBase(ID id, const std::string& dir, const std::string& name, const std::string& source) :
    File(id, dir, name, source) {}
