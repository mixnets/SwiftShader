...
protected:
	inline File(ID id, const std::string& dir, const std::string& name, const std::string& source);
};

File::File(ID id, const std::string& dir, const std::string& name, const std::string& source) :
    id(id),
    dir(dir),
    name(name),
    source(source) {}
