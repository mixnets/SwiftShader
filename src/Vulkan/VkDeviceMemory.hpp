...
public:
	...
	// Return a bitmask of VkExternalMemoryHandleTypeFlagBits values that
	// are supported by this device memory instance. Note that this always
	// returns 0u if this is not an external memory instance.
	VkExternalMemoryHandleTypeFlags getExternalHandleTypes() const;
