...
vk::Queue::SubmitInfo *DeepCopySubmitInfo(uint32_t submitCount, const VkSubmitInfo *pSubmits)
{
	size_t submitSize = sizeof(vk::Queue::SubmitInfo) * submitCount;
	...
	auto submits = new(mem) vk::Queue::SubmitInfo[submitCount];
	mem += submitSize;
...
vk::Queue::SubmitInfo *DeepCopySubmitInfo(uint32_t submitCount, const VkSubmitInfo2KHR *pSubmits)
{
	size_t submitSize = sizeof(vk::Queue::SubmitInfo) * submitCount;
	size_t totalSize = submitSize;
	for(uint32_t i = 0; i < submitCount; i++)
