...
void PhysicalDevice::getQueueFamilyProperties(VkQueueFamilyProperties &properties) const
{
                                              ...
                                              VkQueueFamilyProperties *pQueueFamilyProperties) const
{
	...
	{
		getQueueFamilyProperties(pQueueFamilyProperties[i]);
	}
}
                                              ...
                                              VkQueueFamilyProperties2 *pQueueFamilyProperties) const
{
	for(uint32_t i = 0; i < pQueueFamilyPropertyCount; i++)
	{
		getQueueFamilyProperties(pQueueFamilyProperties[i].queueFamilyProperties);
	}
}
