...
template<typename T>
void PhysicalDevice::getPhysicalDeviceSamplerYcbcrConversionFeatures(T *features) const
{
	features->samplerYcbcrConversion = VK_TRUE;
}

template<typename T>
void PhysicalDevice::getPhysicalDevice16BitStorageFeatures(T *features) const
{
...
template<typename T>
void PhysicalDevice::getPhysicalDeviceVariablePointersFeatures(T *features) const
{
...
template<typename T>
void PhysicalDevice::getPhysicalDevice8BitStorageFeaturesKHR(T *features) const
{
...
template<typename T>
void PhysicalDevice::getPhysicalDeviceMultiviewFeatures(T *features) const
{
...
template<typename T>
void PhysicalDevice::getPhysicalDeviceProtectedMemoryFeatures(T *features) const
{
	features->protectedMemory = VK_FALSE;
}

template<typename T>
void PhysicalDevice::getPhysicalDeviceShaderDrawParameterFeatures(T *features) const
{
	features->shaderDrawParameters = VK_FALSE;
}

template<typename T>
void PhysicalDevice::getPhysicalDeviceSeparateDepthStencilLayoutsFeaturesKHR(T *features) const
{
	features->separateDepthStencilLayouts = VK_TRUE;
}

template<typename T>
void PhysicalDevice::getPhysicalDeviceLineRasterizationFeaturesEXT(T *features) const
{
...
template<typename T>
void PhysicalDevice::getPhysicalDeviceProvokingVertexFeaturesEXT(T *features) const
{
	features->provokingVertexLast = VK_TRUE;
}

template<typename T>
void PhysicalDevice::getPhysicalDeviceImageRobustnessFeaturesEXT(T *features) const
{
	features->robustImageAccess = VK_TRUE;
}

template<typename T>
void PhysicalDevice::getPhysicalDeviceShaderDrawParametersFeatures(T *features) const
{
	features->shaderDrawParameters = VK_FALSE;
}

template<typename T>
void PhysicalDevice::getPhysicalDeviceVulkan11Features(T *features) const
{
	PhysicalDevice::getPhysicalDevice16BitStorageFeatures(features);
	PhysicalDevice::getPhysicalDeviceMultiviewFeatures(features);
	PhysicalDevice::getPhysicalDeviceVariablePointersFeatures(features);
	PhysicalDevice::getPhysicalDeviceProtectedMemoryFeatures(features);
	PhysicalDevice::getPhysicalDeviceSamplerYcbcrConversionFeatures(features);
	PhysicalDevice::getPhysicalDeviceShaderDrawParametersFeatures(features);
}

template<typename T>
void PhysicalDevice::getPhysicalDeviceVulkan12Features(T *features) const
{
