...
static void getPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM(VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM *features)
{
...
void PhysicalDevice::getFeatures2(VkPhysicalDeviceFeatures2 *features) const
{
	...
	while(curExtension != nullptr)
	{
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_FEATURES_ARM:
			getPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM(reinterpret_cast<struct VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM *>(curExtension));
			break;
