...
static void getPhysicalDeviceInlineUniformBlockFeaturesExt(VkPhysicalDeviceInlineUniformBlockFeaturesEXT *features)
{
...
void PhysicalDevice::getFeatures2(VkPhysicalDeviceFeatures2 *features) const
{
	...
	while(curExtension != nullptr)
	{
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_FEATURES_EXT:
			getPhysicalDeviceInlineUniformBlockFeaturesExt(reinterpret_cast<VkPhysicalDeviceInlineUniformBlockFeaturesEXT *>(curExtension));
			break;
...
void PhysicalDevice::getProperties(VkPhysicalDeviceInlineUniformBlockPropertiesEXT *properties) const
{
	properties->maxInlineUniformBlockSize = MAX_INLINE_UNIFORM_BLOCK_SIZE;
	properties->maxPerStageDescriptorInlineUniformBlocks = 32;
	properties->maxPerStageDescriptorUpdateAfterBindInlineUniformBlocks = 32;
	properties->maxDescriptorSetInlineUniformBlocks = 32;
	properties->maxDescriptorSetUpdateAfterBindInlineUniformBlocks = 32;
}
...
bool PhysicalDevice::hasExtendedFeatures(const VkPhysicalDeviceInlineUniformBlockFeaturesEXT *requested) const
{
	auto supported = getSupportedFeatures(requested);
