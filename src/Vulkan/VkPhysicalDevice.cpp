...
bool PhysicalDevice::hasExtendedFeatures(const T *requestedFeature) const
{
	...
	const VkBool32 *requestedFeatureBools = reinterpret_cast<const VkBool32 *>(requestedFeature) + offsetToFirstBool32;
	const VkBool32 *supportedFeatureBools = reinterpret_cast<const VkBool32 *>(&supportedFeature) + offsetToFirstBool32;
...
#define InstantiateHasFeatures2(Type) template bool PhysicalDevice::hasFeatures2<Type>(const Type *requestedFeature) const
InstantiateHasFeatures2(VkPhysicalDeviceLineRasterizationFeaturesEXT);
InstantiateHasFeatures2(VkPhysicalDeviceProvokingVertexFeaturesEXT);
InstantiateHasFeatures2(VkPhysicalDeviceVulkan11Features);
InstantiateHasFeatures2(VkPhysicalDeviceVulkan12Features);
InstantiateHasFeatures2(VkPhysicalDeviceDepthClipEnableFeaturesEXT);
