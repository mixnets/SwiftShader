...
public:
	...
	{
		// FIXME(sugoi): perform a deep copy of the VkGraphicsPipelineCreateInfo structure
	}

	Pipeline(const VkAllocationCallbacks* pAllocator, const VkComputePipelineCreateInfo& pCreateInfo) :
		computeInfo(&pCreateInfo)
	{
		// FIXME(sugoi): perform a deep copy of the VkComputePipelineCreateInfo structure
	}
