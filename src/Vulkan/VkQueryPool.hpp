...
class QueryPool : public VkObject<QueryPool, VkQueryPool>
{
public:
	QueryPool(const VkQueryPoolCreateInfo* pCreateInfo) :
		flags(pCreateInfo->flags), queryCount(pCreateInfo->queryCount)
	{
