...
{
public:
	PipelineLayout(const VkPipelineLayoutCreateInfo* pCreateInfo,
		VkDescriptorSetLayout* pSetLayouts, VkPushConstantRange* pPushConstantRange);
	~PipelineLayout() = delete;
	void destroy(const VkAllocationCallbacks* pAllocator) override;

	static VkResult AllocateMembers(const VkAllocationCallbacks* pAllocator, const VkPipelineLayoutCreateInfo* pCreateInfo,
