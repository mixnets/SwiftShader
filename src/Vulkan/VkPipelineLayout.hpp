...
{
public:
	PipelineLayout(const VkPipelineLayoutCreateInfo* pCreateInfo, const Memory& mem);
	~PipelineLayout() = delete;
	void destroy(const VkAllocationCallbacks* pAllocator);

	static MemorySize ComputeRequiredAllocationSize(const VkPipelineLayoutCreateInfo* pCreateInfo);
