...
{
public:
	RenderPass(const VkRenderPassCreateInfo* pCreateInfo, VkAttachmentDescription* pAttachments,
	...
	static VkResult AllocateMembers(const VkAllocationCallbacks* pAllocator, const VkRenderPassCreateInfo* pCreateInfo,
		VkAttachmentDescription** attachments, VkSubpassDescription** subpasses, VkSubpassDependency** dependencies);
	static void DestroyMembers(const VkAllocationCallbacks* pAllocator,
		VkAttachmentDescription* attachments, VkSubpassDescription* subpasses, VkSubpassDependency* dependencies);
