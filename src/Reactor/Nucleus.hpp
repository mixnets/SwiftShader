...
namespace sw
{
	...
	public:
		...
		static void setFunction(Ice::Cfg *function);
		...
		static Ice::Cfg *createFunction(Ice::Type ReturnType, std::vector<Ice::Type> &Params);
		static Ice::Variable *getArgument(Ice::Cfg *function, unsigned int index);
	...
	//private:
		...
		static Ice::GlobalContext *context;
		static Ice::Cfg *function;
		static Ice::CfgNode *basicBlock;
		static Ice::CfgLocalAllocatorScope *allocator;
