...
namespace sw
{
	...
	public:
		...
		static Value *createConstantVector(const int64_t *constants, Type *type, unsigned int numConstants);
		static Value *createConstantVector(const double *constants, Type *type, unsigned int numConstants);
