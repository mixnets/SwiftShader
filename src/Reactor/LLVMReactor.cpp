...
(defined(__linux__) && (defined(__arm__) || defined(__aarch64__)))
	...
	public:
		...
		rr::RoutineSPtr acquireRoutine(llvm::Function **funcs, size_t count, const rr::Config &cfg)
		{
			ASSERT(module);
...
RoutineSPtr Nucleus::acquireCoroutine(const char *name, const Config::Edit &cfgEdit /* = Config::Edit::None */)
{
