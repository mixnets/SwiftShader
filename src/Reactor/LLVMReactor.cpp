...
namespace sw
{
	...
	llvm::Type *T(Type *t)
	{
		...
		if(type < EmulatedTypeCount)
		{
			switch(type)
			{
			case Type_v2i32: return T(Int2::getType());
			case Type_v4i16: return T(Short4::getType());
			case Type_v2i16: return T(Short2::getType());
			case Type_v8i8:  return T(Byte8::getType());
			case Type_v4i8:  return T(Byte4::getType());
	...
	{
		#if 0
			return T(VectorType::get(T(Byte::getType()), 4));
		#else
	...
	{
		#if 0
			return T(VectorType::get(T(SByte::getType()), 4));
		#else
...
//	}
	...
	Type *Byte8::getType()
	{
		...
		{
			return T(VectorType::get(T(Byte::getType()), 8));
		}
	}
...
//	}
	...
	Type *SByte8::getType()
	{
		...
		{
			return T(VectorType::get(T(SByte::getType()), 8));
		}
	}
	...
	{
		#if 0
			return T(VectorType::get(T(Short::getType()), 2));
		#else
			return UInt::getType();   // FIXME: LLVM doesn't manipulate it as one 32-bit block
		#endif
	}
	...
	{
		#if 0
			return T(VectorType::get(T(UShort::getType()), 2));
		#else
			return UInt::getType();   // FIXME: LLVM doesn't manipulate it as one 32-bit block
		#endif
	}
...
//	}
	...
	Type *Short4::getType()
	{
		...
		{
			return T(VectorType::get(T(Short::getType()), 4));
		}
	}
	...
	Type *UShort4::getType()
	{
		...
		{
			return T(VectorType::get(T(UShort::getType()), 4));
		}
	}
...
//	}
	...
	Type *Int2::getType()
	{
		...
		{
			return T(VectorType::get(T(Int::getType()), 2));
		}
	}
...
//	}
	...
	Type *UInt2::getType()
	{
		...
		{
			return T(VectorType::get(T(UInt::getType()), 2));
		}
	}
