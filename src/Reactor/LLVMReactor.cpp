...
namespace
{
	...
	public:
		...
		const std::vector<std::string> mattrs = getMattrs();
		const char* arch = getArch();
		const llvm::TargetOptions targetOptions = getTargetOptions();
		size_t numEmittedFunctions = 0;
	...
	std::vector<std::string> JITGlobals::getMattrs()
	{
...
(defined(__linux__) && (defined(__arm__) || defined(__aarch64__)))
	...
	llvm::TargetOptions JITGlobals::getTargetOptions()
	{
	...
	class JITInstance : public RefCounted
	{
	private:
	...
	public:
		...
		rr::LLVMRoutine *acquireRoutine(llvm::Function **funcs, size_t count)
		{
			std::vector<std::string> mangledNames(count);
			for (size_t i = 0; i < count; i++)
			{
				auto func = funcs[i];
				std::string name = "f" + llvm::Twine(JITGlobals::get()->numEmittedFunctions++).str();
				func->setName(name);
			...
			reference();
			return new rr::LLVMRoutine(addresses.data(), count, [=] ()
			{
				this->releaseRoutineModule(moduleKey);
				this->release();
			});
		}
...
namespace rr
{
	...
	static ::llvm::Function* createFunction(const char *name, ::llvm::Type *retTy, const std::vector<::llvm::Type*> &params)
	{
		...
		auto func = llvm::Function::Create(functionType, llvm::GlobalValue::InternalLinkage, name, jit->module);
		func->setDoesNotThrow();
	...
	Routine *Nucleus::acquireRoutine(const char *name, bool runOptimizations)
	{
		...
		LLVMRoutine *routine = jit->acquireRoutine(&jit->function, 1);
	...
	Value *Nucleus::createMaskedLoad(Value *ptr, Type *elTy, Value *mask, unsigned int alignment)
	{
		...
		auto func = ::llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::masked_load, { elVecTy, elVecPtrTy } );
	...
	void Nucleus::createMaskedStore(Value *ptr, Value *val, Value *mask, unsigned int alignment)
	{
		...
		auto i8Mask = jit->builder->CreateIntCast(V(mask), ::llvm::VectorType::get(i1Ty, numEls), false); // vec<int, int, ...> -> vec<bool, bool, ...>
		auto align = ::llvm::ConstantInt::get(i32Ty, alignment);
		auto func = ::llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::masked_store, { elVecTy, elVecPtrTy } );
	...
	Value *Nucleus::createGather(Value *base, Type *elTy, Value *offsets, Value *mask, unsigned int alignment)
	{
		...
		auto passthrough = ::llvm::Constant::getNullValue(elVecTy);
		auto align = ::llvm::ConstantInt::get(i32Ty, alignment);
		auto func = ::llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::masked_gather, { elVecTy, elPtrVecTy } );
	...
	void Nucleus::createScatter(Value *base, Value *val, Value *offsets, Value *mask, unsigned int alignment)
	{
		...
		auto i8Mask = jit->builder->CreateIntCast(V(mask), ::llvm::VectorType::get(i1Ty, numEls), false); // vec<int, int, ...> -> vec<bool, bool, ...>
		auto align = ::llvm::ConstantInt::get(i32Ty, alignment);
		auto func = ::llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::masked_scatter, { elVecTy, elPtrVecTy } );
...
//	}
	...
	{
		auto func = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::sin, { V(v.value)->getType() } );
		return RValue<Float4>(V(jit->builder->CreateCall(func, V(v.value))));
	}

	RValue<Float4> Cos(RValue<Float4> v)
	{
		auto func = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::cos, { V(v.value)->getType() } );
		return RValue<Float4>(V(jit->builder->CreateCall(func, V(v.value))));
	}
	...
	{
		auto func = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::pow, { T(Float4::getType()) });
		return RValue<Float4>(V(jit->builder->CreateCall2(func, ARGS(V(x.value), V(y.value)))));
	}

	RValue<Float4> Exp(RValue<Float4> v)
	{
		auto func = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::exp, { T(Float4::getType()) } );
		return RValue<Float4>(V(jit->builder->CreateCall(func, V(v.value))));
	}

	RValue<Float4> Log(RValue<Float4> v)
	{
		auto func = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::log, { T(Float4::getType()) } );
		return RValue<Float4>(V(jit->builder->CreateCall(func, V(v.value))));
	}

	RValue<Float4> Exp2(RValue<Float4> v)
	{
		auto func = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::exp2, { T(Float4::getType()) } );
		return RValue<Float4>(V(jit->builder->CreateCall(func, V(v.value))));
	}

	RValue<Float4> Log2(RValue<Float4> v)
	{
		auto func = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::log2, { T(Float4::getType()) } );
		return RValue<Float4>(V(jit->builder->CreateCall(func, V(v.value))));
	}

	RValue<UInt4> Ctlz(RValue<UInt4> v, bool isZeroUndef)
	{
		auto func = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::ctlz, { T(UInt4::getType()) } );
	...
	{
		auto func = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::cttz, { T(UInt4::getType()) } );
		return RValue<UInt4>(V(jit->builder->CreateCall2(func, ARGS(
			V(v.value),
			isZeroUndef ? ::llvm::ConstantInt::getTrue(jit->context) : ::llvm::ConstantInt::getFalse(jit->context)
		))));
	...
	{
		RR_DEBUG_INFO_UPDATE_LOC();
		llvm::Function *rdtsc = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::readcyclecounter);
	...
	void Breakpoint()
	{
		llvm::Function *debugtrap = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::debugtrap);
...
namespace rr
{
	...
	namespace x86
	{
		...
		{
			llvm::Function *cvtss2si = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse_cvtss2si);
		...
		{
			llvm::Function *cvtps2dq = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_cvtps2dq);
		...
		{
			llvm::Function *rcpss = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse_rcp_ss);
		...
		{
			llvm::Function *sqrt = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::sqrt, {V(val.value)->getType()});
			return RValue<Float>(V(jit->builder->CreateCall(sqrt, ARGS(V(val.value)))));
		}

		RValue<Float> rsqrtss(RValue<Float> val)
		{
			llvm::Function *rsqrtss = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse_rsqrt_ss);
		...
		{
			llvm::Function *rcpps = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse_rcp_ps);
		...
		{
			llvm::Function *sqrtps = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::sqrt, {V(val.value)->getType()});
		...
		{
			llvm::Function *rsqrtps = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse_rsqrt_ps);
		...
		{
			llvm::Function *maxps = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse_max_ps);
		...
		{
			llvm::Function *minps = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse_min_ps);
		...
		{
			llvm::Function *roundss = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse41_round_ss);
		...
		{
			llvm::Function *roundps = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse41_round_ps);
		...
		{
			llvm::Function *paddsw = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_padds_w);
		...
		{
			llvm::Function *psubsw = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_psubs_w);
		...
		{
			llvm::Function *paddusw = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_paddus_w);
		...
		{
			llvm::Function *psubusw = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_psubus_w);
		...
		{
			llvm::Function *paddsb = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_padds_b);
		...
		{
			llvm::Function *psubsb = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_psubs_b);
		...
		{
			llvm::Function *paddusb = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_paddus_b);
		...
		{
			llvm::Function *psubusb = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_psubus_b);
		...
		{
			llvm::Function *packssdw = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_packssdw_128);
		...
		{
			llvm::Function *packsswb = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_packsswb_128);
		...
		{
			llvm::Function *packuswb = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_packuswb_128);
		...
		RValue<UShort8> packusdw(RValue<Int4> x, RValue<Int4> y)
		{
			if(CPUID::supportsSSE4_1())
			{
				llvm::Function *packusdw = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse41_packusdw);
		...
		{
			llvm::Function *psrlw = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_psrli_w);
		...
		{
			llvm::Function *psraw = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_psrai_w);
		...
		{
			llvm::Function *psllw = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_pslli_w);
		...
		{
			llvm::Function *pslld = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_pslli_d);
		...
		{
			llvm::Function *psrad = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_psrai_d);
		...
		{
			llvm::Function *psrld = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_psrli_d);
		...
		{
			llvm::Function *pmulhw = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_pmulh_w);
		...
		{
			llvm::Function *pmulhuw = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_pmulhu_w);
		...
		{
			llvm::Function *pmaddwd = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_pmadd_wd);
		...
		{
			llvm::Function *movmskps = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse_movmsk_ps);
		...
		{
			llvm::Function *pmovmskb = llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::x86_sse2_pmovmskb_128);
...
void Nucleus::createCoroutine(Type *YieldType, std::vector<Type*> &Params)
{
	...
	// LLVM intrinsics
	auto coro_id = ::llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::coro_id);
	auto coro_size = ::llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::coro_size, {i32Ty});
	auto coro_begin = ::llvm::Intrinsic::getDeclaration(jit->module, llvm::Intrinsic::coro_begin);
	auto coro_resume = ::llvm::Intrinsic::getDeclaration(jit->module, ::llvm::Intrinsic::coro_resume);
	auto coro_end = ::llvm::Intrinsic::getDeclaration(jit->module, ::llvm::Intrinsic::coro_end);
	auto coro_free = ::llvm::Intrinsic::getDeclaration(jit->module, ::llvm::Intrinsic::coro_free);
	auto coro_destroy = ::llvm::Intrinsic::getDeclaration(jit->module, ::llvm::Intrinsic::coro_destroy);
	auto coro_promise = ::llvm::Intrinsic::getDeclaration(jit->module, ::llvm::Intrinsic::coro_promise);
	auto coro_done = ::llvm::Intrinsic::getDeclaration(jit->module, ::llvm::Intrinsic::coro_done);
	auto coro_suspend = ::llvm::Intrinsic::getDeclaration(jit->module, ::llvm::Intrinsic::coro_suspend);
...
Routine* Nucleus::acquireCoroutine(const char *name, bool runOptimizations)
{
	...
	jit->coroutine = JITInstance::CoroutineState{};
