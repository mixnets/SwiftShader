...
// If enabled, EmitLocation will emit printf calls that output the function
// name, file, and line number. Useful when target doesn't support debugging
// of reactor-generated code (e.g. Windows).
#define ENABLE_PRINT_EMIT_LOCATION 0
