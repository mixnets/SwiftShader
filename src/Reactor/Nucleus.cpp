...
namespace sw
{
	...
	Ice::GlobalContext *Nucleus::context = nullptr;
	Ice::Cfg *Nucleus::function = nullptr;
	Ice::CfgNode *Nucleus::basicBlock = nullptr;
	Ice::CfgLocalAllocatorScope *Nucleus::allocator = nullptr;
	Routine *Nucleus::routine = nullptr;
	...
	void Nucleus::setFunction(Ice::Cfg *function)
	{
...
////	}
	...
	Ice::Cfg *Nucleus::createFunction(Ice::Type ReturnType, std::vector<Ice::Type> &Params)
	{
	...
	Ice::Variable *Nucleus::getArgument(Ice::Cfg *function, unsigned int index)
	{
...
////	}
	...
	Type Void::getType()
	{
		return Ice::IceType_void;////Type::getVoidTy(*Nucleus::getContext());
	}
...
////	}
	...
	void Return(bool ret)
	{
		...
		Ice::Operand *Ret = Ice::ConstantInteger32::create(Nucleus::context, Ice::IceType_i32, ret ? 1 : 0);
		Ice::InstRet *retu = Ice::InstRet::create(Nucleus::function, Ret);
		Nucleus::basicBlock->appendInst(retu);
	}
	...
	void Return(const Int &ret)
	{
		...
		Ice::InstRet *retu = Ice::InstRet::create(Nucleus::function, ret.loadValue());
		Nucleus::basicBlock->appendInst(retu);
	}
