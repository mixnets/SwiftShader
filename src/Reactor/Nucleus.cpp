...
namespace sw
{
	...
	{
		static_cast<SwitchInst*>(Switch)->addCase(ConstantInt::get(Type::getInt32Ty(*::context), Case, true), Branch);
	}
	...
	{
		return ConstantInt::get(Type::getInt64Ty(*::context), i, true);
	}

	Constant *Nucleus::createConstantInt(int i)
	{
		return ConstantInt::get(Type::getInt32Ty(*::context), i, true);
	}

	Constant *Nucleus::createConstantInt(unsigned int i)
	{
		return ConstantInt::get(Type::getInt32Ty(*::context), i, false);
	}

	Constant *Nucleus::createConstantBool(bool b)
	{
		return ConstantInt::get(Type::getInt1Ty(*::context), b);
	}

	Constant *Nucleus::createConstantByte(signed char i)
	{
		return ConstantInt::get(Type::getInt8Ty(*::context), i, true);
	}

	Constant *Nucleus::createConstantByte(unsigned char i)
	{
		return ConstantInt::get(Type::getInt8Ty(*::context), i, false);
	}

	Constant *Nucleus::createConstantShort(short i)
	{
		return ConstantInt::get(Type::getInt16Ty(*::context), i, true);
	}

	Constant *Nucleus::createConstantShort(unsigned short i)
	{
		return ConstantInt::get(Type::getInt16Ty(*::context), i, false);
	}
