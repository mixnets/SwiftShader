...
//	}
	...
	{
		Value *x0 = Nucleus::createInsertElement(UndefValue::get(VectorType::get(Int::getType(), 2)), cast.value, 0);
		Value *x1 = Nucleus::createInsertElement(x0, Nucleus::createConstantInt(0), 1);

		storeValue(Nucleus::createBitCast(x1, Long1::getType()));
	}
