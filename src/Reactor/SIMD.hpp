...
public:
	...
	Int(RValue<packed::Int4> rhs);
	template<int T>
	Int(const SwizzleMask1<packed::Int4, T> &rhs);
	operator packed::Int4();
...
public:
	...
	explicit Pointer(SIMD::UInt cast);
	explicit Pointer(SIMD::UInt castLow, SIMD::UInt castHight);
