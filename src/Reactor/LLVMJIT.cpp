...
public:
	JITRoutine(
	    ...
	    : objectLayer(session, []() { return std::make_unique<llvm::SectionMemoryManager>(new MemoryMapper()); })
	          ...
	          .setNotifyLoaded([](llvm::orc::VModuleKey, const llvm::object::ObjectFile &Obj, const llvm::RuntimeDyld::LoadedObjectInfo &L) {
		          rr::DebugInfo::NotifyObjectEmitted(Obj, L);
	          })
	          .setNotifyEmitted([](llvm::orc::VModuleKey, const llvm::object::ObjectFile &Obj) {
