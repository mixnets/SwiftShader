...
//	}
	...
	void IfData::endIf()
	{
		auto var = ::function->makeVariable(Ice::IceType_i32);
		auto phi = Ice::InstPhi::create(::function, 2, var);
		phi->addArgument(trueValue, trueBB);
		phi->addArgument(falseValue, falseBB);
