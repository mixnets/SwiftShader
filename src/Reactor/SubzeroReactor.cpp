...
//	}
	...
	Value *Nucleus::createMaskedLoad(Value *ptr, Type *elTy, Value *mask, unsigned int alignment, bool zeroDisabledLanes) { UNIMPLEMENTED("Subzero createMaskedLoad()"); return nullptr; }
	...
	Value *Nucleus::createGather(Value *base, Type *elTy, Value *offsets, Value *mask, unsigned int alignment, bool zeroDisabledLanes) { UNIMPLEMENTED("Subzero createGather()"); return nullptr; }
