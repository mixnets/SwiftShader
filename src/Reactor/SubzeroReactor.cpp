...
namespace rr
{
	...
	RoutineSPtr Nucleus::acquireRoutine(const char *name, const Config::Edit &cfgEdit /* = Config::Edit::None */)
	{
		...
		return RoutineSPtr(handoffRoutine);
	}
...
//	}
	...
	RoutineSPtr Nucleus::acquireCoroutine(const char *name, const Config::Edit &cfgEdit /* = Config::Edit::None */) { UNIMPLEMENTED("acquireCoroutine"); return nullptr; }
