...
namespace sw
{
	...
	Byte4::Byte4(RValue<Int> cast)
	{
	//	xyzw.parent = this;

		auto *vector = loadValue();//::function->makeVariable(Ice::IceType_v4i32);
		storeValue(Nucleus::createBitCast(Nucleus::createInsertElement(V(vector), cast.value, 0), Byte4::getType()));
	}
