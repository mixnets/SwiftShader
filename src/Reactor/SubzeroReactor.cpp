...
static void __vectorcall store128(__m128i *ptr, __m128i val)
{
	return _mm_storeu_si128(ptr, val);
}

static void __vectorcall store32_128(void *ptr, __m128i val)
{
	return _mm_storeu_si32(ptr, val);
}

static void __vectorcall store64_128(void *ptr, __m128i val)
{
	return _mm_storeu_si64(ptr, val);
}
