...
{
	// TODO(b/175612820): Update once we implement x86 SSE rcp_ss and rsqrt_ss intrinsics in Subzero
	UNIMPLEMENTED_NO_BUG("RValue<Float4> RcpApprox()");
	return { 0.0f };
}
...
{
	// TODO(b/175612820): Update once we implement x86 SSE rcp_ss and rsqrt_ss intrinsics in Subzero
	UNIMPLEMENTED_NO_BUG("RValue<Float> RcpApprox()");
	return { 0.0f };
}
...
{
	// TODO(b/175612820): Update once we implement x86 SSE rcp_ss and rsqrt_ss intrinsics in Subzero
	UNIMPLEMENTED_NO_BUG("RValue<Float4> RcpSqrtApprox()");
	return { 0.0f };
}
...
{
	// TODO(b/175612820): Update once we implement x86 SSE rcp_ss and rsqrt_ss intrinsics in Subzero
	UNIMPLEMENTED_NO_BUG("RValue<Float> RcpSqrtApprox()");
	return { 0.0f };
}
