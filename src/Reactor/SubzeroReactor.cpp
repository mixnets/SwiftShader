...
//	}
	...
	Value *Nucleus::createGather(Value *base, Type *elTy, Value *offsets, Value *mask, unsigned int alignment, Type *resultTy) { UNIMPLEMENTED("Subzero createGather()"); return nullptr; }
