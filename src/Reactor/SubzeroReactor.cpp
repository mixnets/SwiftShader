...
//	}
	...
	RValue<Pointer<Byte>> ConstantPointer(void const * ptr)  { UNIMPLEMENTED("Subzero ConstantPointer()"); return Pointer<Byte>(); }
	Value* Call(RValue<Pointer<Byte>> fptr, std::initializer_list<Value*> args, Type* retTy, std::initializer_list<Type*> argTys) { UNIMPLEMENTED("Subzero Call()"); return nullptr; }
