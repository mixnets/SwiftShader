...
{
	// InstLoad assumes that a constant ptr is an offset, rather than an absolute address.
	// We circumvent this by casting to a non-const variable, and loading from that.
