...
namespace sw
{
	...
	private:
		...
		template <typename T> void processINDEXEDsimple(DrawCall *draw, T *indexBegin, T *index, unsigned int batch[][3], unsigned int triangleCount, int primitiveRestartDataIndex);
		template <typename T> void processINDEXEDLINELOOP(DrawCall *draw, T *indexBegin, T *index, unsigned int batch[][3], unsigned int triangleCount, unsigned int startPrimitive, int primitiveRestartDataIndex);
		template <typename T> void processINDEXEDTRIANGLESTRIP(DrawCall *draw, T *indexBegin, T *index, unsigned int batch[][3], unsigned int triangleCount, unsigned int startPrimitive, int primitiveRestartDataIndex);
		template <typename T> void processINDEXEDTRIANGLEFAN(DrawCall *draw, T *indexBegin, T *index, unsigned int batch[][3], unsigned int triangleCount, unsigned int startPrimitive, int primitiveRestartDataIndex);
