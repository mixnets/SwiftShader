...
namespace sw
{
	...
	public:
		...
		virtual void lockUniformBuffers(byte** u, std::vector<Resource*>& lockedResources);
		...
		virtual void lockTransformFeedbackBuffers(byte** t, unsigned int* v, unsigned int* r, unsigned int* c, unsigned int* s, std::vector<Resource*>& lockedResources);
