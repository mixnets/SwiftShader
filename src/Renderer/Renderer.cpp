...
namespace sw
{
	...
	void Renderer::blit(Surface *source, const Rect &sRect, int sourceZ, Surface *dest, const Rect &dRect, bool filter)
	{
		blitter.blit(source, sRect, sourceZ, dest, dRect, filter);
	}
