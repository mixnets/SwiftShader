...
SWIFTSHADER_COMMON_SHARED_LIBRARIES := \
	libhardware \
	liblog \
	libcutils \
	libui \
...
LOCAL_MODULE := libswiftshader_common_debug
LOCAL_MODULE_TAGS := optional
LOCAL_CFLAGS += $(SWIFTSHADER_COMMON_CFLAGS) -UNDEBUG -g -O0

LOCAL_CLANG := true
LOCAL_SRC_FILES := $(SWIFTSHADER_COMMON_SRC_FILES)
LOCAL_C_INCLUDES := $(SWIFTSHADER_COMMON_C_INCLUDES)
LOCAL_SHARED_LIBRARIES += $(SWIFTSHADER_COMMON_SHARED_LIBRARIES)
LOCAL_LDFLAGS += $(SWIFTSHADER_COMMON_LDFLAGS)
LOCAL_BUILT_MODULE_STEM := libswiftshader_common.so
...
LOCAL_MODULE := libswiftshader_common_release
LOCAL_MODULE_TAGS := optional
LOCAL_CFLAGS += $(SWIFTSHADER_COMMON_CFLAGS) -UNDEBUG -fomit-frame-pointer -DANGLE_DISABLE_TRACE
