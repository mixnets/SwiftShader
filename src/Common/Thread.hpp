...
namespace sw
{
	...
	public:
		...
		static LocalStorageKey allocateLocalStorageKey(void (*destructor)(void *obj) = free);
...
namespace sw
{
	...
	inline Thread::LocalStorageKey Thread::allocateLocalStorageKey(void (*destructor)(void *obj))
	{
		#if defined(_WIN32)
			return TlsAlloc();
		#else
