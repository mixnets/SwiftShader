...
#if __has_feature(cxx_atomic) // clang has an explicit check for the availability of atomic
#include <atomic>
#define USE_STD_ATOMIC
#endif
#else // atomic is available in C++11 or newer, and in Visual Studio 2012 or newer
