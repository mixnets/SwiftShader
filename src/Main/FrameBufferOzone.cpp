...
namespace sw
{
	...
	{
		buffer = sw::Surface::create(width, height, 1, sw::FORMAT_A8B8G8R8, nullptr,
		                             sw::Surface::pitchB(width, sw::FORMAT_A8B8G8R8, true),
		                             sw::Surface::sliceB(width, height, sw::FORMAT_A8B8G8R8, true));
	}
