...
namespace sw
{
	...
	public:
		...
		virtual void flip(void *source, Format sourceFormat, size_t sourceStride) override = 0;
		virtual void blit(void *source, const Rect *sourceRect, const Rect *destRect, Format sourceFormat, size_t sourceStride) override = 0;
