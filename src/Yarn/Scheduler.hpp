...
// Scheduler asynchronous processes Tasks.
...
// Scheduler are initially constructed in single-threaded mode. Call
// setWorkerThreadCount() to spawn dedicated worker threads.
class Scheduler
{
public:
    Scheduler();
