...
private:
    ...
    static constexpr size_t MaxWorkerThreads = 128;
    ...
    size_t stealWork(Worker* thief, TaskQueue& out);
    ...
    uint64_t nextEnqueueIndex = 0;
    uint64_t numWorkerThreads = 0;
    Worker* workerThreads[MaxWorkerThreads];
    Worker singleThreadedWorker;
    std::mutex setWorkerThreadMutex;
};
