...
#define SCOPED_EVENT(...) yarn::Trace::ScopedEvent scoped_event_##__LINE__(__VA_ARGS__);
...
#define SCOPED_ASYNC_EVENT(id, ...) yarn::Trace::ScopedAsyncEvent scoped_event_##__LINE__(id, __VA_ARGS__);
