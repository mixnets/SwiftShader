...
TEST_P(WithBoundScheduler, FixedSizePool_ConstructDestruct)
{
...
TEST_P(WithBoundScheduler, FixedSizePool_Borrow)
{
...
TEST_P(WithBoundScheduler, FixedSizePool_ConcurrentBorrow)
{
    yarn::FixedSizePool<int, 10> pool;
    constexpr int iterations = 10000;
    yarn::WaitGroup wg(iterations);
...
TEST_P(WithBoundScheduler, FixedSizePool_PolicyReconstruct)
{
    CtorDtorCounter::reset();
...
TEST_P(WithBoundScheduler, FixedSizePool_PolicyPreserve)
{
    CtorDtorCounter::reset();
    {
