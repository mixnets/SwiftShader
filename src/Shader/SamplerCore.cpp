			...
			case 3:
				{
					...
					{
					//	Byte8 c0; c0 = As<Byte8>(Insert(As<Int2>(c0), *Pointer<Int>(buffer[f0] + 3 * index[0]), 0));
					//	Byte8 c1; c1 = As<Byte8>(Insert(As<Int2>(c1), *Pointer<Int>(buffer[f1] + 3 * index[1]), 0));
					//	Byte8 c2; c2 = As<Byte8>(Insert(As<Int2>(c2), *Pointer<Int>(buffer[f2] + 3 * index[2]), 0));
					//	Byte8 c3; c3 = As<Byte8>(Insert(As<Int2>(c3), *Pointer<Int>(buffer[f3] + 3 * index[3]), 0));
					//	c.x = UnpackLow(c0, c1);
					//	c.y = UnpackLow(c2, c3);
