...
//	}
	...
	{
		cf = is8BitNormalized ?
		     Float4(cs & Short4(0xFF00u)) * Float4(1.0f / 0x7F00u) :
		     Float4(cs) * Float4(1.0f / 0x7FFFu);
	}

	void SamplerCore::convertUnsigned16(Float4 &cf, Short4 &cs, bool is8BitNormalized)
	{
		cf = is8BitNormalized ?
		     Float4(As<UShort4>(cs) & UShort4(0xFF00u)) * Float4(1.0f / 0xFF00u) :
		     Float4(As<UShort4>(cs)) * Float4(1.0f / 0xFFFFu);
	}
