...
namespace sw
{
	...
	private:
		...
		void address(Float4 &uw, Int4& xyz0, Int4& xyz1, Float4& f, Pointer<Byte>& mipmap, Float4 &texOffset, Int4 &filter, int whd, FilterType filterType, AddressingMode addressingMode, SamplerFunction function);
