...
namespace sw
{
	...
	private:
		...
		void computeLodCube(Pointer<Byte> &texture, Float &lod, Float4 &lodU, Float4 &lodV, const Float &lodBias, Vector4f &dsx, Vector4f &dsy, Float4 &M, SamplerFunction function);
		...
		void cubeFace(Int face[4], Float4 &U, Float4 &V, Float4 &lodU, Float4 &lodV, Float4 &x, Float4 &y, Float4 &z, Float4 &M);
