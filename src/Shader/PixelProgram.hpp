...
namespace sw
{
	...
	private:
		...
		void TEXGRAD(Vector4f &dst, Vector4f &src0, const Src &src1, Vector4f &src2, Vector4f &src3);
		...
		void TEXGRADOFFSET(Vector4f &dst, Vector4f &src, const Src &, Vector4f &src2, Vector4f &src3, Vector4f &offset);
