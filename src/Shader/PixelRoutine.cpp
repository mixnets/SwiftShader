		...
		case FORMAT_R5G6B5:
			{
				...
				{
					Int masked = value;
					c01 &= *Pointer<Int>(r.constants + OFFSET(Constants,mask565Q[rgbaWriteMask & 0x7][0]));
					masked &= *Pointer<Int>(r.constants + OFFSET(Constants,invMask565Q[rgbaWriteMask & 0x7][0]));
					c01 |= masked;
				}
				...
				*Pointer<Int>(buffer) = c01;
				...
				{
					Int masked = value;
					c23 &= *Pointer<Int>(r.constants + OFFSET(Constants,mask565Q[rgbaWriteMask & 0x7][0]));
					masked &= *Pointer<Int>(r.constants + OFFSET(Constants,invMask565Q[rgbaWriteMask & 0x7][0]));
					c23 |= masked;
				}
