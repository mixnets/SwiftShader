...
namespace sw
{
	...
	{
		dst = sampleTexture(src1, src0, a0.x, a0, a0, src0, Lod);
	}
	...
	{
		dst = sampleTexture(src1, src0, a0.x, a0, a0, src2, {Lod, Offset});
	}
	...
	{
		dst = sampleTexture(src1, src0, a0.x, a0, a0, offset, {Lod, Offset});
	}
