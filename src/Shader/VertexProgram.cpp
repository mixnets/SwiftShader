...
namespace sw
{
	...
	Vector4f VertexProgram::fetchRegister(const Src &src, unsigned int offset)
	{
		...
		case Shader::PARAMETER_FLOAT4LITERAL:
			// This is used for all literals, and since Reactor doesn't guarantee
			// preserving the bit pattern of float constants, we must construct
			// them as integer constants and bitcast.
