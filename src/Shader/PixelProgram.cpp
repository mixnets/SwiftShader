...
namespace sw
{
	...
	void PixelProgram::TEXOFFSET(Vector4f &dst, Vector4f &src0, const Src &src1, Vector4f &src2)
	{
		dst = sampleTexture(src1, src0, src0.x, src0, src0, src2, {Implicit, Offset});
	}
	...
	void PixelProgram::TEXOFFSETBIAS(Vector4f &dst, Vector4f &src0, const Src &src1, Vector4f &src2, Float4 &bias)
	{
		dst = sampleTexture(src1, src0, bias, src0, src0, src2, {Bias, Offset});
	}
	...
	void PixelProgram::TEXGRADOFFSET(Vector4f &dst, Vector4f &src0, const Src& src1, Vector4f &src2, Vector4f &src3, Vector4f &offset)
	{
