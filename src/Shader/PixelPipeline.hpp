...
namespace sw
{
	...
	protected:
		...
		virtual void ps(PixelRoutine::Registers &r, Int cMask[4]);
		...
		virtual Registers* createRegisters(const PixelShader *shader) { return new Registers(shader); };
