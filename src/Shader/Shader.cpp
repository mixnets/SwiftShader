...
namespace sw
{
	...
	std::string Shader::Instruction::operationString(unsigned short version) const
	{
		...
		case OPCODE_LSI:			return "lsi";
		case OPCODE_LSU:			return "lsu";
		case OPCODE_RSI:			return "rsi";
		case OPCODE_RSU:			return "rsu";
		...
		case OPCODE_MINI:			return "mini";
		case OPCODE_MINU:			return "minu";
		case OPCODE_MAX:			return "max";
		case OPCODE_MAXI:			return "maxi";
		case OPCODE_MAXU:			return "maxu";
