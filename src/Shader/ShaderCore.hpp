...
{
public:
	Register(const Reference<Float4> &x, const Reference<Float4> &y, const Reference<Float4> &z, const Reference<Float4> &w)
	    : x(x)
	    , y(y)
	    , z(z)
	    , w(w)
...
{
public:
	RegisterFile(int size, bool indirectAddressable)
	    : size(size)
	    , indirectAddressable(indirectAddressable)
	{
...
{
public:
	RegisterArray(bool indirectAddressable = I)
	    : RegisterFile(S, indirectAddressable)
	{
	}
};
