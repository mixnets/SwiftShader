...
namespace sw
{
	...
	public:
		...
		void madi(Vector4f &dst, const Vector4f &src0, const Vector4f &src1, const Vector4f &src2);
		void madu(Vector4f &dst, const Vector4f &src0, const Vector4f &src1, const Vector4f &src2);
		...
		void divi(Vector4f &dst, const Vector4f &src0, const Vector4f &src1);
		void divu(Vector4f &dst, const Vector4f &src0, const Vector4f &src1);
		void mod(Vector4f &dst, const Vector4f &src0, const Vector4f &src1);
		void modi(Vector4f &dst, const Vector4f &src0, const Vector4f &src1);
		void modu(Vector4f &dst, const Vector4f &src0, const Vector4f &src1);
		void lsi(Vector4f &dst, const Vector4f &src0, const Vector4f &src1);
		void lsu(Vector4f &dst, const Vector4f &src0, const Vector4f &src1);
		void rsi(Vector4f &dst, const Vector4f &src0, const Vector4f &src1);
		void rsu(Vector4f &dst, const Vector4f &src0, const Vector4f &src1);
