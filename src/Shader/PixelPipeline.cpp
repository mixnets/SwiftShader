...
namespace sw
{
	...
	Vector4s PixelPipeline::fetchRegister(const Src &src)
	{
		...
		{
			mod.x = Min(mod.x, Short4(0x1000)); mod.x = Max(mod.x, Short4(0xF000));
			mod.y = Min(mod.y, Short4(0x1000)); mod.y = Max(mod.y, Short4(0xF000));
			mod.z = Min(mod.z, Short4(0x1000)); mod.z = Max(mod.z, Short4(0xF000));
			mod.w = Min(mod.w, Short4(0x1000)); mod.w = Max(mod.w, Short4(0xF000));
		}
