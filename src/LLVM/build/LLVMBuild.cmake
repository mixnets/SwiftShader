...
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/CodeGen/SelectionDAG/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/CodeGen/MIRParser/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/DebugInfo/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/DebugInfo/DWARF/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/DebugInfo/PDB/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
...
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/ExecutionEngine/OProfileJIT/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/ExecutionEngine/Orc/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/LibDriver/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/LineEditor/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
...
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Option/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Passes/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/ProfileData/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
...
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/AMDGPU/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/AMDGPU/AsmParser/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/AMDGPU/InstPrinter/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/AMDGPU/MCTargetDesc/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/AMDGPU/TargetInfo/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/AMDGPU/Utils/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
...
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/AArch64/Utils/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/BPF/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/BPF/InstPrinter/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/BPF/MCTargetDesc/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/BPF/TargetInfo/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
...
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/Hexagon/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/Hexagon/Disassembler/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
...
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/PowerPC/AsmParser/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/PowerPC/Disassembler/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
...
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/Sparc/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/Sparc/AsmParser/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/Sparc/Disassembler/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/Sparc/InstPrinter/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
...
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/SystemZ/TargetInfo/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/WebAssembly/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/WebAssembly/InstPrinter/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/WebAssembly/MCTargetDesc/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/lib/Target/WebAssembly/TargetInfo/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
...
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/tools/bugpoint/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/tools/dsymutil/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
...
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/tools/llvm-objdump/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/tools/llvm-pdbdump/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/tools/llvm-profdata/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
...
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/tools/opt/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
configure_file("C:/Users/nicolascapens/Development/SwiftShader/src/LLVM/tools/verify-uselistorder/LLVMBuild.txt"
               ${CMAKE_CURRENT_BINARY_DIR}/DummyConfigureOutput)
