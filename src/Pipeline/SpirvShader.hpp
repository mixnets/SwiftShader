...
private:
	...
	void ApplyDecorationsForAccessChain(Decorations *d, DescriptorDecorations *dd, Object::ID baseId, const Span &span) const;
	...
	SIMD::Pointer WalkExplicitLayoutAccessChain(Object::ID id, const Span &span, const EmitState *state) const;
	SIMD::Pointer WalkAccessChain(Object::ID id, const Span &span, const EmitState *state) const;

	// Returns the *component* offset in the literal for the given access chain.
	uint32_t WalkLiteralAccessChain(Type::ID id, const Span &span) const;
