...
namespace sw
{
	...
	public:
		...
		// Compact representation of image instruction parameters that
		// is passed to the trampoline function for retrieving/generating
		// the corresponding sampling routine.
