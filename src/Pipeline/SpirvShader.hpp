...
namespace sw
{
	...
	private:
		...
		// ---------------------------------------------------------------------
		//
		// Address = PtrBase + sizeof(Word) * (SIMD::Width * Offset + LaneIndex)
		//
		// Assuming SIMD::Width == 4:
		//
		//                 Lane[0]   |   Lane[1]   |   Lane[2]   |   Lane[3]
		//              =============+=============+=============+============
		//  Offset: 0  |   Word[0]   |   Word[1]   |   Word[2]   |   Word[3]
		// ------------+-------------+-------------+-------------+------------
		//  Offset: 1  |   Word[4]   |   Word[5]   |   Word[6]   |   Word[7]
		// ------------+-------------+-------------+-------------+------------
		//  Offset: 2  |   Word[8]   |   Word[9]   |   Word[a]   |   Word[b]
		// ------------+-------------+-------------+-------------+------------
		//  Offset: 3  |   Word[c]   |   Word[d]   |   Word[e]   |   Word[f]
		//
		//
		// Linear storage - (IsStorageInterleavedByLane() == false):
		// ---------------------------------------------------------
		//
		// Address = PtrBase + sizeof(Word) * Offset
		//
		//                 Lane[0]   |   Lane[1]   |   Lane[2]   |   Lane[3]
		//              =============+=============+=============+============
		//  Offset: 0  |   Word[0]   |   Word[0]   |   Word[0]   |   Word[0]
		// ------------+-------------+-------------+-------------+------------
		//  Offset: 1  |   Word[1]   |   Word[1]   |   Word[1]   |   Word[1]
		// ------------+-------------+-------------+-------------+------------
		//  Offset: 2  |   Word[2]   |   Word[2]   |   Word[2]   |   Word[2]
		// ------------+-------------+-------------+-------------+------------
		//  Offset: 3  |   Word[3]   |   Word[3]   |   Word[3]   |   Word[3]
		//
