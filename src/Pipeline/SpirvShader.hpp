...
private:
	...
	static void EmitImageWrite2(ImageInstructionSignature instruction, Pointer<Byte> descriptor, const Pointer<SIMD::Int> &in, const Pointer<SIMD::Int> &out, vk::Format imageFormat);
