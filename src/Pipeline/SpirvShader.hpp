...
private:
	...
	static ImageSampler *getImageSampler(const vk::Device *device, uint32_t instruction, vk::SampledImageDescriptor const *imageDescriptor, const vk::Sampler *sampler);
