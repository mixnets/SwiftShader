...
private:
	...
	SIMD::Pointer WalkExplicitLayoutAccessChain(Object::ID id, const Span &indexIds, const EmitState *state, const Decorations dResult) const;
	SIMD::Pointer WalkAccessChain(Object::ID id, const Span &indexIds, const EmitState *state, const Decorations dResult) const;
