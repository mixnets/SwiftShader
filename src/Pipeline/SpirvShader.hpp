...
private:
	...
	SIMD::Int SDotAccSat(unsigned numComponents, Operand const &x, Operand const &y, Operand const &accum) const;
	SIMD::UInt UDotAccSat(unsigned numComponents, Operand const &x, Operand const &y, Operand const &accum) const;
	SIMD::Int SUDotAccSat(unsigned numComponents, Operand const &x, Operand const &y, Operand const &accum) const;
