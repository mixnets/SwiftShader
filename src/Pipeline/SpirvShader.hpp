...
namespace sw
{
	...
	namespace SIMD
	{
		...
		struct Pointer
		{
			...
			inline bool hasSequentialOffsets() const
			{
				if (hasDynamicOffsets)
				{
					return false; // TODO: Evaluate this at execution time?
				}
			...
			inline bool hasEqualOffsets() const
			{
				if (hasDynamicOffsets)
				{
					return false; // TODO: Evaluate this at execution time?
			...
			inline bool hasNoOffsets() const
			{
				if (hasDynamicOffsets)
				{
					return false; // TODO: Evaluate this at execution time?
				...
				{
					if (staticOffsets[i] != 0) { return false; }
				}
				return true;
			}
