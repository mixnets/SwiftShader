...
public:
	...
	{
	public:
		SampledImage(SIMD::Pointer image, Object::ID sampler) : SIMD::Pointer(image), samplerId(sampler) {}
		Object::ID samplerId;
	};
...
private:
	...
	public:
		...
		const SampledImage &GetSampledImage(uint32_t i) const
		{
			ASSERT(intermediate == nullptr);
	...
	Pointer<Byte> lookupSamplerFunction(Pointer<Byte> imageDescriptor, const ImageInstruction &instruction, int laneIdx, EmitState *state) const;
