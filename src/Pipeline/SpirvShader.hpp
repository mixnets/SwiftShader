...
private:
	...
	static SIMD::Float Dot(unsigned numComponents, Operand const &x, Operand const &y);
	...
	static RValue<SIMD::Int> SpirvShader::AddSat(RValue<SIMD::Int> a, RValue<SIMD::Int> b);
	static RValue<SIMD::UInt> SpirvShader::AddSat(RValue<SIMD::UInt> a, RValue<SIMD::UInt> b);
