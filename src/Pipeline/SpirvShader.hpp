...
namespace sw
{
	...
	private:
		...
		// Returns true if data in the given storage class is replicated into
		// each lane of the SIMD vectors.
		//
		...
		//
		static bool IsStorageLaneReplicated(spv::StorageClass storageClass);
