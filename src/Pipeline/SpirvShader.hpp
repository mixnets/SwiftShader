...
public:
	...
	InputData inputsData[MAX_INTERFACE_COMPONENTS];
	...
	static SIMD::Float interpolateAtXY(const SIMD::Float &x, const SIMD::Float &y, const SIMD::Float &rhw, Pointer<Byte> planeEquation, const InputData &inputData);
