...
private:
	...
	public:
		...
		EmitResult EmitCompositeConstruct(InsnIterator insn);  ///////////////////////const
		...
		TexelAddressData setupTexelAddressData(SIMD::Int rowPitch, SIMD::Int slicePitch, SIMD::Int samplePitch, ImageInstructionSignature instruction, SIMD::Int coordinate[], SIMD::Int sample, vk::Format imageFormat) const;
		SIMD::Pointer GetNonUniformTexelAddress(ImageInstructionSignature instruction, SIMD::Pointer descriptor, SIMD::Int coordinate[], SIMD::Int sample, vk::Format imageFormat, OutOfBoundsBehavior outOfBoundsBehavior) const;
		SIMD::Pointer GetTexelAddress(ImageInstructionSignature instruction, Pointer<Byte> descriptor, SIMD::Int coordinate[], SIMD::Int sample, vk::Format imageFormat, OutOfBoundsBehavior outOfBoundsBehavior) const;
		...
		void EmitInstructions(InsnIterator begin, InsnIterator end) const;
		EmitResult EmitInstruction(InsnIterator insn) const;
		...
		// filter.
		void StorePhi(Block::ID blockID, InsnIterator insn, std::unordered_set<SpirvShader::Block::ID> const &filter) const;
