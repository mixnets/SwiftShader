...
private:
	...
	SIMD::Pointer GetPointerToData(Object::ID id, Int4 arrayIndex, EmitState const *state, bool nonUniform) const;
	...
	SIMD::Pointer WalkAccessChain(Object::ID id, const Span &indexIds, const EmitState *state, bool nonUniform) const;
