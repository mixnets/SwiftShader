...
namespace sw
{
    ...
    public:
        ...
        public:
            ...
            uint32_t offset() const { return iter - zero; }
            ...
            InsnIterator const * operator* () const { return this; }
            InsnIterator& operator++ () { iter += wordCount(); return *this; }
            InsnIterator operator++ (int) { InsnIterator ret{*this}; iter += wordCount(); return ret; }
            InsnIterator(InsnIterator const & other) : iter{other.iter}, zero{other.zero} {}
        ...
        SpirvShader(InsnStore const & insns);
