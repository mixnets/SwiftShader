...
private:
	...
	SIMD::Int SDot(unsigned numComponents, Operand const &x, Operand const &y, Operand const *accum) const;
	SIMD::UInt UDot(unsigned numComponents, Operand const &x, Operand const &y, Operand const *accum) const;
	SIMD::Int SUDot(unsigned numComponents, Operand const &x, Operand const &y, Operand const *accum) const;
