...
private:
	...
	void OffsetToElem(SIMD::Pointer &ptr, Object::ID elemId, int32_t arrayStride, EmitState const *state) const;

	OutOfBoundsBehavior getOutOfBoundsBehavior(Object::ID pointerId, EmitState const *state) const;

	SIMD::Pointer WalkExplicitLayoutAccessChain(Object::ID id, Object::ID elemId, const Span &indexIds, const EmitState *state) const;
	SIMD::Pointer WalkAccessChain(Object::ID id, Object::ID elemId, const Span &indexIds, const EmitState *state) const;
