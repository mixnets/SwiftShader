...
static SIMD::Pointer GetTexelAddress(SpirvShader::ImageInstruction instruction, const Sampler &samplerState, Pointer<Byte> descriptor, SIMD::Float coordinate[4], const SIMD::Int sampleIdx, int texelSize, bool useStencilAspect, OutOfBoundsBehavior outOfBoundsBehavior)
{
