...
SpirvShader::ImageSampler *SpirvShader::emitSamplerFunction(ImageInstruction instruction, const Sampler::State &samplerState)
{
	...
	Function<Void(Pointer<Byte> image, Pointer<Byte> sampler, Pointer<SIMD::Float>, Pointer<SIMD::Float>, Pointer<Byte>)> function;
	{
	...
	return reinterpret_cast<ImageSampler*>(function("sampler")->getEntry());
}
