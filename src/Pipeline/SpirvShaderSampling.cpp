...
{
	if((samplingParameters != UNINITIALIZED_PARAMETERS) && (samplingParameters != NON_UNIQUE_PARAMETERS) &&
	   (sampledImageDescriptor && (sampledImageDescriptor->imageViewId != 0) && (sampledImageDescriptor->sampler.id != 0)))
	{
