...
void SamplerCore::sampleLumaTexel(Vector4f& output, Short4 &uuuu, Short4 &vvvv, Short4 &wwww, const Short4 &layerIndex, const Int4 &sample, Pointer<Byte> &lumaMipmap, Pointer<Byte> lumaBuffer) {
	...
	Float4 debugUnnormalizedU = (Float4(uuuu) / Float4(1 << 16)) * Float4(*Pointer<UInt4>(lumaMipmap + OFFSET(Mipmap, width)));
	Float4 debugUnnormalizedV = (Float4(vvvv) / Float4(1 << 16)) * Float4(*Pointer<UInt4>(lumaMipmap + OFFSET(Mipmap, height)));
...
void SamplerCore::sampleChromaTexel(Vector4f& output, Short4 &uuuu, Short4 &vvvv, Short4 &wwww, const Short4 &layerIndex, const Int4 &sample, Pointer<Byte> &mipmapU, Pointer<Byte> bufferU, Pointer<Byte> &mipmapV, Pointer<Byte> bufferV) {
	...
	Float4 debugUnnormalizedU = (Float4(uuuu) / Float4(1 << 16)) * Float4(*Pointer<UInt4>(mipmapU + OFFSET(Mipmap, width)));
	Float4 debugUnnormalizedV = (Float4(vvvv) / Float4(1 << 16)) * Float4(*Pointer<UInt4>(mipmapV + OFFSET(Mipmap, height)));
