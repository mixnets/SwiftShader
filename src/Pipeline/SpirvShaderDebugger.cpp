...
#define PRINT_EACH_PROCESSED_INSTRUCTION 1
...
struct ArrayType : ObjectImpl<ArrayType, Type, Object::Kind::ArrayType>
{
	...
	template<typename GROUP, typename ENTER, typename ELEMENT>
	void build(const GROUP &group, ENTER &&enter, ELEMENT &&element) const
	{
