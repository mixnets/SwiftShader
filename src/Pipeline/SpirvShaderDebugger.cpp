...
private:
	...
	// defineOrEmit() calls function F with a newly created, default-initialized
	// object when called in Pass::Define, or calls the function F with the
	// previously-built object when called in Pass::Emit.
	// The created object is stored into the Debugger::objects map using the
