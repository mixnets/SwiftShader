...
{
	Variant variant = GetVariant(insn);
	SamplerMethod samplerMethod = GetSamplerMethod(insn, variant);

	ImageInstructionWithIds instruction;
	instruction.imageInstruction.variant = variant;
	instruction.imageInstruction.samplerMethod = samplerMethod;
