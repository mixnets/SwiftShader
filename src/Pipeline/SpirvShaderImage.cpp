...
SpirvShader::EmitResult SpirvShader::EmitImageWrite(InsnIterator insn, EmitState *state) const
{
	...
	case spv::ImageFormatRgba8ui:
		texelSize = 4;
		packed[0] = (SIMD::UInt(Min(texel.UInt(0), SIMD::UInt(0xff)) & SIMD::UInt(0xff))) |
		            (SIMD::UInt(Min(texel.UInt(1), SIMD::UInt(0xff)) & SIMD::UInt(0xff)) << 8) |
		            (SIMD::UInt(Min(texel.UInt(2), SIMD::UInt(0xff)) & SIMD::UInt(0xff)) << 16) |
		            (SIMD::UInt(Min(texel.UInt(3), SIMD::UInt(0xff)) & SIMD::UInt(0xff)) << 24);
		break;
	...
	case spv::ImageFormatRgba16ui:
		texelSize = 8;
		packed[0] = SIMD::UInt(Min(texel.UInt(0), SIMD::UInt(0xFFFF)) & SIMD::UInt(0xFFFF)) | (SIMD::UInt(Min(texel.UInt(1), SIMD::UInt(0xFFFF)) & SIMD::UInt(0xFFFF)) << 16);
		packed[1] = SIMD::UInt(Min(texel.UInt(2), SIMD::UInt(0xFFFF)) & SIMD::UInt(0xFFFF)) | (SIMD::UInt(Min(texel.UInt(3), SIMD::UInt(0xFFFF)) & SIMD::UInt(0xFFFF)) << 16);
		break;
	...
	case spv::ImageFormatRg8ui:
		texelSize = 2;
		packed[0] = SIMD::UInt(Min(texel.UInt(0), SIMD::UInt(0xFF)) & SIMD::UInt(0xFF)) | (SIMD::UInt(Min(texel.UInt(1), SIMD::UInt(0xFF)) & SIMD::UInt(0xFF)) << 8);
		break;
	...
	case spv::ImageFormatR16ui:
		texelSize = 2;
		packed[0] = SIMD::UInt(Min(texel.UInt(0), SIMD::UInt(0xFFFF)) & SIMD::UInt(0xFFFF));
		break;
	...
	case spv::ImageFormatRgb10a2ui:
		texelSize = 4;
		packed[0] = (SIMD::UInt(Min(texel.UInt(0), SIMD::UInt(0x3FF)) & SIMD::UInt(0x3FF))) |
		            (SIMD::UInt(Min(texel.UInt(1), SIMD::UInt(0x3FF)) & SIMD::UInt(0x3FF)) << 10) |
		            (SIMD::UInt(Min(texel.UInt(2), SIMD::UInt(0x3FF)) & SIMD::UInt(0x3FF)) << 20) |
		            (SIMD::UInt(Min(texel.UInt(3), SIMD::UInt(0x3)) & SIMD::UInt(0x3)) << 30);
		break;
	default:
