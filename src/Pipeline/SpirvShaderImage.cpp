...
SpirvShader::EmitResult SpirvShader::EmitImageRead(InsnIterator insn_, EmitState *state) const
{
	ImageInstruction instruction(insn_, *this);
...
SpirvShader::EmitResult SpirvShader::EmitImageWrite(InsnIterator insn_, EmitState *state) const
{
