...
SpirvShader::EmitResult SpirvShader::EmitImageSample(InsnIterator insn, EmitState *state) const
{
	...
	ImageInstruction2 instruction(insn, *this);
...
Pointer<Byte> SpirvShader::lookupSamplerFunction(Pointer<Byte> imageDescriptor, const ImageInstruction2 &instruction, EmitState *state) const
{
	...
	auto &cache = state->routine->samplerCache[instruction.resultId];
...
void SpirvShader::EmitImageSampleUnconditional(Array<SIMD::Float> &out, const ImageInstruction2 &instruction, EmitState *state) const
{
...
void SpirvShader::callSamplerFunction(Pointer<Byte> samplerFunction, Array<SIMD::Float> &out, Pointer<Byte> imageDescriptor, const ImageInstruction2 &instruction, EmitState *state) const
{
