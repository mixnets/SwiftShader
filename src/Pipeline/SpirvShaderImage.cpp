...
SpirvShader::EmitResult SpirvShader::EmitImageQuerySizeLod(InsnIterator insn) const
{
...
SpirvShader::EmitResult SpirvShader::EmitImageQuerySize(InsnIterator insn) const
{
	auto &resultTy = getType(insn.resultTypeId());
	auto imageId = Object::ID(insn.word(3));
...
SpirvShader::EmitResult SpirvShader::EmitImageQueryLevels(InsnIterator insn) const
{
	auto &resultTy = getType(insn.resultTypeId());
...
SpirvShader::EmitResult SpirvShader::EmitImageQuerySamples(InsnIterator insn) const
{
	auto &resultTy = getType(insn.resultTypeId());
	ASSERT(resultTy.componentCount == 1);
	auto imageId = Object::ID(insn.word(3));
...
SpirvShader::EmitResult SpirvShader::EmitImageRead(const ImageInstruction &instruction) const
{
...
SpirvShader::EmitResult SpirvShader::EmitImageWrite(const ImageInstruction &instruction) const
{
...
SpirvShader::EmitResult SpirvShader::EmitImageTexelPointer(const ImageInstruction &instruction) const
{
	auto coordinate = Operand(shader, *this, instruction.coordinateId);
...
SpirvShader::EmitResult SpirvShader::EmitSampledImage(InsnIterator insn) const
{
...
SpirvShader::EmitResult SpirvShader::EmitImage(InsnIterator insn) const
{
	Object::ID resultId = insn.word(2);
	Object::ID imageId = insn.word(3);
