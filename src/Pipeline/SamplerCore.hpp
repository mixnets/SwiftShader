...
namespace sw
{
	...
	private:
		...
		Vector4s sampleTexel(Short4 &u, Short4 &v, Short4 &s, Vector4f &offset, Pointer<Byte> &mipmap, Pointer<Byte> buffer[4], const Short4 &border, SamplerFunction function);
		Vector4s sampleTexel(UInt index[4], Pointer<Byte> buffer[4], const Short4 &border);
		Vector4f sampleTexel(Int4 &u, Int4 &v, Int4 &s, Float4 &z, Pointer<Byte> &mipmap, Pointer<Byte> buffer[4], const Int4 &border, SamplerFunction function);
		Vector4s replaceBorderTexel(const Vector4s &c, Short4 borderMask);
		Vector4f replaceBorderTexel(const Vector4f &c, Int4 borderMask);
		void selectMipmap(Pointer<Byte> &texture, Pointer<Byte> buffer[4], Pointer<Byte> &mipmap, Float &lod, Int face[4], bool secondLOD);
		Short4 address(Float4 &uw, Short4 &border, AddressingMode addressingMode, Pointer<Byte>& mipmap);
		void address(Float4 &uw, Int4& xyz0, Int4& xyz1, Float4& f, Pointer<Byte>& mipmap, Float4 &texOffset, Int4 &filter, Int4 &border, int whd, AddressingMode addressingMode, SamplerFunction function);
