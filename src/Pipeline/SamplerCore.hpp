...
{
	Implicit,  // Compute LOD from implicit gradients (pixel shader only).
	Bias,      // Compute LOD from implicit gradients and add provided bias.
	Lod,       // Use provided LOD.
	Grad,      // Compute LOD from provided gradients.
...
public:
	...
	Vector4f sampleTexture(Pointer<Byte> &texture, Float4 uvwa[4], Float4 &q, Float &&lodOrBias, Float4 &dsx, Float4 &dsy, Vector4i &offset, Int4 &sampleId, SamplerFunction function);

private:
	Short4 offsetSample(Short4 &uvw, Pointer<Byte> &mipmap, int halfOffset, bool wrap, int count, Float &lod);
	Vector4s sampleFilter(Pointer<Byte> &texture, Float4 &u, Float4 &v, Float4 &w, const Float4 &arrayCoord, Vector4i &offset, const Int4 &sampleId, Float &lod, Float &anisotropy, Float4 &uDelta, Float4 &vDelta, SamplerFunction function);
	Vector4s sampleAniso(Pointer<Byte> &texture, Float4 &u, Float4 &v, Float4 &w, const Float4 &arrayCoord, Vector4i &offset, const Int4 &sampleId, Float &lod, Float &anisotropy, Float4 &uDelta, Float4 &vDelta, bool secondLOD, SamplerFunction function);
	Vector4s sampleQuad(Pointer<Byte> &texture, Float4 &u, Float4 &v, Float4 &w, const Float4 &arrayCoord, Vector4i &offset, const Int4 &sampleId, Float &lod, bool secondLOD, SamplerFunction function);
	Vector4s sampleQuad2D(Pointer<Byte> &texture, Float4 &u, Float4 &v, Float4 &w, const Float4 &arrayCoord, Vector4i &offset, const Int4 &sampleId, Float &lod, bool secondLOD, SamplerFunction function);
	Vector4s sample3D(Pointer<Byte> &texture, Float4 &u, Float4 &v, Float4 &w, Vector4i &offset, const Int4 &sampleId, Float &lod, bool secondLOD, SamplerFunction function);
	Vector4f sampleFloatFilter(Pointer<Byte> &texture, Float4 &u, Float4 &v, Float4 &w, const Float4 &arrayCoord, Float4 &dRef, Vector4i &offset, const Int4 &sampleId, Float &lod, Float &anisotropy, Float4 &uDelta, Float4 &vDelta, SamplerFunction function);
	Vector4f sampleFloatAniso(Pointer<Byte> &texture, Float4 &u, Float4 &v, Float4 &w, const Float4 &arrayCoord, Float4 &dRef, Vector4i &offset, const Int4 &sampleId, Float &lod, Float &anisotropy, Float4 &uDelta, Float4 &vDelta, bool secondLOD, SamplerFunction function);
	Vector4f sampleFloat(Pointer<Byte> &texture, Float4 &u, Float4 &v, Float4 &w, const Float4 &arrayCoord, Float4 &dRef, Vector4i &offset, const Int4 &sampleId, Float &lod, bool secondLOD, SamplerFunction function);
	Vector4f sampleFloat2D(Pointer<Byte> &texture, Float4 &u, Float4 &v, Float4 &w, const Float4 &arrayCoord, Float4 &dRef, Vector4i &offset, const Int4 &sampleId, Float &lod, bool secondLOD, SamplerFunction function);
	Vector4f sampleFloat3D(Pointer<Byte> &texture, Float4 &u, Float4 &v, Float4 &w, Vector4i &offset, const Int4 &sampleId, Float &lod, bool secondLOD, SamplerFunction function);
	...
	void computeIndices(UInt index[4], Short4 uuuu, Short4 vvvv, Short4 wwww, Vector4i &offset, const Pointer<Byte> &mipmap, const Short4 &cubeArrayId, const Int4 &sampleId, SamplerFunction function);
	...
	Vector4s sampleTexel(Short4 &u, Short4 &v, Short4 &s, Vector4i &offset, Pointer<Byte> &mipmap, const Short4 &cubeArrayId, const Int4 &sampleId, Pointer<Byte> buffer, SamplerFunction function);
