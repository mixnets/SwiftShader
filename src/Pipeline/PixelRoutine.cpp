	...
	default:
		{
			...
			pixel.x = convertFloat32(As<UShort4>(color.x));
			pixel.y = convertFloat32(As<UShort4>(color.y));
			pixel.z = convertFloat32(As<UShort4>(color.z));
			pixel.w = convertFloat32(As<UShort4>(color.w));
		}
		break;
	}
