	...
	case VK_FORMAT_B4G4R4A4_UNORM_PACK16:
		{
			...
			Int channelMask = *Pointer<Int>(constants + OFFSET(Constants, maskH4Q[bgraWriteMask & 0xF][0]));
	...
	case VK_FORMAT_B5G5R5A1_UNORM_PACK16:
		{
			...
			Int channelMask = *Pointer<Int>(constants + OFFSET(Constants, mask1555Q[bgraWriteMask & 0xF][0]));
