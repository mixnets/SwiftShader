	...
	case VK_FORMAT_R5G5B5A1_UNORM_PACK16:
		{
			...
			Short4 current = (UShort4(As<Int4>(color.x)) & UShort4(0xF8)) << 11 |
			                 (UShort4(As<Int4>(color.y)) & UShort4(0xF8)) << 6 |
			                 (UShort4(As<Int4>(color.z)) & UShort4(0xF8)) << 1 |
	...
	case VK_FORMAT_B5G5R5A1_UNORM_PACK16:
		{
			...
			Short4 current = (UShort4(As<Int4>(color.z)) & UShort4(0xF8)) << 11 |
			                 (UShort4(As<Int4>(color.y)) & UShort4(0xF8)) << 6 |
			                 (UShort4(As<Int4>(color.x)) & UShort4(0xF8)) << 1 |
			                 (UShort4(As<Int4>(color.w)) & UShort4(0x1));
	...
	case VK_FORMAT_A1R5G5B5_UNORM_PACK16:
		{
			...
			Short4 current = (UShort4(As<Int4>(color.w)) & UShort4(0x1)) >> 15 |
			                 (UShort4(As<Int4>(color.x)) & UShort4(0xF8)) >> 10 |
			                 (UShort4(As<Int4>(color.y)) & UShort4(0xF8)) >> 5 |
			                 (UShort4(As<Int4>(color.z)) & UShort4(0xF8));
	...
	case VK_FORMAT_R5G6B5_UNORM_PACK16:
		{
			...
			Short4 current = (UShort4(As<Int4>(color.x)) & UShort4(0xF8)) >> 11 |
			                 (UShort4(As<Int4>(color.y)) & UShort4(0xFC)) >> 5 |
			                 (UShort4(As<Int4>(color.z)) & UShort4(0xF8));
	...
	case VK_FORMAT_B5G6R5_UNORM_PACK16:
		{
			...
			Short4 current = (UShort4(As<Int4>(color.z)) & UShort4(0xF8)) >> 11 |
			                 (UShort4(As<Int4>(color.y)) & UShort4(0xFC)) >> 5 |
			                 (UShort4(As<Int4>(color.x)) & UShort4(0xF8));
