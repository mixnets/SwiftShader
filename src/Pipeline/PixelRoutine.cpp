	...
	case VK_FORMAT_A4R4G4B4_UNORM_PACK16:
		{
			...
			Int channelMask;
			Short4 current; // FIXME
			switch(state.colorFormat[index])
			{
			case VK_FORMAT_R4G4B4A4_UNORM_PACK16:
				channelMask = *Pointer<Int>(constants + OFFSET(Constants, mask4rgbaQ[bgraWriteMask & 0xF][0]));
				current = (UShort4(color.x * 0xF + 0.5f, true) & UShort4(0xF)) << 12 |
				          (UShort4(color.y * 0xF + 0.5f, true) & UShort4(0xF)) << 8 |
				          (UShort4(color.z * 0xF + 0.5f, true) & UShort4(0xF)) << 4 |
				          (UShort4(color.w * 0xF + 0.5f, true) & UShort4(0xF));
				break;
			case VK_FORMAT_B4G4R4A4_UNORM_PACK16:
				channelMask = *Pointer<Int>(constants + OFFSET(Constants, mask4bgraQ[bgraWriteMask & 0xF][0]));
				current = (UShort4(color.z * 0xF + 0.5f, true) & UShort4(0xF)) << 12 |
				          (UShort4(color.y * 0xF + 0.5f, true) & UShort4(0xF)) << 8 |
				          (UShort4(color.x * 0xF + 0.5f, true) & UShort4(0xF)) << 4 |
				          (UShort4(color.w * 0xF + 0.5f, true) & UShort4(0xF));
				break;
			case VK_FORMAT_A4R4G4B4_UNORM_PACK16:
				channelMask = *Pointer<Int>(constants + OFFSET(Constants, mask4argbQ[bgraWriteMask & 0xF][0]));
				current = (UShort4(color.w * 0xF + 0.5f, true) & UShort4(0xF)) << 12 |
				          (UShort4(color.x * 0xF + 0.5f, true) & UShort4(0xF)) << 8 |
				          (UShort4(color.y * 0xF + 0.5f, true) & UShort4(0xF)) << 4 |
				          (UShort4(color.z * 0xF + 0.5f, true) & UShort4(0xF));
				break;
			case VK_FORMAT_A4B4G4R4_UNORM_PACK16:
				channelMask = *Pointer<Int>(constants + OFFSET(Constants, mask4abgrQ[bgraWriteMask & 0xF][0]));
				current = (UShort4(color.w * 0xF + 0.5f, true) & UShort4(0xF)) << 12 |
				          (UShort4(color.z * 0xF + 0.5f, true) & UShort4(0xF)) << 8 |
				          (UShort4(color.y * 0xF + 0.5f, true) & UShort4(0xF)) << 4 |
				          (UShort4(color.x * 0xF + 0.5f, true) & UShort4(0xF));
				break;
			default:
	...
	case VK_FORMAT_R5G5B5A1_UNORM_PACK16:
		{
			...
			Short4 current = (UShort4(color.x * 0xF8 + 0.5f, true) & UShort4(0xF8)) << 11 |
			                 (UShort4(color.y * 0xF8 + 0.5f, true) & UShort4(0xF8)) << 6 |
			                 (UShort4(color.z * 0xF8 + 0.5f, true) & UShort4(0xF8)) << 1 |
			                 (UShort4(color.w + 0.5f, true) & UShort4(0x1));
	...
	case VK_FORMAT_B5G5R5A1_UNORM_PACK16:
		{
			...
			Short4 current = (UShort4(color.z * 0xF8 + 0.5f, true) & UShort4(0xF8)) << 11 |
			                 (UShort4(color.y * 0xF8 + 0.5f, true) & UShort4(0xF8)) << 6 |
			                 (UShort4(color.x * 0xF8 + 0.5f, true) & UShort4(0xF8)) << 1 |
			                 (UShort4(color.w + 0.5f, true) & UShort4(0x1));
	...
	case VK_FORMAT_A1R5G5B5_UNORM_PACK16:
		{
			...
			Int channelMask = *Pointer<Int>(constants + OFFSET(Constants, mask5551Q[bgraWriteMask & 0xF][0]));
			Short4 current = (UShort4(color.w + 0.5f, true) & UShort4(0x1)) >> 15 |
			                 (UShort4(color.x * 0xF8 + 0.5f, true) & UShort4(0xF8)) >> 10 |
			                 (UShort4(color.y * 0xF8 + 0.5f, true) & UShort4(0xF8)) >> 5 |
			                 (UShort4(color.z * 0xF8 + 0.5f, true) & UShort4(0xF8));
	...
	case VK_FORMAT_R5G6B5_UNORM_PACK16:
		{
			...
			Short4 current = (UShort4(color.x * 0xF8 + 0.5f, true) & UShort4(0xF8)) >> 11 |
			                 (UShort4(color.y * 0xFC + 0.5f, true) & UShort4(0xFC)) >> 5 |
			                 (UShort4(color.z * 0xF8 + 0.5f, true) & UShort4(0xF8));
	...
	case VK_FORMAT_B5G6R5_UNORM_PACK16:
		{
			...
			Short4 current = (UShort4(color.z * 0xF8 + 0.5f, true) & UShort4(0xF8)) >> 11 |
			                 (UShort4(color.y * 0xFC + 0.5f, true) & UShort4(0xFC)) >> 5 |
			                 (UShort4(color.x * 0xF8 + 0.5f, true) & UShort4(0xF8));
