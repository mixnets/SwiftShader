	...
	case VK_FORMAT_A4R4G4B4_UNORM_PACK16:
		{
			...
			{
			case VK_FORMAT_R4G4B4A4_UNORM_PACK16:
				channelMask = *Pointer<Int>(constants + OFFSET(Constants, mask4rgbaQ[bgraWriteMask][0]));
				...
				break;
			case VK_FORMAT_B4G4R4A4_UNORM_PACK16:
				channelMask = *Pointer<Int>(constants + OFFSET(Constants, mask4bgraQ[bgraWriteMask][0]));
				...
				break;
			case VK_FORMAT_A4R4G4B4_UNORM_PACK16:
				channelMask = *Pointer<Int>(constants + OFFSET(Constants, mask4argbQ[bgraWriteMask][0]));
				...
				break;
			case VK_FORMAT_A4B4G4R4_UNORM_PACK16:
				channelMask = *Pointer<Int>(constants + OFFSET(Constants, mask4abgrQ[bgraWriteMask][0]));
				current = (UShort4(As<Int4>(color.w)) & UShort4(0xF)) << 12 |
	...
	case VK_FORMAT_R5G5B5A1_UNORM_PACK16:
		{
			...
			Int channelMask = *Pointer<Int>(constants + OFFSET(Constants, maskr5g5b5a1Q[bgraWriteMask][0]));
	...
	case VK_FORMAT_B5G5R5A1_UNORM_PACK16:
		{
			...
			Int channelMask = *Pointer<Int>(constants + OFFSET(Constants, maskb5g5r5a1Q[bgraWriteMask][0]));
	...
	case VK_FORMAT_A1R5G5B5_UNORM_PACK16:
		{
			...
			Int channelMask = *Pointer<Int>(constants + OFFSET(Constants, mask5551Q[bgraWriteMask][0]));
	...
	case VK_FORMAT_B5G6R5_UNORM_PACK16:
		{
			...
			Int channelMask = *Pointer<Int>(constants + OFFSET(Constants, mask565Q[rgbaWriteMask & 0x7][0]));
