...
void PixelRoutine::alphaBlend(int index, const Pointer<Byte> &cBuffer, Vector4f &oC, const Int &x)
{
	...
	{
	//	one = As<Float4>(format.isUnsignedComponent(0) ? Int4(0) : Int4(0x7FFFFFFF));
	}
	...
	sourceFactor.x = Min(Max(sourceFactor.x, Float4(0.0f)), Float4(1.0f));
	sourceFactor.y = Min(Max(sourceFactor.y, Float4(0.0f)), Float4(1.0f));
	sourceFactor.z = Min(Max(sourceFactor.z, Float4(0.0f)), Float4(1.0f));

	destFactor.x = Min(Max(destFactor.x, Float4(0.0f)), Float4(1.0f));
	destFactor.y = Min(Max(destFactor.y, Float4(0.0f)), Float4(1.0f));
	destFactor.z = Min(Max(destFactor.z, Float4(0.0f)), Float4(1.0f));
	...
	sourceFactor.w = Min(Max(sourceFactor.w, Float4(0.0f)), Float4(1.0f));

	destFactor.w = Min(Max(destFactor.w, Float4(0.0f)), Float4(1.0f));
