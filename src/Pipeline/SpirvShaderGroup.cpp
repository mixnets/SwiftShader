	...
	switch(insn.opcode())
	{
		...
		case spv::OpGroupNonUniformIAdd:
			Impl::Group::BinaryOperation<SIMD::Int>(
			    ...
			    [](RValue<SIMD::Int> a, RValue<SIMD::Int> b) { return a + b; });
			break;

		case spv::OpGroupNonUniformFAdd:
			Impl::Group::BinaryOperation<SIMD::Float>(
			    this, insn, state, dst, 0.0f,
			    [](RValue<SIMD::Float> a, RValue<SIMD::Float> b) { return a + b; });
			break;
		...
		case spv::OpGroupNonUniformBitwiseAnd:
			Impl::Group::BinaryOperation<SIMD::UInt>(
			    ...
			    [](RValue<SIMD::UInt> a, RValue<SIMD::UInt> b) { return a & b; });
			break;
		...
		case spv::OpGroupNonUniformSMin:
			Impl::Group::BinaryOperation<SIMD::Int>(
			    ...
			    [](RValue<SIMD::Int> a, RValue<SIMD::Int> b) { return Min(a, b); });
			break;

		case spv::OpGroupNonUniformUMin:
			Impl::Group::BinaryOperation<SIMD::UInt>(
			    this, insn, state, dst, ~0u,
			    [](RValue<SIMD::UInt> a, RValue<SIMD::UInt> b) { return Min(a, b); });
			break;

		case spv::OpGroupNonUniformFMin:
			Impl::Group::BinaryOperation<SIMD::Float>(
			    this, insn, state, dst, SIMD::Float::infinity(),
			    [](RValue<SIMD::Float> a, RValue<SIMD::Float> b) { return NMin(a, b); });
			break;

		case spv::OpGroupNonUniformSMax:
			Impl::Group::BinaryOperation<SIMD::Int>(
			    this, insn, state, dst, INT32_MIN,
			    [](RValue<SIMD::Int> a, RValue<SIMD::Int> b) { return Max(a, b); });
			break;

		case spv::OpGroupNonUniformUMax:
			Impl::Group::BinaryOperation<SIMD::UInt>(
			    this, insn, state, dst, 0,
			    [](RValue<SIMD::UInt> a, RValue<SIMD::UInt> b) { return Max(a, b); });
			break;

		case spv::OpGroupNonUniformFMax:
			Impl::Group::BinaryOperation<SIMD::Float>(
			    this, insn, state, dst, -SIMD::Float::infinity(),
			    [](RValue<SIMD::Float> a, RValue<SIMD::Float> b) { return NMax(a, b); });
			break;

		case spv::OpGroupNonUniformLogicalAnd:
			Impl::Group::BinaryOperation<SIMD::UInt>(
			    this, insn, state, dst, ~0u,
			    [](RValue<SIMD::UInt> a, RValue<SIMD::UInt> b) {
