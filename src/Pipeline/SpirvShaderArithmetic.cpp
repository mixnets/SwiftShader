...
SIMD::Int SpirvShader::EmitState::SDot(unsigned numComponents, const Operand &x, const Operand &y, Operand const *accum)
{
	SIMD::Int d(0);
...
SIMD::UInt SpirvShader::EmitState::UDot(unsigned numComponents, const Operand &x, const Operand &y, Operand const *accum)
{
	SIMD::UInt d(0);
...
SIMD::Int SpirvShader::EmitState::SUDot(unsigned numComponents, const Operand &x, const Operand &y, Operand const *accum)
{
	SIMD::Int d(0);
