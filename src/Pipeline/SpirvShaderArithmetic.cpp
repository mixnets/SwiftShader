...
SIMD::Int EmitState::SDot(unsigned numComponents, const Operand &x, const Operand &y, Operand const *accum)
{
	SIMD::Int d(0);
...
SIMD::UInt EmitState::UDot(unsigned numComponents, const Operand &x, const Operand &y, Operand const *accum)
{
	SIMD::UInt d(0);
...
SIMD::Int EmitState::SUDot(unsigned numComponents, const Operand &x, const Operand &y, Operand const *accum)
{
	SIMD::Int d(0);
