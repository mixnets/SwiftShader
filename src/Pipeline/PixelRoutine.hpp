...
private:
	...
	void blendFactor(Vector4f &blendFactor, const Vector4f &sourceColor, const Vector4f &destColor, VkBlendFactor blendFactorActive, vk::Format format);
	void blendFactorAlpha(Float4 &blendFactorAlpha, const Float4 &sourceAlpha, const Float4 &destAlpha, VkBlendFactor blendFactorActive, vk::Format format);
