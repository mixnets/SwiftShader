...
protected:
	...
	Float4 convertFloat32(const Short4 &cf);
...
private:
	...
	void depthBoundsTest(const Pointer<Byte> &zBuffer, int q, const Int &x, RValue<Float4> z, Int &zMask, Int &cMask);
	...
	void depthBoundsTest32F(const Pointer<Byte> &zBuffer, int q, const Int &x, RValue<Float4> z, Int &zMask, Int &cMask);
	void depthBoundsTest16(const Pointer<Byte> &zBuffer, int q, const Int &x, RValue<Float4> z, Int &zMask, Int &cMask);
};
