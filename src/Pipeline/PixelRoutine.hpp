...
private:
	...
	void depthBoundsTest32F(const Pointer<Byte> &zBuffer, int q, const Int &x, Int &zMask, Int &cMask);
	void depthBoundsTest16(const Pointer<Byte> &zBuffer, int q, const Int &x, Int &zMask, Int &cMask);
};
