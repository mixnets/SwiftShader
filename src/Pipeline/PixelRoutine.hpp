...
private:
	...
	void blendFactor(Vector4s &blendFactor, const Vector4s &current, const Vector4s &pixel, VkBlendFactor blendFactorState);
	void blendFactorAlpha(Vector4s &blendFactorAlpha, const Vector4s &current, const Vector4s &pixel, VkBlendFactor blendFactorAlphaState);
