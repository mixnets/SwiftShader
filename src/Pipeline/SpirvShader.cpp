...
namespace sw
{
		...
		for (auto insn : *this)
		{
			...
			case spv::OpVariable:
			{
				...
				case spv::StorageClassUniformConstant:
					...
					// For Vulkan it corresponds with
	...
	std::pair<Pointer<Byte>, SIMD::Int> SpirvShader::WalkExplicitLayoutAccessChain(Object::ID baseId, uint32_t numIndexes, uint32_t const *indexIds, SpirvRoutine *routine) const
	{
...
=======
		std::tie(pointerBase, dynamicOffset) = GetPointerToData(baseId, 0, routine);
>>>>>>> 6727892c4... WIP-texture-sampling
	...
	SpirvShader::EmitResult SpirvShader::EmitVariable(InsnIterator insn, EmitState *state) const
	{
		...
		//	Pointer<Byte> address = data + offset;
			routine->createPointer(resultId, buffer);
			break;
		}
		case spv::StorageClassUniform:
		case spv::StorageClassStorageBuffer:
