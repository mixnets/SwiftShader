...
class SurfaceKHR : public Object<SurfaceKHR, VkSurfaceKHR>
{
public:
#ifdef VK_USE_PLATFORM_XLIB_KHR
	SurfaceKHR(const VkXlibSurfaceCreateInfoKHR* pCreateInfo, void* mem);
#endif
	~SurfaceKHR() = delete;
	...
	void getSurfaceCapabilities(VkSurfaceCapabilitiesKHR* pSurfaceCapabilities) const;
