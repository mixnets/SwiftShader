...
static VkExtent2D getWindowSize(xcb_connection_t *connection, xcb_window_t window)
{
	VkExtent2D windowExtent = { 0, 0 };
	xcb_generic_error_t *error = nullptr;

	xcb_get_geometry_cookie_t cookie = libXCB->xcb_get_geometry(connection, window);
	xcb_get_geometry_reply_t *geom = libXCB->xcb_get_geometry_reply(connection, cookie, &error);
