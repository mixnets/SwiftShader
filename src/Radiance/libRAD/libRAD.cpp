...
public:
	...
	virtual void execute(Pipeline *pipeline, Pass *pass)
	{
		...
		context->setVertexAttribState(0, element0, 3, GL_FLOAT, GL_TRUE, 0, offset);
		context->setEnableVertexAttribArray(0, true);
		...
		pipeline->vertexProgram->program->setUniform4fv(0, 1, (const GLfloat*)uniform);
	}
