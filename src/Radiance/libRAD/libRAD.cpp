...
{
	static rad::Device *context = new rad::Device();
...
struct ColorState : public Object
{
	...
	void default()
	{
		...
		for(int i = 0; i < arraySize(blend); i++)
		{
			blend[i].default();
		}
...
struct RasterState : public Object
{
	...
	RADpolygonOffsetEnables polygonOffsetEnable;
...
struct VertexState : public Object
{
	...
	void default()
	{
		for(int i = 0; i < arraySize(attrib); i++)
		{
			attrib[i].default();
		}
