...
namespace es1
{
	...
	int CubeFaceIndex(GLenum cubeFace)
	{
		...
		default: UNREACHABLE(0); return 0;
		}
	}
...
namespace es2sw
{
	...
	sw::Format ConvertRenderbufferFormat(GLenum format)
	{
		...
		default: UNREACHABLE(0);       return sw::FORMAT_A8B8G8R8;
		}
	}
	...
	sw::TextureStage::StageOperation ConvertCombineOperation(GLenum operation)
	{
		...
		default: UNREACHABLE(0); return sw::TextureStage::STAGE_SELECTARG1;
		}
	}
	...
	sw::TextureStage::SourceArgument ConvertSourceArgument(GLenum argument)
	{
		...
		default: UNREACHABLE(0); return sw::TextureStage::SOURCE_CURRENT;
		}
	}
	...
	sw::TextureStage::ArgumentModifier ConvertSourceOperand(GLenum operand)
	{
		...
		default: UNREACHABLE(0);      return sw::TextureStage::MODIFIER_COLOR;
		}
	}
}
