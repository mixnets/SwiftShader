...
void Disable(GLenum cap)
{
	...
	if(context)
	{
		switch(cap)
		{
		case GL_CULL_FACE:                context->setCullFaceEnable(false);              break;
		case GL_POLYGON_OFFSET_FILL:      context->setPolygonOffsetFillEnable(false);     break;
		case GL_SAMPLE_ALPHA_TO_COVERAGE: context->setSampleAlphaToCoverageEnable(false); break;
		case GL_SAMPLE_COVERAGE:          context->setSampleCoverageEnable(false);        break;
		case GL_SCISSOR_TEST:             context->setScissorTestEnable(false);           break;
		case GL_STENCIL_TEST:             context->setStencilTestEnable(false);           break;
		case GL_DEPTH_TEST:               context->setDepthTestEnable(false);             break;
		case GL_BLEND:                    context->setBlendEnable(false);                 break;
		case GL_DITHER:                   context->setDitherEnable(false);                break;
		case GL_LIGHTING:                 context->setLightingEnable(false);              break;
		case GL_LIGHT0:                   context->setLightEnable(0, false);              break;
		case GL_LIGHT1:                   context->setLightEnable(1, false);              break;
		case GL_LIGHT2:                   context->setLightEnable(2, false);              break;
		case GL_LIGHT3:                   context->setLightEnable(3, false);              break;
		case GL_LIGHT4:                   context->setLightEnable(4, false);              break;
		case GL_LIGHT5:                   context->setLightEnable(5, false);              break;
		case GL_LIGHT6:                   context->setLightEnable(6, false);              break;
		case GL_LIGHT7:                   context->setLightEnable(7, false);              break;
		case GL_FOG:                      context->setFogEnable(false);				      break;
		case GL_TEXTURE_2D:               context->setTexture2Denable(false);             break;
		case GL_TEXTURE_EXTERNAL_OES:     context->setTextureExternalEnable(false);       break;
		case GL_ALPHA_TEST:               context->setAlphaTestEnable(false);             break;
		case GL_COLOR_LOGIC_OP:           context->setColorLogicOpEnable(false);          break;
		case GL_POINT_SMOOTH:             context->setPointSmoothEnable(false);           break;
		case GL_LINE_SMOOTH:              context->setLineSmoothEnable(false);            break;
		case GL_COLOR_MATERIAL:           context->setColorMaterialEnable(false);         break;
		case GL_NORMALIZE:                context->setNormalizeEnable(false);             break;
		case GL_RESCALE_NORMAL:           context->setRescaleNormalEnable(false);         break;
		case GL_VERTEX_ARRAY:             context->setVertexArrayEnable(false);           break;
		case GL_NORMAL_ARRAY:             context->setNormalArrayEnable(false);           break;
		case GL_COLOR_ARRAY:              context->setColorArrayEnable(false);            break;
		case GL_POINT_SIZE_ARRAY_OES:     context->setPointSizeArrayEnable(false);        break;
		case GL_TEXTURE_COORD_ARRAY:      context->setTextureCoordArrayEnable(false);     break;
		case GL_MULTISAMPLE:              context->setMultisampleEnable(false);           break;
		case GL_SAMPLE_ALPHA_TO_ONE:      context->setSampleAlphaToOneEnable(false);      break;
		...
		case GL_POINT_SPRITE_OES:         context->setPointSpriteEnable(false);           break;
		default:
			return error(GL_INVALID_ENUM);
		}
	}
...
void Enable(GLenum cap)
{
	...
	if(context)
	{
		switch(cap)
		{
		case GL_CULL_FACE:                context->setCullFaceEnable(true);              break;
		case GL_POLYGON_OFFSET_FILL:      context->setPolygonOffsetFillEnable(true);     break;
		case GL_SAMPLE_ALPHA_TO_COVERAGE: context->setSampleAlphaToCoverageEnable(true); break;
		case GL_SAMPLE_COVERAGE:          context->setSampleCoverageEnable(true);        break;
		case GL_SCISSOR_TEST:             context->setScissorTestEnable(true);           break;
		case GL_STENCIL_TEST:             context->setStencilTestEnable(true);           break;
		case GL_DEPTH_TEST:               context->setDepthTestEnable(true);             break;
		case GL_BLEND:                    context->setBlendEnable(true);                 break;
		case GL_DITHER:                   context->setDitherEnable(true);                break;
		case GL_LIGHTING:                 context->setLightingEnable(true);              break;
		case GL_LIGHT0:                   context->setLightEnable(0, true);              break;
		case GL_LIGHT1:                   context->setLightEnable(1, true);              break;
		case GL_LIGHT2:                   context->setLightEnable(2, true);              break;
		case GL_LIGHT3:                   context->setLightEnable(3, true);              break;
		case GL_LIGHT4:                   context->setLightEnable(4, true);              break;
		case GL_LIGHT5:                   context->setLightEnable(5, true);              break;
		case GL_LIGHT6:                   context->setLightEnable(6, true);              break;
		case GL_LIGHT7:                   context->setLightEnable(7, true);              break;
		case GL_FOG:                      context->setFogEnable(true);                   break;
		case GL_TEXTURE_2D:               context->setTexture2Denable(true);             break;
		case GL_TEXTURE_EXTERNAL_OES:     context->setTextureExternalEnable(true);       break;
		case GL_ALPHA_TEST:               context->setAlphaTestEnable(true);             break;
		case GL_COLOR_LOGIC_OP:           context->setColorLogicOpEnable(true);          break;
		case GL_POINT_SMOOTH:             context->setPointSmoothEnable(true);           break;
		case GL_LINE_SMOOTH:              context->setLineSmoothEnable(true);            break;
		case GL_COLOR_MATERIAL:           context->setColorMaterialEnable(true);         break;
		case GL_NORMALIZE:                context->setNormalizeEnable(true);             break;
		case GL_RESCALE_NORMAL:           context->setRescaleNormalEnable(true);         break;
		case GL_VERTEX_ARRAY:             context->setVertexArrayEnable(true);           break;
		case GL_NORMAL_ARRAY:             context->setNormalArrayEnable(true);           break;
		case GL_COLOR_ARRAY:              context->setColorArrayEnable(true);            break;
		case GL_POINT_SIZE_ARRAY_OES:     context->setPointSizeArrayEnable(true);        break;
		case GL_TEXTURE_COORD_ARRAY:      context->setTextureCoordArrayEnable(true);     break;
		case GL_MULTISAMPLE:              context->setMultisampleEnable(true);           break;
		case GL_SAMPLE_ALPHA_TO_ONE:      context->setSampleAlphaToOneEnable(true);      break;
		...
		case GL_POINT_SPRITE_OES:         context->setPointSpriteEnable(true);           break;
		default:
			return error(GL_INVALID_ENUM);
		}
	}
...
void Lightf(GLenum light, GLenum pname, GLfloat param)
{
	...
	if(context)
	{
		switch(pname)
		{
		case GL_SPOT_EXPONENT:         context->setSpotLightExponent(index, param);         break;
		case GL_SPOT_CUTOFF:           context->setSpotLightCutoff(index, param);           break;
...
void Lightfv(GLenum light, GLenum pname, const GLfloat *params)
{
	...
	if(context)
	{
		...
		case GL_SPOT_EXPONENT:         context->setSpotLightExponent(index, params[0]);                              break;
		case GL_SPOT_CUTOFF:           context->setSpotLightCutoff(index, params[0]);                                break;
