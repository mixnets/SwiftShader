...
void Disable(GLenum cap)
{
	...
	if(context)
	{
		...
		case GL_RESCALE_NORMAL:           context->setRescaleEnable(false);               break;
...
void Enable(GLenum cap)
{
	...
	if(context)
	{
		...
		case GL_RESCALE_NORMAL:           context->setRescaleEnable(true);               break;
...
GLboolean IsEnabled(GLenum cap)
{
	...
	if(context)
	{
		...
		case GL_RESCALE_NORMAL:           return context->isRescaleEnabled();               break;
		...
		case GL_POINT_SIZE_ARRAY_OES:     return context->isPointSizeArrayEnable();         break;
