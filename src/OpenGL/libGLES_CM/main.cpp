...
void GL_APIENTRY error(GLenum errorCode)
{
...
namespace es1
{
void GL_APIENTRY GL_APIENTRY ActiveTexture(GLenum texture);
void GL_APIENTRY GL_APIENTRY AlphaFunc(GLenum func, GLclampf ref);
void GL_APIENTRY GL_APIENTRY AlphaFuncx(GLenum func, GLclampx ref);
void GL_APIENTRY GL_APIENTRY BindBuffer(GLenum target, GLuint buffer);
void GL_APIENTRY GL_APIENTRY BindFramebuffer(GLenum target, GLuint framebuffer);
void GL_APIENTRY GL_APIENTRY BindFramebufferOES(GLenum target, GLuint framebuffer);
void GL_APIENTRY GL_APIENTRY BindRenderbufferOES(GLenum target, GLuint renderbuffer);
void GL_APIENTRY GL_APIENTRY BindTexture(GLenum target, GLuint texture);
void GL_APIENTRY GL_APIENTRY BlendEquationSeparateOES(GLenum modeRGB, GLenum modeAlpha);
void GL_APIENTRY GL_APIENTRY BlendEquationOES(GLenum mode);
void GL_APIENTRY GL_APIENTRY BlendEquationSeparateOES(GLenum modeRGB, GLenum modeAlpha);
