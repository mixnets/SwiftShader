    ...
    for(Iterator config = mSet.begin(); config != mSet.end(); config++)
    {
        ...
        while(attribute[0] != EGL_NONE)
        {
			if(attribute[1] != EGL_DONT_CARE)
			{
				...
				case EGL_NATIVE_VISUAL_ID:           match = true; /* Ignored */                                       break;
				...
				case EGL_MATCH_NATIVE_PIXMAP:        match = false; UNIMPLEMENTED(); /* Special */                     break;
				case EGL_CONFORMANT:                 match = (config->mConformant & attribute[1]) == attribute[1];     break;
				case EGL_MAX_PBUFFER_WIDTH:          match = true; /* Ignored */                                       break;
				case EGL_MAX_PBUFFER_HEIGHT:         match = true; /* Ignored */                                       break;
				case EGL_MAX_PBUFFER_PIXELS:         match = true; /* Ignored */                                       break;
