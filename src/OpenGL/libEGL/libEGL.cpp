...
__eglMustCastToProperFunctionPointerType GetProcAddress(const char *procname)
{
	...
	static const Extension eglExtensions[] =
	{
		...
		EXTENSION(eglBindAPI),
		EXTENSION(eglBindTexImage),
		EXTENSION(eglChooseConfig),
		EXTENSION(eglCopyBuffers),
		EXTENSION(eglCreateContext),
		EXTENSION(eglCreatePbufferFromClientBuffer),
		EXTENSION(eglCreatePbufferSurface),
		EXTENSION(eglCreatePixmapSurface),
		EXTENSION(eglCreateWindowSurface),
		EXTENSION(eglDestroyContext),
		EXTENSION(eglDestroySurface),
		EXTENSION(eglGetConfigAttrib),
		EXTENSION(eglGetConfigs),
		EXTENSION(eglGetCurrentContext),
		EXTENSION(eglGetCurrentDisplay),
		EXTENSION(eglGetCurrentSurface),
		EXTENSION(eglGetDisplay),
		EXTENSION(eglGetError),
		EXTENSION(eglGetProcAddress),
		EXTENSION(eglInitialize),
		EXTENSION(eglMakeCurrent),
		EXTENSION(eglQueryAPI),
		EXTENSION(eglQueryContext),
		EXTENSION(eglQueryString),
		EXTENSION(eglQuerySurface),
		EXTENSION(eglReleaseTexImage),
		EXTENSION(eglReleaseThread),
		EXTENSION(eglSurfaceAttrib),
		EXTENSION(eglSwapBuffers),
		EXTENSION(eglSwapInterval),
		EXTENSION(eglTerminate),
		EXTENSION(eglWaitClient),
		EXTENSION(eglWaitGL),
		EXTENSION(eglWaitNative),
