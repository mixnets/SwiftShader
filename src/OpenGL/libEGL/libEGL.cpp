...
__eglMustCastToProperFunctionPointerType GetProcAddress(const char *procname)
{
	...
	static const Extension eglExtensions[] =
	{
		...
		EXTENSION(CreateImageKHR),
		EXTENSION(DestroyImageKHR),
		EXTENSION(GetPlatformDisplayEXT),
		EXTENSION(CreatePlatformWindowSurfaceEXT),
		EXTENSION(CreatePlatformPixmapSurfaceEXT),
