...
CONSTRUCTOR static bool eglAttachProcess()
{
	...
	const char *libGLES_CM_lib[] = {"/system/lib/egl/libGLESv1_CM_swiftshader.so", "libGLES_CM.so.1", "libGLES_CM.so"};
	...
	#elif defined(__ANDROID__) || defined(ANDROID)
	const char *libGLESv2_lib[] = {"/system/lib/egl/libGLESv2_swiftshader.so", "libGLESv2.so.2", "libGLESv2.so"};
	#elif defined(__LP64__)
