...
CONSTRUCTOR static bool eglAttachProcess()
{
    ...
    es2::createContext = (egl::Context *(*)(const egl::Config*, const egl::Context*, int))getProcAddress(libGLESv2, "glCreateContext");
...
namespace es2
{
	egl::Context *(*createContext)(const egl::Config *config, const egl::Context *shareContext, int clientVersion) = 0;
	__eglMustCastToProperFunctionPointerType (*getProcAddress)(const char *procname) = 0;
}
