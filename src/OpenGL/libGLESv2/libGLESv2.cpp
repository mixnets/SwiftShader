                                        ...
                                        GLint border, GLsizei imageSize, const GLvoid* data)
{
	...
	case GL_ETC1_RGB8_OES:
		if(clientVersion < 3)
		{
			// This isn't supported by default in ES3
			return error(GL_INVALID_ENUM);
		}
		break;
