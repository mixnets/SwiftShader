...
extern "C" NO_SANITIZE_FUNCTION __eglMustCastToProperFunctionPointerType es2GetProcAddress(const char *procname)
{
	...
	static const Extension glExtensions[] =
	{
		...
		EXTENSION(glBindRenderbuffer),
		EXTENSION(glBindTexture),
		EXTENSION(glBlendColor),
		EXTENSION(glBlendEquation),
		EXTENSION(glBlendEquationSeparate),
		EXTENSION(glBlendFunc),
		EXTENSION(glBlendFuncSeparate),
		EXTENSION(glBufferData),
		EXTENSION(glBufferSubData),
		EXTENSION(glCheckFramebufferStatus),
		EXTENSION(glClear),
		EXTENSION(glClearColor),
		EXTENSION(glClearDepthf),
		EXTENSION(glClearStencil),
		EXTENSION(glColorMask),
		EXTENSION(glCompileShader),
		EXTENSION(glCompressedTexImage2D),
		EXTENSION(glCompressedTexSubImage2D),
		EXTENSION(glCopyTexImage2D),
		EXTENSION(glCopyTexSubImage2D),
		EXTENSION(glCreateProgram),
		EXTENSION(glCreateShader),
		EXTENSION(glCullFace),
		EXTENSION(glDeleteBuffers),
		EXTENSION(glDeleteFramebuffers),
		EXTENSION(glDeleteProgram),
		EXTENSION(glDeleteRenderbuffers),
		EXTENSION(glDeleteShader),
		EXTENSION(glDeleteTextures),
		EXTENSION(glDepthFunc),
		EXTENSION(glDepthMask),
		EXTENSION(glDepthRangef),
		EXTENSION(glDetachShader),
		EXTENSION(glDisable),
		EXTENSION(glDisableVertexAttribArray),
		EXTENSION(glDrawArrays),
		EXTENSION(glDrawElements),
		EXTENSION(glEnable),
		EXTENSION(glEnableVertexAttribArray),
		EXTENSION(glFinish),
		EXTENSION(glFlush),
		EXTENSION(glFramebufferRenderbuffer),
		EXTENSION(glFramebufferTexture2D),
		EXTENSION(glFrontFace),
		EXTENSION(glGenBuffers),
		EXTENSION(glGenFramebuffers),
		EXTENSION(glGenRenderbuffers),
		EXTENSION(glGenTextures),
		EXTENSION(glGenerateMipmap),
		EXTENSION(glGetActiveAttrib),
		EXTENSION(glGetActiveUniform),
		EXTENSION(glGetAttachedShaders),
		EXTENSION(glGetAttribLocation),
		EXTENSION(glGetBooleanv),
		EXTENSION(glGetBufferParameteriv),
		EXTENSION(glGetError),
		EXTENSION(glGetFloatv),
		EXTENSION(glGetFramebufferAttachmentParameteriv),
		EXTENSION(glGetIntegerv),
		EXTENSION(glGetProgramInfoLog),
		EXTENSION(glGetProgramiv),
		EXTENSION(glGetRenderbufferParameteriv),
		EXTENSION(glGetShaderInfoLog),
		EXTENSION(glGetShaderPrecisionFormat),
		EXTENSION(glGetShaderSource),
		EXTENSION(glGetShaderiv),
		EXTENSION(glGetString),
		EXTENSION(glGetTexParameterfv),
		EXTENSION(glGetTexParameteriv),
		EXTENSION(glGetUniformLocation),
		EXTENSION(glGetUniformfv),
		EXTENSION(glGetUniformiv),
		EXTENSION(glGetVertexAttribPointerv),
		EXTENSION(glGetVertexAttribfv),
		EXTENSION(glGetVertexAttribiv),
		EXTENSION(glHint),
		EXTENSION(glIsBuffer),
		EXTENSION(glIsEnabled),
		EXTENSION(glIsFramebuffer),
		EXTENSION(glIsProgram),
		EXTENSION(glIsRenderbuffer),
		EXTENSION(glIsShader),
		EXTENSION(glIsTexture),
		EXTENSION(glLineWidth),
		EXTENSION(glLinkProgram),
		EXTENSION(glPixelStorei),
		EXTENSION(glPolygonOffset),
		EXTENSION(glReadPixels),
		EXTENSION(glReleaseShaderCompiler),
		EXTENSION(glRenderbufferStorage),
		EXTENSION(glSampleCoverage),
		EXTENSION(glScissor),
		EXTENSION(glShaderBinary),
		EXTENSION(glShaderSource),
		EXTENSION(glStencilFunc),
		EXTENSION(glStencilFuncSeparate),
		EXTENSION(glStencilMask),
		EXTENSION(glStencilMaskSeparate),
		EXTENSION(glStencilOp),
		EXTENSION(glStencilOpSeparate),
		EXTENSION(glTexImage2D),
		EXTENSION(glTexParameterf),
		EXTENSION(glTexParameterfv),
		EXTENSION(glTexParameteri),
		EXTENSION(glTexParameteriv),
		EXTENSION(glTexSubImage2D),
		EXTENSION(glUniform1f),
		EXTENSION(glUniform1fv),
		EXTENSION(glUniform1i),
		EXTENSION(glUniform1iv),
		EXTENSION(glUniform2f),
		EXTENSION(glUniform2fv),
		EXTENSION(glUniform2i),
		EXTENSION(glUniform2iv),
		EXTENSION(glUniform3f),
		EXTENSION(glUniform3fv),
		EXTENSION(glUniform3i),
		EXTENSION(glUniform3iv),
		EXTENSION(glUniform4f),
		EXTENSION(glUniform4fv),
		EXTENSION(glUniform4i),
		EXTENSION(glUniform4iv),
		EXTENSION(glUniformMatrix2fv),
		EXTENSION(glUniformMatrix3fv),
		EXTENSION(glUniformMatrix4fv),
		EXTENSION(glUseProgram),
		EXTENSION(glValidateProgram),
		EXTENSION(glVertexAttrib1f),
		EXTENSION(glVertexAttrib1fv),
		EXTENSION(glVertexAttrib2f),
		EXTENSION(glVertexAttrib2fv),
		EXTENSION(glVertexAttrib3f),
		EXTENSION(glVertexAttrib3fv),
		EXTENSION(glVertexAttrib4f),
		EXTENSION(glVertexAttrib4fv),
		EXTENSION(glVertexAttribPointer),
		EXTENSION(glViewport),
