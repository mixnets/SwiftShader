                             ...
                             GLenum format, GLsizei imageSize, const GLvoid* data)
{
	...
	if(context)
	{
		...
		if(target == GL_TEXTURE_2D)
		{
			...
			GLenum formatError = ValidateSubImageParams(true, width, height, xoffset, yoffset, target, level, sizedInternalFormat, texture);
...
void CopyTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height)
{
	...
	if(context)
	{
		...
		GLenum formatError = ValidateSubImageParams(false, width, height, xoffset, yoffset, target, level, GL_NONE, texture);
		if(formatError != GL_NONE)
		{
			return error(formatError);
		}
                   ...
                   GLenum format, GLenum type, const GLvoid* pixels)
{
	...
	if(context)
	{
		...
		if(target == GL_TEXTURE_2D)
		{
			...
			GLenum formatError = ValidateSubImageParams(false, width, height, xoffset, yoffset, target, level, sizedInternalFormat, texture);
...
void TexSubImage3DOES(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void *pixels)
{
	...
	if(context)
	{
		...
		GLenum formatError = ValidateSubImageParams(false, width, height, depth, xoffset, yoffset, zoffset, target, level, sizedInternalFormat, texture);
		if(formatError == GL_NONE)
		{
...
void CopyTexSubImage3DOES(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height)
{
	...
	if(context)
	{
		...
		GLenum formatError = ValidateSubImageParams(false, width, height, 1, xoffset, yoffset, zoffset, target, level, GL_NONE, texture);
