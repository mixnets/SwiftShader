...
namespace es2
{
	GLint GetSizedInternalFormat(GLint internalformat, GLenum type)
	{
		...
		case GL_BGRA_EXT:
			...
			case GL_UNSIGNED_SHORT_4_4_4_4_REV_EXT: return GL_BGRA4_ANGLE;
			case GL_UNSIGNED_SHORT_1_5_5_5_REV_EXT: return GL_BGR5_A1_ANGLE;
			default: UNREACHABLE(type); return GL_NONE;
			}
		...
		// GL_EXT_sRGB
	//	case GL_STENCIL_INDEX_OES, GL_UNSIGNED_BYTE, GL_STENCIL_INDEX8);

		// GL_OES_texture_sRGB
	//	case GL_SRGB_EXT, GL_UNSIGNED_BYTE, GL_SRGB8);
	//	case GL_SRGB_ALPHA_EXT, GL_UNSIGNED_BYTE, GL_SRGB8_ALPHA8);
	...
	{
		ASSERT(!IsUnsizedInternalFormat(textureFormat));
		ASSERT(!IsUnsizedInternalFormat(colorbufferFormat));
