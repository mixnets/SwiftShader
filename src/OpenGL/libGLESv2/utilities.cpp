...
namespace es2
{
	...
	GLenum ValidateTextureFormatType(GLenum format, GLenum type, GLint internalformat, GLenum target, GLint clientVersion)
	{
		...
		case GL_RGB:
			...
			case GL_HALF_FLOAT_OES:               VALIDATE_INTERNALFORMAT(GL_RGB16F, GL_R11F_G11F_B10F, GL_RGB9_E5)
		...
		case GL_RG:
			...
			case GL_HALF_FLOAT_OES: VALIDATE_INTERNALFORMAT(GL_RG16F)
		...
		case GL_RED:
			...
			case GL_HALF_FLOAT_OES: VALIDATE_INTERNALFORMAT(GL_R16F)
