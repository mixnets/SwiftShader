...
bool Texture::copy(egl::Image *source, const sw::Rect &sourceRect, int sourceZ, GLenum destFormat, GLint xoffset, GLint yoffset, egl::Image *dest)
{
    Device *device = getDevice();
	
    sw::Rect destRect = {xoffset, yoffset, xoffset + (sourceRect.x1 - sourceRect.x0), yoffset + (sourceRect.y1 - sourceRect.y0)};
    bool success = device->stretchRect(source, &sourceRect, sourceZ, dest, &destRect, false);
...
void Texture2D::copyImage(GLint level, GLenum format, GLint x, GLint y, GLsizei width, GLsizei height, Framebuffer *source)
{
    ...
    if(width != 0 && height != 0)
    {
        ...
        copy(renderTarget, sourceRect, 0, format, 0, 0, image[level]);
    }
...
void Texture2D::copySubImage(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height, Framebuffer *source)
{
	...
	copy(renderTarget, sourceRect, 0, image[level]->getFormat(), xoffset, yoffset, image[level]);
...
void Texture2D::generateMipmaps()
{
	...
	for(unsigned int i = 1; i <= q; i++)
    {
		...
		getDevice()->stretchRect(image[i - 1], 0, 0, image[i], 0, true);
    }
}
...
void TextureCubeMap::copyImage(GLenum target, GLint level, GLenum format, GLint x, GLint y, GLsizei width, GLsizei height, Framebuffer *source)
{
    ...
    if(width != 0 && height != 0)
    {
        ...
        copy(renderTarget, sourceRect, 0, format, 0, 0, image[face][level]);
    }
...
void TextureCubeMap::copySubImage(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height, Framebuffer *source)
{
	...
	copy(renderTarget, sourceRect, 0, image[face][level]->getFormat(), xoffset, yoffset, image[face][level]);
...
void TextureCubeMap::generateMipmaps()
{
	...
	for(unsigned int f = 0; f < 6; f++)
    {
		for(unsigned int i = 1; i <= q; i++)
		{
			...
			getDevice()->stretchRect(image[f][i - 1], 0, 0, image[f][i], 0, true);
		}
	}
}
...
void Texture3D::copySubImage(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height, Framebuffer *source)
{
	...
	copy(renderTarget, sourceRect, zoffset, image[level]->getFormat(), xoffset, yoffset, image[level]);
