...
egl::Image *Framebuffer::getDrawRenderTarget(GLuint outputIndex)
{
	Context *context = getContext();
	return getRenderTarget(context->getDrawFramebufferColorIndex(outputIndex));
}
...
Renderbuffer *Framebuffer::getDrawColorbuffer(GLuint outputIndex)
{
	Context *context = getContext();
	return getColorbuffer(context->getDrawFramebufferColorIndex(outputIndex));
}
