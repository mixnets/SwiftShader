...
{
	return mColorbufferPointer[index];
}
...
GLenum Framebuffer::getImplementationColorReadFormat(GLuint index)
{
	Renderbuffer *colorbuffer = mColorbufferPointer[index];
...
GLenum Framebuffer::getImplementationColorReadType(GLuint index)
{
	Renderbuffer *colorbuffer = mColorbufferPointer[index];
