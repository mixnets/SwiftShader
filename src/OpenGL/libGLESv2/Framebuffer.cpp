...
GLenum Framebuffer::getImplementationColorReadType()
{
	...
	if(colorbuffer)
	{
		...
		case sw::FORMAT_A1R5G5B5:        return GL_UNSIGNED_SHORT_5_5_5_1;
		...
		case sw::FORMAT_G8R8I:
		case sw::FORMAT_X8B8G8R8I:
		case sw::FORMAT_A8B8G8R8I:       return GL_BYTE;
		case sw::FORMAT_R16I:
		case sw::FORMAT_G16R16I:
		case sw::FORMAT_X16B16G16R16I:
		case sw::FORMAT_A16B16G16R16I:   return GL_SHORT;
		case sw::FORMAT_R32I:
		case sw::FORMAT_G32R32I:
		case sw::FORMAT_X32B32G32R32I:
		...
		case sw::FORMAT_G8R8UI:
		case sw::FORMAT_X8B8G8R8UI:
		case sw::FORMAT_A8B8G8R8UI:      return GL_UNSIGNED_BYTE;
		case sw::FORMAT_R16UI:
		case sw::FORMAT_G16R16UI:
		case sw::FORMAT_X16B16G16R16UI:
		case sw::FORMAT_A16B16G16R16UI:  return GL_UNSIGNED_SHORT;
		...
		case sw::FORMAT_A2B10G10R10:     return GL_UNSIGNED_INT_2_10_10_10_REV;
		default:
			UNREACHABLE(colorbuffer->getInternalFormat());
		}
	}
