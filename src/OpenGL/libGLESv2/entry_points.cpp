...
static int libGLESv2_swiftshader_symbol;
LibEGL libEGL(getLibraryDirectoryFromSymbol((void*)&libGLESv2_swiftshader_symbol));
LibGLES_CM libGLES_CM(getLibraryDirectoryFromSymbol((void*)&libGLESv2_swiftshader_symbol));
