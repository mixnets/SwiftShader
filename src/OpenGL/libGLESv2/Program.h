...
namespace es2
{
	...
	private:
		...
		std::set<GLuint> uniformBlockBinding[MAX_UNIFORM_BUFFER_BINDINGS];
		glsl::UniformBlock linkedUniformBlock[MAX_UNIFORM_BUFFER_BINDINGS];
		int uniformBlockStream[MAX_UNIFORM_BUFFER_BINDINGS];
