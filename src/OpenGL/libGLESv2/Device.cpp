...
namespace es2
{
	...
	void Device::drawIndexedPrimitive(sw::DrawType type, unsigned int indexOffset, unsigned int primitiveCount, bool primitiveRestart)
	{
		...
		draw(type, indexOffset, primitiveCount, true, primitiveRestart);
	}
