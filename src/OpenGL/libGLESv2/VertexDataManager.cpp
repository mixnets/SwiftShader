	...
	for(int i = 0; i < MAX_VERTEX_ATTRIBS; i++)
	{
		if(program->getAttributeStream(i) != -1)
		{
			...
			if(attrib.mArrayEnabled)
			{
				...
				case GL_INT_2_10_10_10_REV:          translated[i].type = sw::STREAMTYPE_RGB10A2I;  break;
				case GL_UNSIGNED_INT_2_10_10_10_REV: translated[i].type = sw::STREAMTYPE_RGB10A2UI; break;
