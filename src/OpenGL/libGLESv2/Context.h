...
public:
	...
	GLsizei getRequiredSize(GLsizei width, GLsizei height, GLsizei depth, GLint internalformat, GLenum type);
	const GLvoid *getPixels(const GLvoid *data, GLsizei imageSize) const;
