...
bool RenderbufferTexture3D::validateLayer() const
{
	return mTexture3D->getDepth(mTexture3D->getTarget(), mLevel) > mLayer;
}
...
bool Renderbuffer::validateLayer() const
{
	return mInstance->validateLayer();
}
