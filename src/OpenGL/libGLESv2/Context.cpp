...
void Context::readPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei *bufSize, void* pixels)
{
	...
	GLenum readFormat = GL_INVALID_ENUM;
	GLenum readType = GL_INVALID_ENUM;
	switch(format)
	{
	case GL_DEPTH_COMPONENT:
		readFormat = framebuffer->getImplementationDepthReadFormat();
		readType = framebuffer->getImplementationDepthReadType();
		break;
	default:
...
#endif
		(const GLubyte*)"GL_NV_fbo_color_attachments",
