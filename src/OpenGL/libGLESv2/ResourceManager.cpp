...
ResourceManager::~ResourceManager()
{
    ...
    {
        deleteBuffer(mBufferNameSpace.begin()->first);
    }
...
{
	Buffer *bufferObject = mBufferNameSpace.erase(buffer);
...
void ResourceManager::deleteShader(GLuint shader)
{
    ...
    if(shaderObject != mShaderMap.end())
    {
        if(shaderObject->second->getRefCount() == 0)
        {
			...
			mProgramShaderNameSpace.erase(shaderObject->first);
...
void ResourceManager::deleteProgram(GLuint program)
{
    ...
    if(programObject != mProgramMap.end())
    {
        if(programObject->second->getRefCount() == 0)
        {
			...
			mProgramShaderNameSpace.erase(programObject->first);
...
void ResourceManager::deleteTexture(GLuint texture)
{
    ...
    if(textureObject != mTextureMap.end())
    {
		...
		mTextureNameSpace.erase(textureObject->first);
...
void ResourceManager::deleteRenderbuffer(GLuint renderbuffer)
{
    ...
    if(renderbufferObject != mRenderbufferMap.end())
    {
		...
		mRenderbufferNameSpace.erase(renderbufferObject->first);
...
void ResourceManager::deleteSampler(GLuint sampler)
{
	...
	if(samplerObject != mSamplerMap.end())
	{
		...
		mSamplerNameSpace.erase(samplerObject->first);
...
void ResourceManager::deleteFenceSync(GLuint fenceSync)
{
	...
	if(fenceObjectIt != mFenceSyncMap.end())
	{
		...
		mFenceSyncNameSpace.erase(fenceObjectIt->first);
