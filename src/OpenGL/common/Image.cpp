...
namespace
{
	...
	template<>
	void LoadImageRow<Bytes_1>(const unsigned char *source, unsigned char *dest, GLint xoffset, GLsizei width, sw::Format internalFormat)
	{
		memcpy(dest + xoffset, source, width);
	}

	template<>
	void LoadImageRow<Bytes_2>(const unsigned char *source, unsigned char *dest, GLint xoffset, GLsizei width, sw::Format internalFormat)
	{
		memcpy(dest + xoffset * 2, source, width * 2);
	}

	template<>
	void LoadImageRow<Bytes_4>(const unsigned char *source, unsigned char *dest, GLint xoffset, GLsizei width, sw::Format internalFormat)
	{
		memcpy(dest + xoffset * 4, source, width * 4);
	}

	template<>
	void LoadImageRow<Bytes_8>(const unsigned char *source, unsigned char *dest, GLint xoffset, GLsizei width, sw::Format internalFormat)
	{
		memcpy(dest + xoffset * 8, source, width * 8);
	}

	template<>
	void LoadImageRow<Bytes_16>(const unsigned char *source, unsigned char *dest, GLint xoffset, GLsizei width, sw::Format internalFormat)
	{
	...
	template<>
	void LoadImageRow<ByteRGB>(const unsigned char *source, unsigned char *dest, GLint xoffset, GLsizei width, sw::Format internalFormat)
	{
	...
	template<>
	void LoadImageRow<ShortRGB>(const unsigned char *source, unsigned char *dest, GLint xoffset, GLsizei width, sw::Format internalFormat)
	{
	...
	template<>
	void LoadImageRow<UShortRGB>(const unsigned char *source, unsigned char *dest, GLint xoffset, GLsizei width, sw::Format internalFormat)
	{
		const unsigned short *sourceS = reinterpret_cast<const unsigned short*>(source);
		unsigned short *destS = reinterpret_cast<unsigned short*>(dest + xoffset * 8);
	...
	template<>
	void LoadImageRow<IntRGB>(const unsigned char *source, unsigned char *dest, GLint xoffset, GLsizei width, sw::Format internalFormat)
	{
	...
	template<>
	void LoadImageRow<UIntRGB>(const unsigned char *source, unsigned char *dest, GLint xoffset, GLsizei width, sw::Format internalFormat)
	{
		const unsigned int *sourceI = reinterpret_cast<const unsigned int*>(source);
		unsigned int *destI = reinterpret_cast<unsigned int*>(dest + xoffset * 16);
	...
	sw::Format Image::selectInternalFormat(GLenum format, GLenum type)
	{
		...
		#endif
		{
			...
			case GL_UNSIGNED_SHORT:
				...
				{
				case GL_RED_INTEGER:
					return sw::FORMAT_R16;
				case GL_RG_INTEGER:
					return sw::FORMAT_G16R16;
				case GL_RGB_INTEGER:
					return sw::FORMAT_X16B16G16R16;
				case GL_RGBA_INTEGER:
					return sw::FORMAT_A16B16G16R16;
			...
			case GL_UNSIGNED_INT:
				...
				{
				case GL_RED_INTEGER:
					return sw::FORMAT_R32;
				case GL_RG_INTEGER:
					return sw::FORMAT_G32R32;
				case GL_RGB_INTEGER:
					return sw::FORMAT_X32B32G32R32;
				case GL_RGBA_INTEGER:
					return sw::FORMAT_A32B32G32R32;
				case GL_DEPTH_COMPONENT:
					return sw::FORMAT_D32FS8_TEXTURE;
				default:
					UNREACHABLE();
	...
	void Image::loadImageData(GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const UnpackInfo& unpackInfo, const void *input)
	{
		...
		if(buffer)
		{
			...
			case GL_BYTE:
				...
				case GL_ALPHA:
				case GL_LUMINANCE:
					LoadImageData<Bytes_1>(xoffset, yoffset, zoffset, width, height, depth, inputPitch, inputHeight, getPitch(), getHeight(), input, buffer, internalFormat);
					break;
				case GL_RG:
				case GL_RG_INTEGER:
				case GL_LUMINANCE_ALPHA:
					LoadImageData<Bytes_2>(xoffset, yoffset, zoffset, width, height, depth, inputPitch, inputHeight, getPitch(), getHeight(), input, buffer, internalFormat);
					break;
				case GL_RGB:
				case GL_RGB_INTEGER:
					LoadImageData<ByteRGB>(xoffset, yoffset, zoffset, width, height, depth, inputPitch, inputHeight, getPitch(), getHeight(), input, buffer, internalFormat);
					break;
				case GL_RGBA:
				case GL_RGBA_INTEGER:
				case GL_BGRA_EXT:
					LoadImageData<Bytes_4>(xoffset, yoffset, zoffset, width, height, depth, inputPitch, inputHeight, getPitch(), getHeight(), input, buffer, internalFormat);
					break;
				default: UNREACHABLE();
				}
				break;
			...
			case GL_FLOAT:
				...
				case GL_RGB:
					...
					break;
				case GL_RGBA:
					LoadImageData<Bytes_16>(xoffset, yoffset, zoffset, width, height, depth, inputPitch, inputHeight, getPitch(), getHeight(), input, buffer, internalFormat);
					break;
				default: UNREACHABLE();
				}
				break;
			...
			case GL_HALF_FLOAT_OES:
				...
				case GL_RGB:
					...
					break;
				case GL_RGBA:
					LoadImageData<Bytes_8>(xoffset, yoffset, zoffset, width, height, depth, inputPitch, inputHeight, getPitch(), getHeight(), input, buffer, internalFormat);
					break;
				default: UNREACHABLE();
				}
				break;
			case GL_SHORT:
				...
				case GL_RGB:
				case GL_RGB_INTEGER:
					LoadImageData<ShortRGB>(xoffset, yoffset, zoffset, width, height, depth, inputPitch, inputHeight, getPitch(), getHeight(), input, buffer, internalFormat);
					break;
				case GL_RGBA:
				case GL_RGBA_INTEGER:
				case GL_BGRA_EXT:
			...
			case GL_UNSIGNED_SHORT:
				...
				case GL_RGB:
				case GL_RGB_INTEGER:
					LoadImageData<UShortRGB>(xoffset, yoffset, zoffset, width, height, depth, inputPitch, inputHeight, getPitch(), getHeight(), input, buffer, internalFormat);
					break;
				case GL_RGBA:
				case GL_RGBA_INTEGER:
				case GL_BGRA_EXT:
			...
			case GL_INT:
				...
				case GL_RGB:
				case GL_RGB_INTEGER:
					LoadImageData<IntRGB>(xoffset, yoffset, zoffset, width, height, depth, inputPitch, inputHeight, getPitch(), getHeight(), input, buffer, internalFormat);
					break;
				case GL_RGBA:
				case GL_RGBA_INTEGER:
				case GL_BGRA_EXT:
			...
			case GL_UNSIGNED_INT:
				...
				case GL_RGB:
				case GL_RGB_INTEGER:
					LoadImageData<UIntRGB>(xoffset, yoffset, zoffset, width, height, depth, inputPitch, inputHeight, getPitch(), getHeight(), input, buffer, internalFormat);
					break;
				case GL_RGBA:
				case GL_RGBA_INTEGER:
				case GL_BGRA_EXT:
