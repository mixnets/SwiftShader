...
namespace gl
{
	static sw::Format ConvertFormatType(GLenum format, GLenum type)
	{
		switch(format)
		{
		case GL_LUMINANCE:
	...
	TextureImage::TextureImage(egl::Texture *parentTexture, GLsizei width, GLsizei height, GLenum format, GLenum type)
		: Image(parentTexture, width, height, 1, format, type)
	{
	}
	...
	void TextureImage::loadImageData(GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const UnpackInfo& unpackInfo, const void *input)
	{
		...
		sw::Format selectedInternalFormat = egl::SelectInternalFormat(format, type);
	...
	void TextureImage::loadD24S8ImageData(GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, int inputPitch, int inputHeight, const void *input, void *buffer)
	{
	...
	void TextureImage::loadD32FS8ImageData(GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, int inputPitch, int inputHeight, const void *input, void *buffer)
	{
