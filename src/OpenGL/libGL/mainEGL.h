...
extern "C" sw::FrameBuffer *createFrameBuffer(EGLNativeDisplayType display, EGLNativeWindowType window, int width, int height);
extern "C" egl::Image *createBackBuffer(int width, int height, const egl::Config *config);
extern "C" egl::Image *createDepthStencil(unsigned int width, unsigned int height, sw::Format format, int multiSampleDepth, bool discard);
