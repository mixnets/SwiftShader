...
namespace gl
{
	...
	Image::Image(Texture *parentTexture, GLsizei width, GLsizei height, GLenum format, GLenum type, LockResourceId id)
	...
	Image::Image(Texture *parentTexture, GLsizei width, GLsizei height, sw::Format internalFormat, int multiSampleDepth, bool lockable, bool renderTarget, LockResourceId id)
		...
		, sw::Surface(getParentResource(parentTexture), width, height, multiSampleDepth, internalFormat, lockable, renderTarget, id)
	{
		referenceCount = 1;
	}
