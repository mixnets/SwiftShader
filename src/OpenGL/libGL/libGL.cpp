...
void APIENTRY glBeginQueryEXT(GLenum target, GLuint id)
{
...
void APIENTRY glGetQueryObjectuivEXT(GLuint id, GLenum pname, GLuint *params)
{
...
GLboolean APIENTRY glIsQueryEXT(GLuint id)
{
...
{
	egl::Surface *drawSurface = static_cast<egl::Surface*>(egl::getCurrentDrawSurface());
...
HGLRC WINAPI wglCreateContext(HDC hdc)
{
	...
	egl::Display *display = egl::Display::getDisplay(hdc);
	display->initialize();

	EGLContext context = display->createContext((void*)1, 0);
...
BOOL WINAPI wglMakeCurrent(HDC hdc, HGLRC hglrc)
{
	...
	if(hdc && hglrc)
	{
		egl::Display *display = (egl::Display*)egl::Display::getDisplay(hdc);
