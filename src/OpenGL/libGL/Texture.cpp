...
//	}
//
//	if(width + xoffset > image[level]->getWidth() || height + yoffset > image[level]->getHeight())
//	{
//		return error(GL_INVALID_VALUE);
//	}
//
//	if(IsCompressed(image[level]->getFormat()))
//	{
//		return error(GL_INVALID_OPERATION);
//	}
//
//	if(pixels)
//	{
//		image[level]->loadImageData(xoffset, yoffset, 0, width, height, 1, format, type, unpackAlignment, pixels);
//	}
//}
