...
namespace gl
{
	...
	{
	public:
		Image(Texture *parentTexture, GLsizei width, GLsizei height, GLenum format, GLenum type, LockResourceId id, ThreadAnalyzer * ta);
		Image(Texture *parentTexture, GLsizei width, GLsizei height, sw::Format internalFormat, int multiSampleDepth, bool lockable, bool renderTarget, LockResourceId id, ThreadAnalyzer * ta);
