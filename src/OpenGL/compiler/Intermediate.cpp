                    ...
                    for (int row = 0; row < tempNumRows; row++) {
                        for (int column = 0; column < tempNumCols; column++) {
                            ...
                            for (int i = 0; i < tempNumAdds; i++) {
                                tempConstArray[tempNumRows * column + row].setFConst(tempConstArray[tempNumRows * column + row].getFConst() + unionArray[column * leftNumRows + i].getFConst() * (rightUnionArray[i * rightNumCols + row].getFConst()));
                            }
                        }
                    }
                }
