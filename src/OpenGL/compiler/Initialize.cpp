...
void InsertBuiltInFunctions(GLenum type, const ShBuiltInResources &resources, TSymbolTable &symbolTable)
{
    ...
    symbolTable.insertBuiltIn(COMMON_BUILTINS, EOpReflect, genType, "refract", genType, genType, float1);
    ...
    symbolTable.insertBuiltIn(COMMON_BUILTINS, EOpEqual, bvec, "equal", vec, vec);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, EOpEqual, bvec, "equal", ivec, ivec);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, EOpEqual, bvec, "equal", bvec, bvec);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, EOpNotEqual, bvec, "notEqual", vec, vec);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, EOpNotEqual, bvec, "notEqual", ivec, ivec);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, EOpNotEqual, bvec, "notEqual", bvec, bvec);
