...
void InsertBuiltInFunctions(GLenum type, const ShBuiltInResources &resources, TSymbolTable &symbolTable)
{
	...
	if(resources.OES_EGL_image_external_essl3)
    {
        ...
        symbolTable.insertBuiltIn(ESSL3_BUILTINS, gvec4, "texture", samplerExternalOES, float2);
        symbolTable.insertBuiltIn(ESSL3_BUILTINS, gvec4, "textureProj", samplerExternalOES, float3);
        symbolTable.insertBuiltIn(ESSL3_BUILTINS, gvec4, "textureProj", samplerExternalOES, float4);
        symbolTable.insertBuiltIn(ESSL3_BUILTINS, int2, "textureSize", samplerExternalOES, int1);
        symbolTable.insertBuiltIn(ESSL3_BUILTINS, gvec4, "texelFetch", samplerExternalOES, int2, int1);
    }
