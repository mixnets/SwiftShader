...
__eglMustCastToProperFunctionPointerType glGetProcAddress(const char *procname)
{
    ...
    static const Extension glExtensions[] =
    {
		...
		{"glEGLImageTargetRenderbufferStorageOES", (__eglMustCastToProperFunctionPointerType)glEGLImageTargetRenderbufferStorageOES},
		...
		{"glBlendEquationOES", (__eglMustCastToProperFunctionPointerType)glBlendEquationOES},
