...
GraphicsState::GraphicsState(const Device *device, const VkGraphicsPipelineCreateInfo *pCreateInfo,
    ...
    : GraphicsState(device, pCreateInfo, layout, robustBufferAccess,
                    ParseDynamicStateFlags(pCreateInfo->pDynamicState),
...
GraphicsState::GraphicsState(const Device *device, const VkGraphicsPipelineCreateInfo *pCreateInfo,
                             const PipelineLayout *layout, bool robustBufferAccess,
                             const DynamicStateFlags &dynamicStateFlags, const VkPipelineRenderingCreateInfo *rendering)
