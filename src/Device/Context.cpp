...
VertexInputInterfaceState::VertexInputInterfaceState(const VkPipelineVertexInputStateCreateInfo *vertexInputState,
...
PreRasterizationState::PreRasterizationState(const vk::Device *device,
...
FragmentState::FragmentState(bool rasterizerDiscardEnable,
...
FragmentOutputInterfaceState::FragmentOutputInterfaceState(bool rasterizerDiscardEnable,
...
GraphicsState::GraphicsState(const Device *device, const VkGraphicsPipelineCreateInfo *pCreateInfo,
    ...
    : GraphicsState(device, pCreateInfo, layout, ParseDynamicStateFlags(pCreateInfo->pDynamicState),
                    GetExtendedStruct<VkPipelineRenderingCreateInfo>(pCreateInfo, VK_STRUCTURE_TYPE_PIPELINE_RENDERING_CREATE_INFO))
{
}

GraphicsState::GraphicsState(const Device *device, const VkGraphicsPipelineCreateInfo *pCreateInfo,
                             const PipelineLayout *layout, const DynamicStateFlags &dynamicStateFlags, const VkPipelineRenderingCreateInfo *rendering)
    : pipelineLayout(layout)
    , vertexInputInterfaceState(pCreateInfo->pVertexInputState,
                                pCreateInfo->pInputAssemblyState,
                                dynamicStateFlags)
    , preRasterizationState(device,
                            ...
                            rendering,
                            dynamicStateFlags)
    , fragmentState(pCreateInfo->pRasterizationState->rasterizerDiscardEnable,
                    pCreateInfo->pDepthStencilState,
                    vk::Cast(pCreateInfo->renderPass),
                    pCreateInfo->subpass,
                    rendering,
                    dynamicStateFlags)
    , fragmentOutputInterfaceState(pCreateInfo->pRasterizationState->rasterizerDiscardEnable,
