...
DynamicRendering::DynamicRendering(const VkRenderingInfo *pRenderingInfo)
    ...
    , hasDepthAttachment(pRenderingInfo->pDepthAttachment != nullptr)
    , hasStencilAttachment(pRenderingInfo->pStencilAttachment != nullptr)
...
void DynamicRendering::getAttachments(Attachments *attachments) const
{
	...
	attachments->depthBuffer = hasDepthAttachment ? vk::Cast(depthAttachment.imageView) : nullptr;
	attachments->stencilBuffer = hasStencilAttachment ? vk::Cast(stencilAttachment.imageView) : nullptr;
}
