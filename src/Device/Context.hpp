...
{
	VertexInputInterfaceState(const VkPipelineVertexInputStateCreateInfo *vertexInputState,
...
private:
	const VertexInputInterfaceDynamicStateFlags dynamicStateFlags = {};
...
{
	PreRasterizationState(const vk::Device *device,
...
private:
	const PreRasterizationDynamicStateFlags dynamicStateFlags = {};
...
{
	FragmentState(bool rasterizerDiscardEnable,
...
private:
	...
	const FragmentDynamicStateFlags dynamicStateFlags = {};
...
{
	FragmentOutputInterfaceState(bool rasterizerDiscardEnable,
...
private:
	...
	const FragmentOutputInterfaceDynamicStateFlags dynamicStateFlags = {};
...
private:
	...
	// created, these can be turned into shared_ptr such that linked pipeline libraries could
	// share the blobs.
