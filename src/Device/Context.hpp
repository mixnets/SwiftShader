...
struct GraphicsState
{
	...
	inline bool hasDynamicVertexStride() const { return dynamicStateFlags & DYNAMIC_VERTEX_INPUT_BINDING_STRIDE; }
	inline bool hasDynamicTopology() const { return dynamicStateFlags & DYNAMIC_PRIMITIVE_TOPOLOGY; }
