...
Float4 Blitter::LinearToSRGB(const Float4 &c)
{
	...
	Float4 ec = Float4(1.055f) * sw::Pow(c, (1.0f / 2.4f), false) - 0.055f;  // TODO(b/149574741): Use an optimized approximation.
...
Float4 Blitter::sRGBtoLinear(const Float4 &c)
{
	...
	Float4 ec = sw::Pow((c + 0.055f) * (1.0f / 1.055f), 2.4f, false);  // TODO(b/149574741): Use an optimized approximation.
