...
void PixelProcessor::setBlendConstant(const Color<float> &blendConstant)
{
	...
	factor.blendConstant4W[0] = static_cast<uint16_t>(iround(0xFFFFu * blendConstant.r));
	factor.blendConstant4W[1] = static_cast<uint16_t>(iround(0xFFFFu * blendConstant.g));
	factor.blendConstant4W[2] = static_cast<uint16_t>(iround(0xFFFFu * blendConstant.b));
	factor.blendConstant4W[3] = static_cast<uint16_t>(iround(0xFFFFu * blendConstant.a));

	factor.invBlendConstant4W[0] = 0xFFFFu - factor.blendConstant4W[0][0];
	factor.invBlendConstant4W[1] = 0xFFFFu - factor.blendConstant4W[1][0];
	factor.invBlendConstant4W[2] = 0xFFFFu - factor.blendConstant4W[2][0];
	factor.invBlendConstant4W[3] = 0xFFFFu - factor.blendConstant4W[3][0];

	factor.blendConstant4F[0] = blendConstant.r;
	factor.blendConstant4F[1] = blendConstant.g;
	factor.blendConstant4F[2] = blendConstant.b;
	factor.blendConstant4F[3] = blendConstant.a;

	factor.invBlendConstant4F[0] = 1 - blendConstant.r;
	factor.invBlendConstant4F[1] = 1 - blendConstant.g;
	factor.invBlendConstant4F[2] = 1 - blendConstant.b;
	factor.invBlendConstant4F[3] = 1 - blendConstant.a;
}
