...
namespace sw
{
	...
	bool Surface::hasSameLayout(const Surface* other) const
	{
		return external.buffer && other->external.buffer &&
			   !internal.buffer && !other->internal.buffer &&
			   (external.width == other->external.width) &&
			   (external.height == other->external.height) &&
			   (external.depth == other->external.depth) &&
			   (external.samples == other->external.samples) &&
			   (external.format == other->external.format) &&
			   (external.bytes == other->external.bytes) &&
			   (external.pitchB == other->external.pitchB) &&
			   (external.pitchP == other->external.pitchP) &&
			   (external.sliceB == other->external.sliceB) &&
			   (external.sliceP == other->external.sliceP) &&
			   (external.border == other->external.border);
	}
