...
namespace sw
{
	...
	struct DrawCall
	{
		struct BatchData
		{
			using Pool = yarn::FixedSizePool<BatchData, MaxBatchCount, yarn::PoolPolicy::Preserve>;
		...
		using Pool = yarn::FixedSizePool<DrawCall, MaxDrawCount, yarn::PoolPolicy::Preserve>;
