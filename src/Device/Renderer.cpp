                    ...
                    vk::Pipeline::PushConstantStorage const &pushConstants, bool update)
{
	...
	ASSERT(hasRasterizerDiscard || (fragmentState != nullptr && fragmentOutputInterfaceState != nullptr));
	...
	if(update)
	{
		...
		{
			setupState.rasterizerDiscard = true;
		}
	}
	...
	draw->setupState.rasterizerDiscard = setupState.rasterizerDiscard;
