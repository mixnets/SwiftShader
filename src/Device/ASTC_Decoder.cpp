                          ...
                          int xblocks, int yblocks, int zblocks, bool isUnsignedByte)
{
	...
	// Initialize decimation_tables to null in order to easily delete them at the end
	for(int i = 0; i < (MAX_DECIMATION_MODES + 1); i++)
	{
	...
	// Release decimation_tables allocated within init_block_size_descriptor()
	for(int i = 0; i < (MAX_DECIMATION_MODES + 1); i++)
	{
